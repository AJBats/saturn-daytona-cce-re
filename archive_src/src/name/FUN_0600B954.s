...
FUN_0600B954:
    ...
    cmp/hs r1, r0
    bt .L_0600B994
    .reloc ., R_SH_IND12W, FUN_0600C570 - 4
    .2byte 0xB000    /* bsr FUN_0600C570 (linker-resolved) */
    mov r5, r1
    .reloc ., R_SH_IND12W, FUN_0600C6FA - 4
    .2byte 0xB000    /* bsr FUN_0600C6FA (linker-resolved) */
    mov.l @(48, r14), r1
    mov.l @(48, r14), r1
    mov.l @(8, r1), r8
    add r1, r8
...
.L_0600B974:
    ...
    bf/s .L_0600B99E
    mov.w r0, @(130, gbr)
    .reloc ., R_SH_IND12W, FUN_0600C804 - 4
    .2byte 0xB000    /* bsr FUN_0600C804 (linker-resolved) */
    mov.l r7, @-r15
    mov.l @r15+, r7
    dt r7
    bf .L_0600B974
.L_0600B994:
    ...
    ldc.l @r15+, gbr
.L_0600B99E:
    .reloc ., R_SH_IND12W, FUN_0600C846 - 4
    .2byte 0xB000    /* bsr FUN_0600C846 (linker-resolved) */
    mov.l r7, @-r15
    mov.l @r15+, r7
    dt r7
    bf .L_0600B974
