...
FUN_0600816C:
    ...
    sts.l pr, @-r15
    add #-0x10, r15
    .reloc ., R_SH_IND12W, FUN_06008104 - 4
    .2byte 0xB000    /* bsr FUN_06008104 (linker-resolved) */
    nop
    mov #0x0, r11
...
.L_060081A0:
    ...
    add #0x27, r3
    mov.l r3, @r15
    .reloc ., R_SH_IND12W, FUN_060081EC - 4
    .2byte 0xA000    /* bra FUN_060081EC (linker-resolved) */
    mov r11, r12
