...
.L_0600B792:
    ...
    mov.b r14, @r2
.L_0600B7A0:
    .reloc ., R_SH_IND12W, FUN_0600C028 - 4
    .2byte 0xB000    /* bsr FUN_0600C028 (linker-resolved) */
    nop
    mov.w @r11, r4
    extu.w r4, r4
...
.L_0600B8A6:
    ...
    mov.l @r15+, r12
    mov.l @r15+, r13
    .reloc ., R_SH_IND12W, FUN_0600B8C6 - 4
    .2byte 0xA000    /* bra FUN_0600B8C6 (linker-resolved) */
    mov.l @r15+, r14
.L_0600B8B6:
    lds.l @r15+, pr
    mov.l @r15+, r9
