...
- code subsegs in closure: **32** (ported **4**)
- data tables referenced: **17**  |  external inputs: **27**

## Call tree (from the dispatcher)

```
sym_0602ECF2 [dispatcher] player physics dispatcher (jump-table state machine)  «data: 0602EDE8, 0602EE20, 0602EE58, 0602EE90, 0602FDA1»  «in: car pointer (global), scratch global, dispatch state index»
  ...
  sym_0602F270 [7b] track force application  «data: track-force bounds, gear-ratio table»
    sym_0602755C [math] fixed-point multiply
  ...
  sym_0602C8E2 [14] collision response
    sym_0602ECCC [math] SH-2 DIVU helper ✓PORTED
  sym_0602CA84 [15] force accumulator
    sym_0602755C [math] fixed-point multiply
    sym_0602CCD0 [helper] helper
    sym_0602CCEC [traction] traction force (within force accumulator)  «data: traction constants»
      sym_0602755C [math] fixed-point multiply
      sym_0602D7E4 [helper] damping / clamp
