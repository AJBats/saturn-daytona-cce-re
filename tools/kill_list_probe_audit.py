...
def main():
    ...
    defensible_lines = [
        ...
        '#   2. cdl_n_tracks_alive > 0 (positive evidence retail TT runs it)',
        '#   3. bp_n_tracks_fired = 0 (positive evidence transplant does not run it)',
        '#   4. Every entry probe and every body-exit probe of the function is',
        '#      unfired across all 4 per-track BP sweeps (no probe-vs-range gap)',
        '#   5. Preceding function does NOT fall through into us, OR if it does',
