/* FUN_0602C14C  0x0602C14C */


uint FUN_0602c14c(void)

{
  ...
  uVar1 = FUN_0602c194((int)(short)*(undefined4 *)(unaff_gbr + 0x18));
  if ((in_sr & 1) == 0) {
    return uVar1;
  }
  FUN_0602c194();
...
LAB_0602c18c:
    ...
    if ((bVar5 & 1) != 0) {
      ...
      if (iVar2 == 1) goto LAB_0602c188;
      if (iVar2 == 2) goto LAB_0602c18c;
    }
    uVar3 = *(undefined4 *)(in_r7 + 0xc);
    uVar4 = *(undefined4 *)(in_r7 + 0x10);
