/* FUN_0602C2D8  0x0602C2D8 */


uint FUN_0602c2d8(int param_1,undefined4 param_2,undefined4 param_3,int param_4)
...
LAB_0602c3a4:
    ...
    if ((param_1 == 3) || ((*(byte *)((int)unaff_r13 + 7) & 4) != 0)) {
      ...
      if (cVar2 == '\x01') goto LAB_0602c37c;
      if (cVar2 == '\x02') goto LAB_0602c3a4;
    }
