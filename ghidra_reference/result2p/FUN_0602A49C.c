/* FUN_0602A49C  0x0602A49C */


uint FUN_0602a49c(uint *param_1,int param_2)

{
  ...
  uVar7 = param_2 + 8U & DAT_0602a500;
  if (uVar7 == 0) {
    return DAT_0602a500;
  }
  iVar8 = (int)*(short *)(PTR_DAT_0602a504 + (uVar7 >> 2));
  iVar10 = (int)*(short *)((int)(PTR_DAT_0602a504 + (uVar7 >> 2)) + 2);
  uVar9 = iVar8 * 4;
  uVar11 = iVar10 * 4;
  uVar7 = iVar8 * -4;
  iVar6 = 3;
