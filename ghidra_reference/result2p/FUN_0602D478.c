/* FUN_0602D478  0x0602D478 */


void FUN_0602d478(int param_1,undefined4 *param_2)

{
  ...
  *param_2 = (int)((ulonglong)
                   ...
                   (longlong)iRam0602d4d4) >> 0x20);
  param_2[1] = (((int)uVar5 >> 1) - uVar4) + iRam0602d4d8;
  param_2[2] = ((int)-uVar5 >> 1) + ((int)uVar4 >> 1) + (param_1 >> 1) + iRam0602d4dc;
