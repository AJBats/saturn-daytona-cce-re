/* FUN_060042D8  0x060042D8 */


uint FUN_060042d8(int param_1,undefined4 param_2,undefined4 param_3,int param_4)
...
LAB_060043a4:
    ...
    if ((param_1 == 3) || ((*(byte *)((int)unaff_r13 + 7) & 4) != 0)) {
      ...
      if (cVar2 == '\x01') goto LAB_0600437c;
      if (cVar2 == '\x02') goto LAB_060043a4;
    }
