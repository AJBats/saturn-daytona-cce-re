...
void FUN_060049a4(undefined4 param_1,undefined4 param_2,undefined4 param_3,int param_4)
...
LAB_06004a5c:
  ...
  if ((*(byte *)(unaff_r13 + 7) & 4) != 0) {
    ...
    if (cVar1 == '\0') goto LAB_06004a38;
    if (cVar1 == '\x01') goto LAB_06004a44;
    if (cVar1 == '\x02') goto LAB_06004a5c;
  }
