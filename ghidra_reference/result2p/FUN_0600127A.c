...
void FUN_0600127a(undefined4 param_1,undefined4 param_2,int param_3,undefined4 param_4)

{
  ...
  while( true ) {
    ...
    unaff_r14 = unaff_r14 + DAT_060012c8;
    unaff_r13 = unaff_r13 + 1;
    if (unaff_r8 <= unaff_r14) break;
    param_4 = 0;
    in_r3 = (code *)PTR_FUN_0600132c;
    param_2 = DAT_06001334;
    unaff_r12 = param_3;
  }
  return;
}
