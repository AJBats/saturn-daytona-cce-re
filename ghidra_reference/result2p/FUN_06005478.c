...
void FUN_06005478(int param_1,undefined4 *param_2)

{
  ...
  *param_2 = (int)((ulonglong)
                   ...
                   (longlong)DAT_060054d4) >> 0x20);
  param_2[1] = (((int)uVar5 >> 1) - uVar4) + DAT_060054d8;
  param_2[2] = ((int)-uVar5 >> 1) + ((int)uVar4 >> 1) + (param_1 >> 1) + DAT_060054dc;
