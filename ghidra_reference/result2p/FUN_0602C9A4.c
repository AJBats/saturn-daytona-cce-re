/* FUN_0602C9A4  0x0602C9A4 */


void FUN_0602c9a4(undefined4 param_1,undefined4 param_2,undefined4 param_3,int param_4)
...
LAB_0602ca5c:
  ...
  if ((*(byte *)(unaff_r13 + 7) & 4) != 0) {
    ...
    if (cVar1 == '\0') goto LAB_0602ca38;
    if (cVar1 == '\x01') goto LAB_0602ca44;
    if (cVar1 == '\x02') goto LAB_0602ca5c;
  }
