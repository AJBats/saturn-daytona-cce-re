/* FUN_06029C9C  0x06029C9C */


void FUN_06029c9c(byte param_1,uint param_2,byte param_3,byte param_4,int param_5,uint param_6,
                 uint param_7)

{
  ...
  iVar4 = (int)sRam06029d96;
  uVar1 = (ushort)(param_6 >> 5) & uRam06029d94;
