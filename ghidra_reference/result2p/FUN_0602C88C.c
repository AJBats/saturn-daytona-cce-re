/* FUN_0602C88C  0x0602C88C */


undefined4 FUN_0602c88c(undefined4 param_1,undefined4 param_2,undefined4 param_3,byte *param_4)

{
  ...
  *(undefined4 *)(param_4 + 0x18) = param_1;
  FUN_0602c14c();
  pbVar4 = param_4 + 0x20;
  *(undefined4 *)pbVar4 = *(undefined4 *)param_4;
  ...
  *param_4 = *param_4 & 0x8f;
  ...
  uVar2 = unaff_r10[6];
  uVar3 = unaff_r10[8];
  *(undefined4 *)(param_4 + 0x2c) = unaff_r10[2];
