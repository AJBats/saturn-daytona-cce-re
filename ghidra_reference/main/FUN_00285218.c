...

{
  ...
  pcVar3 = (char *)(*(int *)PTR_DAT_00285284 + param_2);
  if ((pcVar3[0x18] == '\x01') && (*pcVar3 == '\x01')) {
    piVar4 = (int *)(*(int *)PTR_DAT_00285284 + (int)DAT_0028527a);
    uVar1 = 0xffffffff;
    if (*piVar4 == 0) {
      iVar2 = 1;
      if (param_1 == -1) {
