...

{
  ...
  iVar4 = 0;
  piVar3 = (int *)(*piRam00280e30 + (int)sRam00280e28);
  if (0 < *(int *)*piRam00280e30) {
    iVar6 = (int)sRam00280e2a;
    piVar5 = (int *)((int)piVar3 + (int)sRam00280e2c);
    do {
      if (*piVar3 == 1) {
        if (*piVar5 == 4) {
