...

{
  ...
  if (*(int *)(iVar6 + *(int *)PTR_DAT_00285a6c) == 1) {
    (*(code *)PTR_FUN_00285a70)
              (*(undefined4 *)(*(int *)PTR_DAT_00285a6c + (int)DAT_00285a60),&local_10);
    (*(code *)PTR_FUN_00285a74)();
    *param_1 = *param_1 + 1;
    iVar5 = *(int *)puVar1;
    local_10 = local_10 - *(int *)(iVar5 + DAT_00285a62);
    if (*(int *)(iVar5 + DAT_00285a64) < local_10) {
      local_10 = *(int *)(iVar5 + DAT_00285a64);
    }
    **(int **)(iVar5 + DAT_00285a66) = local_10;
    iVar4 = *(int *)puVar1;
