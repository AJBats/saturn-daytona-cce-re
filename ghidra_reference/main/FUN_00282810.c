    ...
    if (iVar3 == 0) {
      ...
      if (iVar2 != 0) {
        ...
        if (iVar2 != 0) {
          ...
          if (iVar2 != 0) {
            ...
            uStack_1c = 0;
            iVar2 = (*(code *)PTR_FUN_00282950)(&uStack_2c,*(undefined4 *)(param_1 + 0x38));
            if (iVar2 == 0) {
              *(int *)(param_1 + 0x58) = *(int *)(param_1 + 0x58) + aiStack_c[0];
              iVar2 = *DAT_00282954;
              *(int *)(DAT_0028292a + iVar2) = iStack_28;
              *(undefined4 *)(DAT_0028292c + iVar2) = *(undefined4 *)(param_1 + 0x48);
              return 1;
            }
          }
          uStack_10 = 8;
      ...
      if ((*(int *)(param_1 + 0x48) <= iStack_18) &&
        ...
        if (*(int *)(param_1 + 0x54) == *(int *)(param_1 + 0x58)) {
          iVar3 = *(int *)(*DAT_00282954 + (int)DAT_0028292c);
          if ((iStack_18 < iVar3) || (iVar2 == 2)) {
            uStack_10 = 2;
          }
          else {
            *(int *)(*DAT_00282954 + (int)DAT_0028292a) = iVar3;
            uStack_10 = 4;
          }
        }
      }
