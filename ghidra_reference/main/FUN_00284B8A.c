...
undefined8 FUN_00284b8a(uint param_1)

{
  ...
  if (*DAT_00284c0c == -0x10) {
    *DAT_00284c0c = 0;
  }
  iVar4 = 0x17;
  uVar3 = 0xfffffffa;
  if (param_1 < 0x18) {
    iVar4 = (int)*(char *)(param_1 + *DAT_00284c10);
    uVar3 = 0xfffffff9;
    if (iVar4 == 1) {
      (*(code *)PTR_FUN_00284c14)(param_1,0,0xffffffff);
      puVar1 = PTR_FUN_00284c1c;
      (*(code *)PTR_FUN_00284c1c)(DAT_00284c18);
      ...
      (*(code *)puVar1)(0);
      iVar4 = 0;
      *(undefined1 *)(param_1 + *DAT_00284c10) = 0;
      uVar3 = 0;
    }
  }
LAB_00284bfe:
