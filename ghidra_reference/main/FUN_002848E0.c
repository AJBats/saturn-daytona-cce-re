...
int FUN_002848e0(int param_1,undefined4 param_2)
  ...
  *DAT_00284aa4 = 0;
  ...
  if (iVar6 == 0) {
    ...
    *(undefined4 *)(*DAT_00284a9c + 0x3c) = 0;
    ...
    iVar8 = *DAT_00284ad0;
    iStack_20 = (*(code *)PTR_FUN_00284ad4)(iVar8 + iVar6);
    puVar4 = PTR_FUN_00284ad8;
    if (iStack_20 == 0) {
      (*(code *)PTR_FUN_00284ad8)(0,local_1c);
      (*(code *)puVar4)(local_1c[0],local_1c);
      if ((*(uint *)((uint)local_1c[0] * 4 + iVar8 + iVar6 + -4) & DAT_00284adc) == 0) {
        return -0xf;
      }
