/* FUN_002848E0  0x002848E0 */

int FUN_002848e0(undefined4 param_1,undefined4 param_2)

{
  ...
  *(undefined4 *)PTR_DAT_00284aa4 = 0;
  ...
  (*(code *)PTR_FUN_00284ab0)(local_2c);
  if (*(int *)puVar3 != 0) {
    return *(int *)puVar3;
  }
  if ((local_2c[0] & 0xf) == 9) {
  ...
  if (iVar6 == 0) {
    ...
    *(undefined4 *)(*(int *)PTR_DAT_00284a9c + 0x3c) = 0;
    ...
    (*(code *)PTR_FUN_00284acc)(&iStack_20);
    iVar7 = (int)DAT_00284a96;
    iVar6 = *(int *)PTR_DAT_00284ad0;
    iStack_20 = (*(code *)PTR_FUN_00284ad4)(iVar6 + iVar7);
    puVar3 = PTR_FUN_00284ad8;
    if (iStack_20 == 0) {
      (*(code *)PTR_FUN_00284ad8)(0,local_1c);
      (*(code *)puVar3)(local_1c[0],local_1c);
      if ((*(uint *)((uint)local_1c[0] * 4 + iVar6 + iVar7 + -4) & DAT_00284adc) == 0) {
        return -0xf;
      }
      iStack_20 = (*(code *)PTR_FUN_00284ae0)((int)DAT_00284a9a,(int)DAT_00284a98);
      *(undefined4 *)(*(int *)PTR_DAT_00284a9c + 0x3c) = 0x30000;
      do {
