...
undefined4 FUN_00282d04(int param_1,int *param_2,undefined4 *param_3)

{
  ...
  *param_2 = iVar4;
  ...
  if (*(int *)(param_1 + 0x4c) == 1) {
    ...
    if ((0 < iVar3) && (iVar2 < *(int *)((int)DAT_00282e24 + *(int *)PTR_DAT_00282e38))) {
      iVar4 = iVar4 - (*(int *)((int)DAT_00282e24 + *(int *)PTR_DAT_00282e38) - iVar2);
    }
  }
  iVar3 = *param_2;
  if (iVar4 < iVar3) {
    ...
    *(int *)(param_1 + 0x48) = iVar4;
    ...
    piVar6 = (int *)(*(int *)PTR_DAT_00282e38 + (int)DAT_00282e24);
    iVar2 = *piVar6;
    if (iVar3 < iVar2) {
      return 1;
    }
    iVar5 = *(int *)(*(int *)PTR_DAT_00282e38 + (int)DAT_00282e26);
    ...
    *(int *)(param_1 + 0x58) = iVar3;
    if (*(int *)(param_1 + 0x54) == iVar3) {
      *param_3 = 4;
      *(undefined4 *)((int)DAT_00282e24 + *(int *)PTR_DAT_00282e38) =
           *(undefined4 *)((int)DAT_00282e26 + *(int *)PTR_DAT_00282e38);
    }
    else {
      *param_3 = 2;
      *(int *)((int)DAT_00282e24 + *(int *)PTR_DAT_00282e38) = iVar2;
    }
  }
  return 0;
}
