...

{
  ...
  puVar3 = (undefined4 *)(*DAT_00284768 + (int)DAT_00284764);
  if ((((puVar3[4] == 0) &&
       (iVar1 = (*(code *)PTR_FUN_0028476c)
                          (*(undefined4 *)(param_1 + 0x20),*(undefined4 *)(param_1 + 0x40),param_2,
                           &iStack_1c,&iStack_18), iVar1 == 0)) &&
      (iVar1 = (*(code *)PTR_FUN_00284770)(), iVar1 == 0)) && (0 < iStack_18)) {
    (*(code *)PTR_FUN_00284774)(param_1,0,0,&iStack_14,&iStack_10,aiStack_c,0,0);
    iVar1 = (*(code *)PTR_FUN_00284778)(param_1 + 0x1c);
    if (((iStack_10 <= iVar1 + iStack_1c) && (aiStack_c[0] != 0)) && (0 < iStack_1c)) {
      iStack_18 = iStack_18 - (iStack_14 - aiStack_c[0]);
    }
