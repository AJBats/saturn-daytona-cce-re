...

{
  ...
  puVar2 = PTR_DAT_00285c3c;
  iVar3 = *(int *)PTR_DAT_00285c3c;
  ...
  if (*(int *)(iVar4 + iVar3) == 1) {
    if ((*(int *)(iVar3 + DAT_00285c34) == 0) && (*(int *)(iVar3 + DAT_00285c36) == -1)) {
      ...
      *param_1 = *param_1 + 1;
      *(undefined4 *)(iVar4 + *(int *)puVar2) = 4;
    }
    else if (*(int *)(*(int *)PTR_DAT_00285c3c + (int)DAT_00285c36) == 0) {
      bVar1 = false;
    }
    else {
      *(undefined4 *)((int)DAT_00285c32 + *(int *)PTR_DAT_00285c3c) = 2;
    }
  }
  puVar2 = PTR_DAT_00285c3c;
  iVar3 = *(int *)PTR_DAT_00285c3c;
  ...
  if (*(int *)(iVar4 + iVar3) == 2) {
    ...
    *param_1 = *param_1 + 1;
    if (iVar3 == 0) {
      *(undefined4 *)(iVar4 + *(int *)puVar2) = 3;
      (*(code *)PTR_FUN_00285c44)();
    }
  }
  if ((*(int *)(*(int *)PTR_DAT_00285c3c + (int)DAT_00285c32) == 3) &&
     (iVar3 = (*(code *)PTR_FUN_00285c4c)((int)DAT_00285c3a), iVar3 != 0)) {
    bVar1 = false;
  }
  if ((*(int *)(*(int *)PTR_DAT_00285c3c + (int)DAT_00285c32) == 4) &&
     (iVar3 = (*(code *)PTR_FUN_00285c4c)(0x40), iVar3 != 0)) {
    bVar1 = false;
  }
  if (!bVar1) {
    (*(code *)PTR_FUN_00285c50)(0xfffffff7);
    *(undefined4 *)((int)DAT_00285c32 + *(int *)PTR_DAT_00285c3c) = 0;
  }
  return bVar1;
}
