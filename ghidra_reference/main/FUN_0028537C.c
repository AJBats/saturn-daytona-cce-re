...

{
  ...
  iVar2 = (*(code *)PTR_FUN_0028543c)(&iStack_14,&iStack_10,aiStack_c);
  if (iVar2 == 0) {
    if ((param_1 < iStack_14) || (iStack_10 + iStack_14 <= param_1)) {
    ...
    if (iVar2 == 0) {
      ...
      if ((aiStack_c[0] != 0) && (iStack_14 + iStack_10 + -1 == param_1)) {
        *pbVar4 = *pbVar4 | 1;
      }
