/* FUN_00285C54  0x00285C54 */


undefined8 FUN_00285c54(int *param_1)

{
  ...
  if (*(int *)(iVar7 + iVar5) == 1) {
    ...
    *param_1 = *param_1 + 1;
    (*(code *)puVar2)();
    puVar3 = (undefined4 *)(*(code *)PTR_FUN_00285dac)(*(undefined4 *)(iVar6 + *piVar1),0);
    uVar4 = 1;
  ...
  if ((*(int *)(iVar7 + iVar5) == 3) &&
     (iVar5 = (*(code *)PTR_FUN_00285db4)((int)DAT_00285d9c), iVar5 != 0)) {
  ...
  if ((*(int *)(iVar5 + *DAT_00285da0) == 5) &&
     (iVar7 = (*(code *)PTR_FUN_00285db4)(0x40), iVar7 == 1)) {
    *(undefined4 *)(iVar5 + *piVar1) = 0;
  }
  puVar3 = (undefined4 *)(*DAT_00285da0 + (int)DAT_00285d90);
  uVar4 = *puVar3;
LAB_00285d7e:
