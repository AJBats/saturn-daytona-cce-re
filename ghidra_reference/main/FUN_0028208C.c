/* FUN_0028208C  0x0028208C */

int FUN_0028208c(int *param_1)

{
  ...
  puVar1 = PTR_DAT_0028217c;
  if ((*(uint *)(*(int *)PTR_DAT_0028217c + (int)DAT_0028216c) & 1) == 0) {
    iVar2 = -2;
  }
  else {
    iVar2 = (*(code *)PTR_FUN_00282180)(*(int *)PTR_DAT_0028217c + (int)DAT_0028216e);
    if (iVar2 == 0) {
      iVar5 = *(int *)puVar1 + (int)DAT_00282170;
