...
void FUN_002813e8(int param_1,int param_2,undefined4 param_3,undefined4 param_4)
  ...
  if (param_1 == 0) {
    ...
    if (-1 < iVar2) {
      ...
      *(undefined4 *)(param_1 + 4) = 1;
      (*(code *)PTR_FUN_002814d4)(param_1,0,0,0,&uStack_14);
      if ((uStack_14 & 0x40) == 0) {
        if ((*(int *)(param_1 + 0xa0) == 0) || (*(int *)(param_1 + 0xa0) == 6)) {
          (*(code *)PTR_FUN_002814d8)(iVar4,iVar2);
          (*(code *)PTR_FUN_002814dc)(iVar4,uStack_10,uStack_c,1);
