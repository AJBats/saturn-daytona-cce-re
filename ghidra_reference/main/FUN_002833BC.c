...

{
  ...
  piStack_18 = param_2;
  cVar7 = (*(code *)PTR_FUN_002834dc)(param_1,&iStack_1c);
  *(char *)(piStack_18 + 2) = cVar7;
  ...
  (*(code *)PTR_FUN_002834e0)(param_1,&iStack_1c);
  puVar3 = PTR_FUN_002834e4;
  if (iStack_1c != 0) {
    return iStack_1c;
  }
  iVar5 = (*(code *)PTR_FUN_002834e4)(param_1,&iStack_1c);
  *piStack_18 = DAT_002834d8 + iVar5;
  if (iStack_1c != 0) {
    return iStack_1c;
  }
  iVar5 = (*(code *)puVar3)(param_1,&iStack_1c);
  piStack_18[1] = iVar5;
  iVar5 = 0;
  if (iStack_1c != 0) {
    return iStack_1c;
  ...
  bStack_d = (*(code *)PTR_FUN_002834e0)(param_1);
  if (iStack_1c != 0) {
    return iStack_1c;
  }
  uVar8 = (*(code *)puVar3)(param_1,&iStack_1c);
  ...
  *(undefined1 *)((int)piStack_18 + 0xb) = uVar8;
  ...
  (*(code *)PTR_FUN_002834e8)(param_1,&iStack_1c);
  if (iStack_1c != 0) {
    return iStack_1c;
  }
  uVar6 = (*(code *)puVar3)(param_1,&iStack_1c);
  if (iStack_1c != 0) {
    return iStack_1c;
  }
  ...
  do {
    ...
    unaff_r9 = (*(code *)PTR_FUN_0028363c)(param_1,&iStack_1c);
    iVar5 = iVar5 + 1;
    if (iStack_1c != 0) {
      return iStack_1c;
    }
  ...
  if (unaff_r9 == ';') {
    ...
    if (unaff_r9 != '.') {
      ...
      do {
        cVar7 = (*(code *)puVar2)(param_1,&iStack_1c);
        iVar5 = iVar5 + 1;
        if (iStack_1c != 0) {
          return iStack_1c;
        }
...
LAB_0028358c:
  if (!bVar1) {
    do {
      cVar7 = (*(code *)PTR_FUN_0028363c)(param_1,&iStack_1c);
      iVar5 = iVar5 + 1;
      if (iStack_1c != 0) {
        return iStack_1c;
      }
      if (cVar7 == ';') {
        if (iVar5 < (int)(uVar6 & 0xff)) {
          do {
            (*(code *)PTR_FUN_0028363c)(param_1,&iStack_1c);
            iVar5 = iVar5 + 1;
            if (iStack_1c != 0) {
              return iStack_1c;
            }
  ...
  if (iStack_14 < (int)(uint)*pbVar11) {
    (*(code *)PTR_FUN_0028371c)(param_1,&iStack_1c);
    puVar2 = PTR_FUN_00283720;
    if (iStack_1c != 0) {
      return iStack_1c;
    }
    bVar9 = (*(code *)PTR_FUN_00283720)(param_1,&iStack_1c);
    *(byte *)((int)piStack_18 + 9) = bVar9 & 0xf8;
    ...
    (*(code *)PTR_FUN_00283724)(param_1,&iStack_1c);
    if (iStack_1c == 0) {
      uVar8 = (*(code *)puVar2)(param_1,&iStack_1c);
