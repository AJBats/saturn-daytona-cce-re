...

{
  ...
  if (param_2 == 0) {
    if (*(int *)(*(int *)PTR_DAT_00280bf8 + (int)DAT_00280bf4 + 8) == 0) {
    ...
    if (iVar2 == 0) {
      iVar1 = *(int *)(*(int *)PTR_DAT_00280bf8 + (int)DAT_00280bf6 + 8);
    }
    else {
      (*(code *)PTR_FUN_00280c08)(iVar2,0,local_c,0);
      iVar1 = (*(code *)PTR_FUN_00280c0c)(iVar2,param_2,local_c[0]);
