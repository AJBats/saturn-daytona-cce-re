...
undefined4 FUN_0600a1f6(int param_1,int param_2)

{
  ...
  iVar1 = (*DAT_0600a290)(&local_1c,&iStack_18,aiStack_14);
  if (iVar1 != 0) {
    return 0xfffffff5;
  }
  if ((param_1 < local_1c) || (local_1c + iStack_18 <= param_1)) {
    iVar1 = (*DAT_0600a294)(0x17,param_1);
    if (iVar1 != 0) {
      return 0xfffffff5;
    }
  ...
  iVar1 = (*DAT_0600a298)(param_1,param_2);
  if (iVar1 == 0) {
