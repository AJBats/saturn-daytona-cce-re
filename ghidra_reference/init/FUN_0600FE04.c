/* FUN_0600FE04  0x0600FE04 */


undefined4 FUN_0600fe04(undefined4 param_1,int param_2)

{
  ...
  iVar1 = (*(code *)PTR_FUN_0600fe78)
                    ((int)*(short *)(*unaff_r14 + in_r0 + 2),(int)*(short *)(param_2 + in_r0));
  if (iVar1 == 0) {
    FUN_060100b8();
    ...
    *(undefined4 *)(*unaff_r14 + iVar1) = 4;
    if ((*(int *)((int)DAT_0600fe6a + *unaff_r14) == 4) &&
      ...
      **(undefined4 **)(*unaff_r14 + (int)DAT_0600ff7a) = in_stack_00000004;
    }
    uVar2 = *(undefined4 *)((int)DAT_0600ff7c + *unaff_r14);
  }
  else {
    uVar2 = 1;
  }
