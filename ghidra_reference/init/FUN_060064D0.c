...
void FUN_060064d0(byte *param_1,byte *param_2,byte *param_3,undefined4 param_4,undefined4 param_5,
...

{
  ...
  do {
    *param_1 = in_r0;
    param_3 = param_3 + 3;
    iVar6 = (int)(char)((unaff_r8 * '\x02' + unaff_r12) * '\x04');
    param_5 = unaff_r13 + 4;
    param_9 = unaff_r13 + 5;
    param_8 = unaff_r13 + 6;
    bVar1 = *param_1;
    ...
    *(ushort *)(iVar6 + unaff_r10) = ~uVar4;
    ...
    do {
      ...
      while ((unaff_r9 <= (int)(uint)unaff_r12 ||
        ...
        if ((*(char *)(*(int *)PTR_DAT_060067dc + param_12 + 1) == '\0') || (unaff_r12 == 0)) {
          ...
          param_3 = param_6 + (uint)*(byte *)(*(int *)PTR_DAT_060067dc + param_13 + 1) * 8;
        }
    ...
    } while (*param_3 == DAT_0600651e);
    param_14 = (uint)unaff_r12;
    param_2 = param_3 + 2;
    param_1 = PTR_DAT_06006530 + param_14;
    in_r0 = param_3[1] | *param_3;
    unaff_r13 = param_3;
    unaff_r8 = unaff_r12;
  } while( true );
}
