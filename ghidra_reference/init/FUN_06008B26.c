/* FUN_06008B26  0x06008B26 */


uint FUN_06008b26(void)

{
  ...
  uVar4 = in_r1 << 1;
  uVar36 = in_sr & 0xfffffefe | (uint)((in_r1 & 0x80000000) != 0);
  uVar6 = in_r2 << 1 | (uint)((byte)uVar36 & 1);
  bVar2 = ((byte)(in_sr >> 8) & 1) == ((byte)(in_sr >> 9) & 1);
  bVar3 = (bool)((byte)(in_sr >> 9) & 1) == ((in_r2 & 0x80000000) != 0);
  uVar7 = (uint)bVar2 * (uVar6 - in_r0) + (uint)!bVar2 * (uVar6 + in_r0);
  cVar1 = bVar2 * (uVar6 < uVar7) + !bVar2 * (uVar7 < uVar6);
  uVar37 = (uint)(byte)(bVar3 * cVar1 + (!bVar3 && cVar1 == '\0')) << 8;
  uVar36 = uVar36 | uVar37;
  uVar5 = in_sr & 0xfffffefe;
  uVar38 = uVar5 | uVar37;
  uVar6 = uVar5 | uVar37 & 0xfffffeff | (uint)((uVar4 & 0x80000000) != 0);
  uVar8 = uVar7 * 2 | (uint)((byte)uVar6 & 1);
  bVar2 = ((byte)(uVar38 >> 8) & 1) == ((byte)(uVar38 >> 9) & 1);
  bVar3 = (bool)((byte)(uVar38 >> 9) & 1) == ((uVar7 & 0x80000000) != 0);
  uVar9 = (uint)bVar2 * (uVar8 - in_r0) + (uint)!bVar2 * (uVar8 + in_r0);
  cVar1 = bVar2 * (uVar8 < uVar9) + !bVar2 * (uVar9 < uVar8);
  uVar38 = (uint)(byte)(bVar3 * cVar1 + (!bVar3 && cVar1 == '\0')) << 8;
  uVar6 = uVar6 | uVar38;
  uVar5 = uVar5 | uVar37 & 0xfffffefe;
  uVar7 = uVar5 | uVar38;
  uVar37 = uVar5 | uVar38 & 0xfffffeff | (uint)((uVar4 & 0x40000000) != 0);
  uVar8 = uVar9 * 2 | (uint)((byte)uVar37 & 1);
  ...
  uVar37 = uVar37 | uVar7;
  uVar5 = uVar5 | uVar38 & 0xfffffefe;
  uVar8 = uVar5 | uVar7;
  uVar38 = uVar5 | uVar7 & 0xfffffeff | (uint)((uVar4 & 0x20000000) != 0);
  uVar10 = uVar9 * 2 | (uint)((byte)uVar38 & 1);
  ...
  uVar17 = uVar5 | uVar16;
  uVar15 = uVar5 | uVar16 & 0xfffffeff | (uint)((uVar4 & 0x100000) != 0);
  ...
  uVar19 = uVar5 | uVar18;
  uVar17 = uVar5 | uVar18 & 0xfffffeff | (uint)((uVar4 & 0x40000) != 0);
  ...
  uVar21 = uVar5 | uVar20;
  uVar19 = uVar5 | uVar20 & 0xfffffeff | (uint)((uVar4 & 0x10000) != 0);
  ...
  uVar23 = uVar5 | uVar22;
  uVar21 = uVar5 | uVar22 & 0xfffffeff | (uint)((uVar4 & 0x4000) != 0);
  ...
  uVar25 = uVar5 | uVar24;
  uVar23 = uVar5 | uVar24 & 0xfffffeff | (uint)((uVar4 & 0x1000) != 0);
  ...
  uVar27 = uVar5 | uVar26;
  uVar25 = uVar5 | uVar26 & 0xfffffeff | (uint)((uVar4 & 0x400) != 0);
  ...
  uVar29 = uVar5 | uVar28;
  uVar27 = uVar5 | uVar28 & 0xfffffeff | (uint)((uVar4 & 0x100) != 0);
  ...
  uVar30 = uVar5 | uVar29;
  uVar28 = uVar5 | uVar29 & 0xfffffeff | (uint)((uVar4 & 0x80) != 0);
  uVar32 = uVar31 * 2 | (uint)((byte)uVar28 & 1);
  bVar2 = ((byte)(uVar30 >> 8) & 1) == ((byte)(uVar30 >> 9) & 1);
  bVar3 = (bool)((byte)(uVar30 >> 9) & 1) == ((uVar31 & 0x80000000) != 0);
  uVar33 = (uint)bVar2 * (uVar32 - in_r0) + (uint)!bVar2 * (uVar32 + in_r0);
  cVar1 = bVar2 * (uVar32 < uVar33) + !bVar2 * (uVar33 < uVar32);
  uVar30 = (uint)(byte)(bVar3 * cVar1 + (!bVar3 && cVar1 == '\0')) << 8;
  uVar28 = uVar28 | uVar30;
  uVar5 = uVar5 | uVar29 & 0xfffffefe;
  uVar31 = uVar5 | uVar30;
  uVar29 = uVar5 | uVar30 & 0xfffffeff | (uint)((uVar4 & 0x40) != 0);
  uVar32 = uVar33 * 2 | (uint)((byte)uVar29 & 1);
  bVar2 = ((byte)(uVar31 >> 8) & 1) == ((byte)(uVar31 >> 9) & 1);
  bVar3 = (bool)((byte)(uVar31 >> 9) & 1) == ((uVar33 & 0x80000000) != 0);
  uVar33 = (uint)bVar2 * (uVar32 - in_r0) + (uint)!bVar2 * (uVar32 + in_r0);
  cVar1 = bVar2 * (uVar32 < uVar33) + !bVar2 * (uVar33 < uVar32);
  uVar31 = (uint)(byte)(bVar3 * cVar1 + (!bVar3 && cVar1 == '\0')) << 8;
  uVar29 = uVar29 | uVar31;
  uVar5 = uVar5 | uVar30 & 0xfffffefe;
  uVar32 = uVar5 | uVar31;
  uVar30 = uVar5 | uVar31 & 0xfffffeff | (uint)((uVar4 & 0x20) != 0);
  uVar34 = uVar33 * 2 | (uint)((byte)uVar30 & 1);
  bVar2 = ((byte)(uVar32 >> 8) & 1) == ((byte)(uVar32 >> 9) & 1);
  bVar3 = (bool)((byte)(uVar32 >> 9) & 1) == ((uVar33 & 0x80000000) != 0);
  uVar35 = (uint)bVar2 * (uVar34 - in_r0) + (uint)!bVar2 * (uVar34 + in_r0);
  cVar1 = bVar2 * (uVar34 < uVar35) + !bVar2 * (uVar35 < uVar34);
  uVar32 = (uint)(byte)(bVar3 * cVar1 + (!bVar3 && cVar1 == '\0')) << 8;
  uVar30 = uVar30 | uVar32;
  uVar5 = uVar5 | uVar31 & 0xfffffefe;
  uVar33 = uVar5 | uVar32;
  uVar31 = uVar5 | uVar32 & 0xfffffeff | (uint)((uVar4 & 0x10) != 0);
  uVar32 = uVar35 * 2 | (uint)((byte)uVar31 & 1);
  bVar2 = ((byte)(uVar33 >> 8) & 1) == ((byte)(uVar33 >> 9) & 1);
  bVar3 = (bool)((byte)(uVar33 >> 9) & 1) == ((uVar35 & 0x80000000) != 0);
  uVar33 = (uint)bVar2 * (uVar32 - in_r0) + (uint)!bVar2 * (uVar32 + in_r0);
  cVar1 = bVar2 * (uVar32 < uVar33) + !bVar2 * (uVar33 < uVar32);
  uVar31 = uVar31 | (uint)(byte)(bVar3 * cVar1 + (!bVar3 && cVar1 == '\0')) << 8;
  return (((((((((((((((((((((((((((((uVar4 | (byte)in_sr & 1) << 1 |
                                    (uint)(((byte)(uVar36 >> 8) & 1) == ((byte)(uVar36 >> 9) & 1)))
                                    << 1 | (uint)(((byte)(uVar6 >> 8) & 1) ==
                                                 ((byte)(uVar6 >> 9) & 1))) << 1 |
                                  (uint)(((byte)(uVar37 >> 8) & 1) == ((byte)(uVar37 >> 9) & 1))) <<
                                  1 | (uint)(((byte)(uVar38 >> 8) & 1) == ((byte)(uVar38 >> 9) & 1))
                                 ) << 1 | (uint)(((byte)(uVar7 >> 8) & 1) ==
                                                ((byte)(uVar7 >> 9) & 1))) << 1 |
         ...
         (uint)(((byte)(uVar31 >> 8) & 1) == ((byte)(uVar31 >> 9) & 1));
}
