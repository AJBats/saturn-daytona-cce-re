...
void FUN_0600643c(undefined1 param_1,undefined2 *param_2,undefined1 *param_3,undefined2 *param_4)

{
  ...
  while( true ) {
    ...
    *(undefined1 *)((int)param_4 + 9) = param_1;
    *(byte *)(param_4 + 5) = bVar6;
    *(byte *)((int)param_4 + 0xb) = bVar6;
