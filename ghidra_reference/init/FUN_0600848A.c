...
void FUN_0600848a(undefined4 param_1,int param_2,undefined4 param_3,int param_4)

{
  ...
  *(char *)(param_4 + 2) = in_r0;
  bVar10 = in_r0 - 1;
  pcVar8 = (char *)((unaff_r12 & (int)(char)bVar10) * 0x40 + in_r3);
  pcVar8[1] = in_r1;
  pcVar8[2] = bVar10 & 0x7f;
  pcVar8[3] = ~bVar10 & 0x7f;
  sVar1 = DAT_060084d2;
