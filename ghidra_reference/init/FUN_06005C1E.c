...
uint FUN_06005c1e(undefined4 param_1,undefined4 param_2)

{
  ...
  if (PTR_DAT_06005d14[*(ushort *)PTR_DAT_06005d10] == '\0') {
    ...
    *puVar8 = uVar6;
    (*(code *)puVar5)(*(undefined4 *)(puVar4 + (uint)*(ushort *)puVar3 * 4),0,&uStack_10,auStack_c);
    iVar7 = (*(code *)PTR_FUN_06005d28)
                      (*(undefined4 *)(puVar4 + (uint)*(ushort *)puVar3 * 4),uStack_10);
    if (iVar7 < 0) {
      ...
      *(undefined4 *)(PTR_DAT_06005d34 + (uint)*(ushort *)puVar3 * 4) = uStack_8;
