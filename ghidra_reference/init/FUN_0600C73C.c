/* FUN_0600C73C  0x0600C73C */


undefined4 FUN_0600c73c(int *param_1,byte *param_2,int param_3,int *param_4)

{
  ...
  while( true ) {
    *(undefined1 *)((unaff_r11 + 2) * param_3 + in_r2) =
         *(undefined1 *)((unaff_r11 + 2) * unaff_r14 + param_1[1]);
