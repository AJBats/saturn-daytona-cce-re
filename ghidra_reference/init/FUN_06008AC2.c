...
bool FUN_06008ac2(undefined4 *param_1,undefined4 *param_2,undefined4 param_3)

{
  ...
  puVar1 = PTR_FUN_06008b58;
  iVar3 = (int)DAT_06008b4a;
  ...
  uVar2 = FUN_0600904e(*(undefined1 *)((int)param_2 + 0xb));
  param_1[4] = uVar2;
  param_1[5] = (uint)(DAT_06008b4c + iVar4) >> 0xb;
  if (param_1[4] == 0) {
    param_1[6] = 0;
  }
  else {
    (*(code *)PTR_FUN_06008d04)();
    uVar2 = (*(code *)PTR_FUN_06008d04)();
    param_1[6] = uVar2;
  }
  iVar3 = (*(code *)PTR_FUN_06008d08)(param_1);
  uVar2 = DAT_06008d0c;
  if (iVar3 != 0) {
    param_1[0x13] = 0;
    param_1[0x14] = 0;
