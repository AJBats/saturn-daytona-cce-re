/* FUN_0600B6D0  0x0600B6D0 */


undefined4 FUN_0600b6d0(int param_1)

{
  ...
  if (*(int *)(unaff_r13 + 0xc + in_r0) == 4) {
    uVar2 = *(undefined4 *)(unaff_r13 + 0x5c);
  }
  else {
    iVar5 = *(int *)(*(int *)PTR_DAT_0600b784 + (int)DAT_0600b77e);
    if ((iVar5 == 0) || (iVar5 == param_1)) {
      iVar5 = (**(code **)(*(int *)(unaff_r13 + 0x28) * 0x10 + *(int *)PTR_DAT_0600b784 + 4))
                        (unaff_r13 + 0xc);
      if (iVar5 == 1) {
