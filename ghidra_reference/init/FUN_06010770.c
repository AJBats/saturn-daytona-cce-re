/* FUN_06010770  0x06010770 */


undefined4 FUN_06010770(byte param_1,undefined2 param_2,uint *param_3)

{
  ...
  uVar1 = (*(code *)PTR_FUN_06010840)(0,&uStack_1c,&uStack_24);
  *param_3 = uStack_24 & DAT_06010848;
