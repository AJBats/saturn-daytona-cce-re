...

{
  ...
  if (param_1 == ';') {
    ...
    do {
      if (unaff_r11 <= unaff_r13) goto FUN_0600d1a6;
      cVar1 = FUN_0600ce3a();
      unaff_r13 = unaff_r13 + 1;
      if (in_stack_00000000 != 0) {
        return in_stack_00000000;
    ...
    *unaff_r10 = '.';
    unaff_r8 = unaff_r10 + 1;
    unaff_r10 = unaff_r8;
  }
FUN_0600d1a6:
  if (unaff_r13 < unaff_r11) {
    cVar1 = FUN_0600ce3a();
    unaff_r13 = unaff_r13 + 1;
    if (in_stack_00000000 != 0) {
      return in_stack_00000000;
    ...
    if (((int)unaff_r10 - (int)unaff_r8 < 4) && ((int)unaff_r10 - (unaff_r12 + 0xc) < 0xc)) {
      *unaff_r10 = cVar1;
...
LAB_0600d1aa:
  ...
  return 0;
joined_r0x0600d16c:
  for (; unaff_r13 < unaff_r11; unaff_r13 = unaff_r13 + 1) {
    FUN_0600ce3a();
  }
  goto LAB_0600d1aa;
}
