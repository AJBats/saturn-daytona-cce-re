...
/* WARNING: Instruction at (ram,0x06005fb2) overlaps instruction at (ram,0x06005fb1)
    */

void FUN_06005f9c(int param_1,undefined1 *param_2,undefined4 param_3,int param_4)
