/* FUN_060290A4  0x060290A4 */


void FUN_060290a4(void)

{
  ...
  puVar3 = DAT_060291e4 + 5;
  puVar7 = DAT_060291ec;
  for (puVar8 = DAT_060291e4; DAT_060291ec = puVar7, puVar8 < puVar3; puVar8 = puVar8 + 1) {
  ...
  puVar8 = (undefined4 *)((int)DAT_060291e2 + (int)puVar7);
