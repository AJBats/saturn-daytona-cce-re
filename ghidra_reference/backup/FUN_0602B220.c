/* FUN_0602B220  0x0602B220 */


void FUN_0602b220(void)

{
  ...
  iVar12 = iRam0602b3a4;
  iVar5 = iRam0602b2b8;
  pcVar4 = pcRam0602b2b4;
  pcVar3 = pcRam0602b2b0;
  pcVar2 = pcRam0602b2ac;
  puVar7 = puRam0602b2a8;
  if (*pcRam0602b2ac == '\0') {
    iVar12 = 0;
    uVar9 = 0;
    do {
      ...
      puVar6 = (undefined4 *)
               ((short)((*pcVar3 * 3 + (short)*pcVar4) * sRam0602b2a6) + iVar5 + (uVar9 & 0xff));
  ...
  iVar5 = iRam0602b3b0;
  puVar7 = puRam0602b3ac;
  iVar10 = 0;
  cVar13 = '\0';
  puVar6 = (undefined4 *)(((*pcVar2 * 5 + (int)*pcVar3) * 0x18 & 0xffU) + iRam0602b3a8);
  *puRam0602b3ac = *puVar6;
  puVar7[1] = puVar6[1];
  puVar7[2] = puVar6[2];
  puVar7[3] = puVar6[3];
  puVar7[4] = puVar6[4];
