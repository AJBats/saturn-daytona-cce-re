...

{
  ...
  puVar2 = PTR_DAT_0600d248;
  *(undefined2 *)PTR_DAT_0600d258 = 0;
  puVar3 = (undefined2 *)PTR_DAT_0600d290;
  if (*puVar2 != '\0') {
    puVar3 = (undefined2 *)PTR_DAT_0600d244;
  }
  uVar5 = 0;
  puVar4 = (undefined2 *)PTR_LAB_0600d294;
  do {
    uVar5 = uVar5 + 1;
    *puVar4 = *puVar3;
    puVar4[1] = puVar3[1];
