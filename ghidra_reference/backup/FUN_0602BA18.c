/* FUN_0602BA18  0x0602BA18 */


void FUN_0602ba18(ushort *param_1,ushort *param_2,ushort *param_3,uint param_4,uint param_5)

{
  ...
  iVar3 = (int)sRam0602bb20;
  uVar2 = DAT_0602bb1c & (ushort)(param_4 >> 5);
  iVar6 = 0;
  do {
    iVar5 = 0x40;
    puVar4 = param_2;
