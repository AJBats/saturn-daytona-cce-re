/* FUN_0602F21C  0x0602F21C */


uint FUN_0602f21c(int param_1,undefined4 param_2,undefined4 param_3,int param_4)
...
LAB_0602f2e8:
    ...
    if ((param_1 == 3) || ((*(byte *)((int)unaff_r13 + 7) & 4) != 0)) {
      ...
      if (cVar2 == '\x01') goto LAB_0602f2c0;
      if (cVar2 == '\x02') goto LAB_0602f2e8;
    }
