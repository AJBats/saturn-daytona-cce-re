...
void FUN_060078e8(undefined4 param_1,undefined4 param_2,undefined4 param_3,int param_4)
...
LAB_060079a0:
  ...
  if ((*(byte *)(unaff_r13 + 7) & 4) != 0) {
    ...
    if (cVar1 == '\0') goto LAB_0600797c;
    if (cVar1 == '\x01') goto LAB_06007988;
    if (cVar1 == '\x02') goto LAB_060079a0;
  }
