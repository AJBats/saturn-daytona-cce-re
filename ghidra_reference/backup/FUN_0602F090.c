/* FUN_0602F090  0x0602F090 */


uint FUN_0602f090(void)

{
  ...
  uVar1 = FUN_0602f0d8((int)(short)*(undefined4 *)(unaff_gbr + 0x18));
  if ((in_sr & 1) == 0) {
    return uVar1;
  }
  FUN_0602f0d8();
...
LAB_0602f0d0:
    ...
    if ((bVar5 & 1) != 0) {
      ...
      if (iVar2 == 1) goto LAB_0602f0cc;
      if (iVar2 == 2) goto LAB_0602f0d0;
    }
    uVar3 = *(undefined4 *)(in_r7 + 0xc);
    uVar4 = *(undefined4 *)(in_r7 + 0x10);
