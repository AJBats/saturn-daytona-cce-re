...

{
  ...
  for (uVar7 = 0; uVar7 < 3; uVar7 = uVar7 + 1) {
    psVar3 = (short *)((uint)uVar7 * 4 + DAT_060020a8);
    if (*psVar3 != 0) {
      uVar6 = 0;
      sVar5 = psVar3[1];
      ...
      while (sVar5 != 0) {
        ...
        *puVar4 = uVar7;
        puVar4[1] = uVar6;
        iVar2 = FUN_060020c0(uVar8);
        if (iVar2 == 2) {
          *(undefined4 *)(iVar9 + 0x14) = 0;
        }
        sVar5 = sVar5 + -1;
        if (*(uint *)(iVar9 + 0x10) < (uint)(int)DAT_0600209e) {
        ...
        uVar8 = uVar8 + 1;
        uVar6 = uVar6 + 1;
        if (8 < (uVar8 & 0xffff)) goto LAB_06002088;
      }
    }
  }
LAB_06002088:
  *DAT_060020bc = (short)uVar8;
  return;
}
