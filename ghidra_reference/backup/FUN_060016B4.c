...

{
  ...
  piVar1 = DAT_060017d8;
  puVar3 = DAT_060017d4 + 5;
  puVar5 = DAT_060017dc;
  for (puVar6 = DAT_060017d4; DAT_060017dc = puVar5, puVar6 < puVar3; puVar6 = puVar6 + 1) {
    *puVar6 = (uint)*(byte *)(*piVar1 + 1) << 0x10 | (uint)*(byte *)(*piVar1 + 2) << 8 |
              (uint)*(byte *)*piVar1 << 0x18 | (uint)((byte *)*piVar1)[3];
    *piVar1 = *piVar1 + 4;
    puVar5 = DAT_060017dc;
  }
  puVar6 = (uint *)((int)DAT_060017d2 + (int)puVar5);
