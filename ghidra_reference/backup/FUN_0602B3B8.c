/* FUN_0602B3B8  0x0602B3B8 */


void FUN_0602b3b8(void)

{
  ...
  iVar12 = iRam0602b53c;
  iVar5 = iRam0602b450;
  pcVar4 = pcRam0602b44c;
  pcVar3 = pcRam0602b448;
  pcVar2 = pcRam0602b444;
  puVar7 = puRam0602b440;
  if (*pcRam0602b444 == '\0') {
    iVar12 = 0;
    uVar9 = 0;
    do {
      sVar1 = sRam0602b43e;
      puVar8 = (undefined4 *)
               ((short)((*pcVar3 * 3 + (short)*pcVar4) * sRam0602b43e) + iVar5 + (uVar9 & 0xff));
  ...
  iVar5 = iRam0602b548;
  puVar7 = puRam0602b540;
  iVar10 = 0;
  cVar13 = '\0';
  puVar6 = (undefined4 *)(((*pcVar2 * 5 + (int)*pcVar3) * 0x18 & 0xffU) + iRam0602b544);
  *puVar6 = *puRam0602b540;
  puVar6[1] = puVar7[1];
  puVar6[2] = puVar7[2];
  puVar6[3] = puVar7[3];
  puVar6[4] = puVar7[4];
