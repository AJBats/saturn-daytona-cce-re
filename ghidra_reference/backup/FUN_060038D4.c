...
void FUN_060038d4(byte param_1,uint param_2,byte param_3,byte param_4,int param_5,uint param_6,
                 uint param_7)

{
  ...
  iVar4 = (int)DAT_060039ce;
  uVar1 = (ushort)(param_6 >> 5) & DAT_060039cc;
