...

{
  ...
  uVar8 = in_r0 + 8U & DAT_060053d0;
  if (uVar8 == 0) {
    return DAT_060053d0;
  }
  psVar6 = (short *)(DAT_060053d4 + (uVar8 >> 2));
  iVar9 = (int)*psVar6;
  iVar11 = (int)psVar6[1];
  uVar10 = iVar9 * 4;
  uVar12 = iVar11 * 4;
  ...
  do {
    ...
    *(uint *)(param_1 + 4) = uVar13 << 0x10 | uVar17 >> 0x10;
    ...
    iVar7 = iVar7 + -1;
    *(uint *)(param_1 + 8) = uVar14 << 0x10 | uVar17 >> 0x10;
