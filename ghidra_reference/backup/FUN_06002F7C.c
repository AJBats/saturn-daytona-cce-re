...

{
  ...
  do {
    iVar4 = 0;
    iVar10 = 0;
    puVar3 = (undefined4 *)((short)((short)iVar11 * DAT_060030dc) + iVar1);
  ...
  do {
    ...
    puVar3 = (undefined4 *)((char)((char)iVar11 * '\x14') + DAT_060030f4);
  ...
  do {
    ...
    puVar2 = (undefined4 *)(uVar9 + DAT_06003100);
  ...
  do {
    iVar10 = 0;
    puVar2 = (undefined4 *)((short)((short)iVar11 * 0x30) + DAT_06003210);
    puVar3 = (undefined4 *)(iVar11 * 0x10 + iVar4);
    iVar8 = 0;
    piVar7 = (int *)(iVar11 * 4 + DAT_06003214);
    do {
