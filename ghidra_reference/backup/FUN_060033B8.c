...

{
  ...
  if (*DAT_06003444 == '\0') {
    ...
    do {
      sVar1 = DAT_0600343e;
      puVar8 = (undefined4 *)
               ((short)((*pcVar3 * 3 + (short)*pcVar4) * DAT_0600343e) + iVar5 + (uVar9 & 0xff));
  ...
  iVar10 = 0;
  cVar13 = '\0';
  puVar6 = (undefined4 *)(((*pcVar2 * 5 + (int)*pcVar3) * 0x18 & 0xffU) + DAT_06003544);
  *puVar6 = *DAT_06003540;
  puVar6[1] = puVar7[1];
  puVar6[2] = puVar7[2];
  puVar6[3] = puVar7[3];
