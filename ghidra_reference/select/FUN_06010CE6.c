/* FUN_06010CE6  0x06010CE6 */


/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Instruction at (ram,0x06010d10) overlaps instruction at (ram,0x06010d0f)
    */

void FUN_06010ce6(byte param_1,uint param_2,undefined4 param_3,int param_4)

{
  ...
  *(short *)(unaff_gbr + 0x90) = sVar3 + 1;
  pcVar4 = DAT_0600f32c;
  puVar6 = (undefined2 *)(PTR_DAT_06010d50 + sVar3 * 8);
  ...
  case 10:
    *(undefined4 *)(uVar7 + 0x14) = unaff_r8;
    ...
    halt_baddata();
  case 0xc:
    *DAT_0600f32c = (char)(param_2 >> 4) * '\n' + ((byte)puVar6 & param_1);
    pbVar5 = DAT_0600f330;
    pcVar4[1] = (*(byte *)(uVar7 + 2) >> 4) * '\n' + (*(byte *)(uVar7 + 2) & 0xf);
    bVar1 = *pbVar5;
    pcVar4[2] = bVar1 & 0xf;
    pcVar4[3] = bVar1 >> 4;
    pcVar4[4] = (*(byte *)(uVar7 + 6) >> 4) * '\n' + (*(byte *)(uVar7 + 6) & 0xf);
    pcVar4[5] = (pbVar5[4] >> 4) * '\n' + (pbVar5[4] & 0xf);
    pcVar4[6] = (pbVar5[6] >> 4) * '\n' + (pbVar5[6] & 0xf);
    pcVar4[7] = (pbVar5[8] >> 4) * '\n' + (pbVar5[8] & 0xf);
    return;
