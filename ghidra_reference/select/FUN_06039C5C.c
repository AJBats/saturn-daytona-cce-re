/* FUN_06039C5C  0x06039C5C */


uint FUN_06039c5c(int param_1,undefined4 param_2,undefined4 param_3,int param_4)
...
LAB_06039d28:
    ...
    if ((param_1 == 3) || ((*(byte *)((int)unaff_r13 + 7) & 4) != 0)) {
      ...
      if (cVar2 == '\x01') goto LAB_06039d00;
      if (cVar2 == '\x02') goto LAB_06039d28;
    }
