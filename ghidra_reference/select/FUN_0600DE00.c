...

{
  ...
  piVar1 = DAT_0600df44;
  puVar3 = DAT_0600df40 + 5;
  puVar7 = DAT_0600df48;
  for (puVar8 = DAT_0600df40; DAT_0600df48 = puVar7, puVar8 < puVar3; puVar8 = puVar8 + 1) {
  ...
  puVar8 = (undefined4 *)((int)DAT_0600df3e + (int)puVar7);
