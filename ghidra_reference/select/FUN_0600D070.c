...

{
  ...
  do {
    iVar4 = 0;
    iVar10 = 0;
    puVar3 = (undefined4 *)((short)((short)iVar11 * DAT_0600d1d0) + iVar1);
  ...
  do {
    ...
    puVar3 = (undefined4 *)((char)((char)iVar11 * '\x14') + DAT_0600d1e8);
  ...
  do {
    ...
    puVar2 = (undefined4 *)(uVar9 + iRam0600d1f4);
  ...
  do {
    iVar10 = 0;
    puVar2 = (undefined4 *)((short)((short)iVar11 * 0x30) + iRam0600d304);
    puVar3 = (undefined4 *)(iVar11 * 0x10 + iVar4);
    iVar8 = 0;
    piVar7 = (int *)(iVar11 * 4 + iRam0600d308);
    do {
