...
void FUN_06012328(undefined4 param_1,undefined4 param_2,undefined4 param_3,int param_4)
...
LAB_060123e0:
  ...
  if ((*(byte *)(unaff_r13 + 7) & 4) != 0) {
    ...
    if (cVar1 == '\0') goto LAB_060123bc;
    if (cVar1 == '\x01') goto LAB_060123c8;
    if (cVar1 == '\x02') goto LAB_060123e0;
  }
