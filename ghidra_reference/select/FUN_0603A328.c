/* FUN_0603A328  0x0603A328 */


void FUN_0603a328(undefined4 param_1,undefined4 param_2,undefined4 param_3,int param_4)
...
LAB_0603a3e0:
  ...
  if ((*(byte *)(unaff_r13 + 7) & 4) != 0) {
    ...
    if (cVar1 == '\0') goto LAB_0603a3bc;
    if (cVar1 == '\x01') goto LAB_0603a3c8;
    if (cVar1 == '\x02') goto LAB_0603a3e0;
  }
