/* FUN_06039AD0  0x06039AD0 */


uint FUN_06039ad0(void)

{
  ...
  uVar1 = FUN_06039b18((int)(short)*(undefined4 *)(unaff_gbr + 0x18));
  if ((in_sr & 1) == 0) {
    return uVar1;
  }
  FUN_06039b18();
...
LAB_06039b10:
    ...
    if ((bVar5 & 1) != 0) {
      ...
      if (iVar2 == 1) goto LAB_06039b0c;
      if (iVar2 == 2) goto LAB_06039b10;
    }
    uVar3 = *(undefined4 *)(in_r7 + 0xc);
    uVar4 = *(undefined4 *)(in_r7 + 0x10);
