/* FUN_06030238  0x06030238 */


void FUN_06030238(undefined4 param_1)

{
  ...
  do {
    ...
    while (in_r2 = (code *)PTR_FUN_060302f4, param_1 = DAT_060302f0,
          (int)(uint)(byte)PTR_DAT_060302f8[unaff_r13 + (char)(*in_stack_00000010 * '\x03')] <=
          unaff_r12) {
      do {
        ...
        for (; iVar1 < (int)(uint)(byte)PTR_DAT_060302f8
                                        [unaff_r13 + (char)(*in_stack_0000000c * '\x03')];
            iVar1 = iVar1 + 1) {
