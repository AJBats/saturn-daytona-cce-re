/* FUN_0603AD40  0x0603AD40 */


void FUN_0603ad40(int param_1,undefined4 *param_2)

{
  ...
  *param_2 = (int)((ulonglong)
                   ...
                   (longlong)iRam0603ad9c) >> 0x20);
  param_2[1] = (((int)uVar5 >> 1) - uVar4) + iRam0603ada0;
  param_2[2] = ((int)-uVar5 >> 1) + ((int)uVar4 >> 1) + (param_1 >> 1) + iRam0603ada4;
