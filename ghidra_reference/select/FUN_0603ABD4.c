/* FUN_0603ABD4  0x0603ABD4 */


/* WARNING: Removing unreachable block (ram,0x0603abe6) */
/* WARNING: Removing unreachable block (ram,0x0603abf2) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0603abd4(int *param_1,int *param_2)
