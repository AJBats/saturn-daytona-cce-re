/* FUN_06028C1C  0x06028C1C */


void FUN_06028c1c(byte param_1,uint param_2,byte param_3,byte param_4,int param_5,uint param_6,
                 uint param_7)

{
  ...
  iVar4 = (int)DAT_06028d16;
  uVar1 = (ushort)(param_6 >> 5) & DAT_06028d14;
