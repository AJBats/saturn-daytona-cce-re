/* FUN_06037E94  0x06037E94 */


uint FUN_06037e94(uint *param_1,int param_2)

{
  ...
  uVar7 = param_2 + 8U & DAT_06037eec;
  if (uVar7 == 0) {
    return DAT_06037eec;
  }
  iVar8 = (int)*(short *)(PTR_DAT_06037ef0 + (uVar7 >> 2));
  iVar10 = (int)*(short *)((int)(PTR_DAT_06037ef0 + (uVar7 >> 2)) + 2);
  uVar9 = iVar8 * 4;
  uVar11 = iVar10 * 4;
  uVar7 = iVar8 * -4;
  iVar6 = 3;
