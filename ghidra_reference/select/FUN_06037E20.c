/* FUN_06037E20  0x06037E20 */


uint FUN_06037e20(uint *param_1,int param_2)

{
  ...
  uVar7 = param_2 + 8U & DAT_06037e84;
  if (uVar7 == 0) {
    return DAT_06037e84;
  }
  iVar8 = (int)*(short *)(PTR_DAT_06037e88 + (uVar7 >> 2));
  iVar10 = (int)*(short *)((int)(PTR_DAT_06037e88 + (uVar7 >> 2)) + 2);
  uVar9 = iVar8 * 4;
  uVar11 = iVar10 * 4;
  uVar7 = iVar8 * -4;
  iVar6 = 3;
