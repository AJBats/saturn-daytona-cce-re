...

{
  ...
  if (*DAT_060043cc == '\0') {
    ...
    do {
      ...
      puVar6 = (undefined4 *)
               ((short)((*pcVar3 * 3 + (short)*pcVar4) * DAT_060043c6) + iVar5 + (uVar9 & 0xff));
  ...
  iVar10 = 0;
  cVar13 = '\0';
  puVar6 = (undefined4 *)(((*pcVar2 * 5 + (int)*pcVar3) * 0x18 & 0xffU) + DAT_060044c8);
  *DAT_060044cc = *puVar6;
  puVar7[1] = puVar6[1];
  puVar7[2] = puVar6[2];
  puVar7[3] = puVar6[3];
