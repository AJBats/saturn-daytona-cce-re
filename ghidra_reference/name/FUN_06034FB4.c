/* FUN_06034FB4  0x06034FB4 */


uint FUN_06034fb4(int param_1,undefined4 param_2,undefined4 param_3,int param_4)
...
LAB_06035080:
    ...
    if ((param_1 == 3) || ((*(byte *)((int)unaff_r13 + 7) & 4) != 0)) {
      ...
      if (cVar2 == '\x01') goto LAB_06035058;
      if (cVar2 == '\x02') goto LAB_06035080;
    }
