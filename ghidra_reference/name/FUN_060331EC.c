/* FUN_060331EC  0x060331EC */


uint FUN_060331ec(uint *param_1,int param_2)

{
  ...
  uVar7 = param_2 + 8U & DAT_06033244;
  if (uVar7 == 0) {
    return DAT_06033244;
  }
  iVar8 = (int)*(short *)(PTR_DAT_06033248 + (uVar7 >> 2));
  iVar10 = (int)*(short *)((int)(PTR_DAT_06033248 + (uVar7 >> 2)) + 2);
  uVar9 = iVar8 * 4;
  uVar11 = iVar10 * 4;
  uVar7 = iVar8 * -4;
  iVar6 = 3;
