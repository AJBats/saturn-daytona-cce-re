/* FUN_0602A9BA  0x0602A9BA */


void FUN_0602a9ba(void)

{
  ...
  puVar8 = (undefined4 *)((int)DAT_0602a9ce + (int)DAT_0602a9dc);
  for (puVar7 = DAT_0602a9dc; puVar7 < puVar8; puVar7 = puVar7 + 0x12) {
    iVar6 = 0;
    puVar3 = puVar7;
    do {
