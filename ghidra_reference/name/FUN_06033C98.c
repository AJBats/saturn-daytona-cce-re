/* FUN_06033C98  0x06033C98 */


int FUN_06033c98(int param_1)

{
  ...
  if ((in_sr & 1) != 1) {
                    /* WARNING: Could not recover jumptable at 0x06033ca0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    iVar1 = (*(code *)(*(short *)(in_r0 + 0x6033ca4) + 0x6033ca4))();
    return iVar1;
  }
