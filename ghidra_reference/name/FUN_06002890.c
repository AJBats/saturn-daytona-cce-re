...

{
  ...
  piVar1 = DAT_060029d4;
  puVar3 = DAT_060029d0 + 5;
  puVar7 = DAT_060029d8;
  for (puVar8 = DAT_060029d0; DAT_060029d8 = puVar7, puVar8 < puVar3; puVar8 = puVar8 + 1) {
  ...
  puVar8 = (undefined4 *)((int)DAT_060029ce + (int)puVar7);
