/* FUN_06034618  0x06034618 */


void FUN_06034618(void)

{
  ...
  puVar12 = (uint *)(int)sRam06034728;
  piVar11 = (int *)(iRam0603472c + (int)unaff_r14);
  do {
    iVar15 = (int)*psVar16;
    ...
    *puVar12 = uVar10;
    ...
    if ((int)uVar10 < 0x80001) {
      ...
      if (((int)uVar7 <= iVar15) && ((int)uVar9 <= iVar15)) {
        if ((-iVar15 <= (int)uVar7) && (-iVar15 <= (int)uVar9)) goto LAB_060346a8;
      }
      puVar14[1] = uVar10 + 1;
    }
    else {
        ...
        *puVar14 = iVar15 << 0x10 | uVar9 & 0xffff;
        if ((iVar15 <= *(short *)(unaff_gbr + 0x18)) &&
          ...
          if (((int)uVar9 <= (int)*(short *)(unaff_gbr + 0x1a)) &&
             (-(int)*(short *)(unaff_gbr + 0x1a) <= (int)uVar9)) goto LAB_060346da;
        }
