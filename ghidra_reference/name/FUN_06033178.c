/* FUN_06033178  0x06033178 */


uint FUN_06033178(uint *param_1,int param_2)

{
  ...
  uVar7 = param_2 + 8U & DAT_060331dc;
  if (uVar7 == 0) {
    return DAT_060331dc;
  }
  iVar8 = (int)*(short *)(PTR_DAT_060331e0 + (uVar7 >> 2));
  iVar10 = (int)*(short *)((int)(PTR_DAT_060331e0 + (uVar7 >> 2)) + 2);
  uVar9 = iVar8 * 4;
  uVar11 = iVar10 * 4;
  uVar7 = iVar8 * -4;
  iVar6 = 3;
