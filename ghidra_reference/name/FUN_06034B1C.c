/* FUN_06034B1C  0x06034B1C */


uint FUN_06034b1c(undefined4 param_1,undefined4 param_2,undefined4 param_3,int param_4)
...
LAB_06035738:
  ...
  if ((*(byte *)(unaff_r13 + 7) & 4) != 0) {
    ...
    uVar1 = 0;
    if (cVar2 == '\0') goto LAB_06035714;
    if (cVar2 == '\x01') goto LAB_06035720;
    if (cVar2 == '\x02') goto LAB_06035738;
  }
