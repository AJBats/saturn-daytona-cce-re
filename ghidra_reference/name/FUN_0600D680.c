...
void FUN_0600d680(undefined4 param_1,undefined4 param_2,undefined4 param_3,int param_4)
...
LAB_0600d738:
  ...
  if ((*(byte *)(unaff_r13 + 7) & 4) != 0) {
    ...
    if (cVar1 == '\0') goto LAB_0600d714;
    if (cVar1 == '\x01') goto LAB_0600d720;
    if (cVar1 == '\x02') goto LAB_0600d738;
  }
