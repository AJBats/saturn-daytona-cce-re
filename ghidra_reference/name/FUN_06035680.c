/* FUN_06035680  0x06035680 */


void FUN_06035680(undefined4 param_1,undefined4 param_2,undefined4 param_3,int param_4)
...
LAB_06035738:
  ...
  if ((*(byte *)(unaff_r13 + 7) & 4) != 0) {
    ...
    if (cVar1 == '\0') goto LAB_06035714;
    if (cVar1 == '\x01') goto LAB_06035720;
    if (cVar1 == '\x02') goto LAB_06035738;
  }
