/* FUN_0602C09C  0x0602C09C */


void FUN_0602c09c(void)

{
  ...
  puVar2 = PTR_PTR_0602c204;
  puVar1 = PTR_DAT_0602c200;
  iVar12 = 0;
  do {
    iVar8 = 0;
  ...
  do {
    iVar8 = 0;
    iVar7 = 0;
    puVar6 = (undefined4 *)((short)((short)iVar12 * DAT_0602c1fc) + iVar3);
    piVar10 = (int *)(puVar2 + iVar12 * 4);
    do {
      iVar8 = iVar8 + 2;
  ...
  do {
    ...
    puVar6 = (undefined4 *)(PTR_DAT_0602c214 + (char)((char)iVar12 * '\x14'));
    do {
      iVar7 = iVar7 + 1;
      ...
      *puVar5 = *puVar9;
      puVar5[1] = puVar9[1];
      puVar5[2] = puVar9[2];
      puVar4 = PTR_DAT_0602c21c;
      puVar2 = PTR_DAT_0602c218;
      puVar5 = puVar5 + 3;
      iVar8 = iVar8 + 0xc;
    } while (iVar7 < 5);
    iVar12 = iVar12 + 1;
  ...
  do {
    ...
    puVar5 = (undefined4 *)(uVar11 + DAT_0602c220);
  ...
  do {
    iVar8 = 0;
    puVar5 = (undefined4 *)((short)((short)iVar12 * 0x30) + DAT_0602c330);
    puVar6 = (undefined4 *)(puVar2 + iVar12 * 0x10);
    iVar7 = 0;
    piVar10 = (int *)(PTR_PTR_0602c334 + iVar12 * 4);
    do {
      *(undefined4 *)(*piVar10 + iVar7 + 8) = *puVar6;
