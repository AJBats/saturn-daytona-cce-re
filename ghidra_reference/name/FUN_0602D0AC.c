/* FUN_0602D0AC  0x0602D0AC */


void FUN_0602d0ac(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,
...

{
  ...
  uVar1 = DAT_0602d150;
  uVar2 = *(uint *)((int)auStack_28 + in_r0);
  puVar9 = (ushort *)(param_7 * 0x80 + param_6 * 2 + param_5);
  iVar6 = (int)DAT_0602d14e;
