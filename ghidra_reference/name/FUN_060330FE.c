/* FUN_060330FE  0x060330FE */


uint FUN_060330fe(int param_1)

{
  ...
  uVar7 = in_r0 + 8U & DAT_06033168;
  if (uVar7 == 0) {
    return DAT_06033168;
  }
  iVar8 = (int)*(short *)(PTR_DAT_0603316c + (uVar7 >> 2));
  iVar10 = (int)*(short *)((int)(PTR_DAT_0603316c + (uVar7 >> 2)) + 2);
  uVar9 = iVar8 * 4;
  uVar11 = iVar10 * 4;
  uVar7 = iVar8 * -4;
  iVar6 = 3;
