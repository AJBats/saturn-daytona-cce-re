/* FUN_0602CB38  0x0602CB38 */


void FUN_0602cb38(ushort *param_1,ushort *param_2,ushort *param_3,uint param_4,uint param_5)

{
  ...
  iVar3 = (int)DAT_0602cc40;
  uVar2 = DAT_0602cc3c & (ushort)(param_4 >> 5);
  iVar6 = 0;
  do {
    iVar5 = 0x40;
    puVar4 = param_2;
