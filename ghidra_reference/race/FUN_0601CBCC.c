...

{
  ...
  if (*DAT_0601cc58 == '\0') {
    ...
    do {
      ...
      puVar6 = (undefined4 *)
               ((short)((*pcVar3 * 3 + (short)*pcVar4) * DAT_0601cc52) + iVar5 + (uVar9 & 0xff));
  ...
  iVar10 = 0;
  cVar13 = '\0';
  puVar6 = (undefined4 *)(((*pcVar2 * 5 + (int)*pcVar3) * 0x18 & 0xffU) + DAT_0601cd54);
  *DAT_0601cd58 = *puVar6;
  puVar7[1] = puVar6[1];
  puVar7[2] = puVar6[2];
  puVar7[3] = puVar6[3];
