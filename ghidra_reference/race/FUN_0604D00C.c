...
undefined4 FUN_0604d00c(uint param_1,uint param_2,uint param_3,uint param_4)

{
  ...
  uVar9 = param_1 >> 0x14 & DAT_0604d140;
  uVar11 = param_3 >> 0x14 & DAT_0604d140;
  param_1 = param_1 & DAT_0604d144;
  param_3 = param_3 & DAT_0604d144;
...
FUN_0604d03e:
        if (uVar11 == 0) {
          if ((param_3 == 0) && (param_4 == 0)) goto LAB_0604cfcc;
        ...
        if (-0x36 < (int)uVar9) {
          ...
          lVar1 = (ulonglong)(param_3 | DAT_0604d148) * (ulonglong)(param_1 | DAT_0604d148);
          uVar6 = (uint)lVar1;
          lVar2 = (ulonglong)param_4 * (ulonglong)(param_1 | DAT_0604d148);
          uVar8 = (uint)lVar2;
          lVar3 = (ulonglong)(param_3 | DAT_0604d148) * (ulonglong)param_2;
...
LAB_0604cfcc:
    ...
    if ((param_3 != 0) || (param_4 != 0)) goto code_r0x0604cfde;
