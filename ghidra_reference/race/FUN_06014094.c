...
int FUN_06014094(int param_1,short *param_2,ushort param_3,ushort param_4,short param_5,
...

{
  ...
  iVar2 = (*DAT_060140d8)(DAT_060140e8);
  if (iVar2 == 0) {
    iVar2 = 0;
  }
  else {
    ...
    *(undefined2 *)(iVar2 + 0x22) = param_6;
    ...
    for (uVar10 = 0; uVar10 < param_4; uVar10 = uVar10 + 1) {
      ...
      param_2 = (short *)((int)param_2 + (int)DAT_060141c6);
