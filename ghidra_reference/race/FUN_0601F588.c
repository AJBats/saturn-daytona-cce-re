...
void FUN_0601f588(undefined4 param_1,undefined4 param_2,undefined4 param_3,int param_4)
...
LAB_0601f640:
  ...
  if ((*(byte *)(unaff_r13 + 7) & 4) != 0) {
    ...
    if (cVar1 == '\0') goto LAB_0601f61c;
    if (cVar1 == '\x01') goto LAB_0601f628;
    if (cVar1 == '\x02') goto LAB_0601f640;
  }
