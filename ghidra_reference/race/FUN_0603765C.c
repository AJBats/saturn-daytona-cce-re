...
int FUN_0603765c(undefined2 param_1)

{
  ...
  *(undefined2 *)(PTR_DAT_06037690 + *(char *)(DAT_0603768a + unaff_r14) * 2) = param_1;
  puVar3 = (uint *)(DAT_0603768c + unaff_r14);
  if ((((int)DAT_0603768e & (*puVar3 | puVar3[1] | puVar3[2] | puVar3[3])) != 0) &&
    ...
    if (((int)DAT_060376ba & uVar6) != 0) {
      iVar2 = FUN_06037bf8(*(undefined4 *)(*(int *)(*(int *)(DAT_060376bc + unaff_r14) + 8) + 0xc));
      return iVar2;
    }
    if (((int)DAT_060376cc & uVar6) == 0) {
      ...
      *(undefined4 *)(DAT_06037848 + unaff_r14) = 8;
      if (bVar9 == 3) {
        iVar2 = 0;
        sVar5 = (short)*(undefined4 *)(**(int **)(DAT_0603784a + unaff_r14) + 0xc);
      }
      else if (bVar9 == 0xc) {
        iVar2 = 2;
        sVar5 = (short)*(undefined4 *)(*(int *)(*(int *)(DAT_0603784a + unaff_r14) + 8) + 0xc);
      }
      else if (((bVar9 & 5) == 5) || (((bVar9 & 5) != 0 && ((bVar9 & 10) == 0)))) {
        iVar8 = **(int **)(DAT_0603784a + unaff_r14);
        iVar2 = 0;
        if ((bVar9 & 1) == 0) {
          iVar8 = *(int *)(*(int *)(DAT_0603784a + unaff_r14) + 8);
          iVar2 = 2;
        }
        sVar5 = (short)*(undefined4 *)(iVar8 + 0xc);
      }
      else {
        iVar8 = *(int *)(*(int *)(DAT_0603784a + unaff_r14) + 4);
        iVar2 = 1;
        if ((bVar9 & 2) == 0) {
          iVar8 = *(int *)(*(int *)(DAT_0603784a + unaff_r14) + 0xc);
          iVar2 = 3;
        }
        sVar5 = (short)*(undefined4 *)(iVar8 + 0xc);
      }
      ...
      if (((iVar8 <= DAT_06037854) || (DAT_06037850 <= iVar8)) &&
        ...
        *(undefined2 *)(DAT_06037888 + unaff_r14) = 8;
        if (iVar2 == 0) {
          ...
          *(uint *)(unaff_r14 + DAT_060378ac) = *(uint *)(unaff_r14 + DAT_060378ac) | uVar6;
          iVar2 = *(int *)(**(int **)(DAT_060378ae + unaff_r14) + 0xc);
        }
        else if (iVar2 == 1) {
          uVar6 = (uint)DAT_060378f6;
          *(uint *)(unaff_r14 + 0x30) = *(uint *)(unaff_r14 + 0x30) | uVar6;
          *(uint *)(unaff_r14 + DAT_060378f8) = *(uint *)(unaff_r14 + DAT_060378f8) | uVar6;
          iVar2 = *(int *)(*(int *)(*(int *)(DAT_060378fa + unaff_r14) + 4) + 0xc);
        }
        else if (iVar2 == 2) {
          uVar6 = (uint)DAT_060378d0;
          *(uint *)(unaff_r14 + 0x30) = *(uint *)(unaff_r14 + 0x30) | uVar6;
          *(uint *)(unaff_r14 + DAT_060378d2) = *(uint *)(unaff_r14 + DAT_060378d2) | uVar6;
          iVar2 = *(int *)(*(int *)(*(int *)(DAT_060378d4 + unaff_r14) + 8) + 0xc);
        }
        else {
          uVar6 = (uint)DAT_0603791c;
          *(uint *)(unaff_r14 + 0x30) = *(uint *)(unaff_r14 + 0x30) | uVar6;
          *(uint *)(unaff_r14 + DAT_0603791e) = *(uint *)(unaff_r14 + DAT_0603791e) | uVar6;
          iVar2 = *(int *)(*(int *)(*(int *)(DAT_06037920 + unaff_r14) + 0xc) + 0xc);
        }
        ...
        *(int *)(unaff_r14 + 0x38) = (int)(short)iVar4;
        ...
        if ((*(char *)(DAT_06037984 + unaff_r14) != '\0') &&
           (iVar2 = DAT_060379cc, *(char *)(DAT_06037984 + unaff_r14) == '\x01')) {
          iVar2 = DAT_06037990;
        }
      ...
      if (iVar2 == 0) {
        ...
        *(uint *)(unaff_r14 + 0x30) = *(uint *)(unaff_r14 + 0x30) | uVar6;
        *(uint *)(unaff_r14 + DAT_060379f0) = *(uint *)(unaff_r14 + DAT_060379f0) | uVar6;
        sVar5 = (short)*(undefined4 *)(**(int **)(DAT_060379f2 + unaff_r14) + 0xc);
      }
      else if (iVar2 == 1) {
        uVar6 = (uint)DAT_06037a12;
        *(uint *)(unaff_r14 + 0x30) = *(uint *)(unaff_r14 + 0x30) | uVar6;
        *(uint *)(unaff_r14 + DAT_06037a14) = *(uint *)(unaff_r14 + DAT_06037a14) | uVar6;
        sVar5 = (short)*(undefined4 *)(*(int *)(*(int *)(DAT_06037a16 + unaff_r14) + 4) + 0xc);
      }
      else if (iVar2 == 2) {
        uVar6 = (uint)DAT_06037a36;
        *(uint *)(unaff_r14 + 0x30) = *(uint *)(unaff_r14 + 0x30) | uVar6;
        *(uint *)(unaff_r14 + DAT_06037a38) = *(uint *)(unaff_r14 + DAT_06037a38) | uVar6;
        sVar5 = (short)*(undefined4 *)(*(int *)(*(int *)(DAT_06037a3a + unaff_r14) + 8) + 0xc);
      }
      else {
        uVar6 = (uint)DAT_06037a5a;
        *(uint *)(unaff_r14 + 0x30) = *(uint *)(unaff_r14 + 0x30) | uVar6;
        *(uint *)(unaff_r14 + DAT_06037a5c) = *(uint *)(unaff_r14 + DAT_06037a5c) | uVar6;
      ...
      iVar2 = iVar2 + (iVar2 >> 2);
      *(int *)(unaff_r14 + DAT_06037b04) = iVar2;
      *(int *)(unaff_r14 + DAT_06037b06) = iVar8 - iVar2;
      *(undefined2 *)(unaff_r14 + DAT_06037b0a) = DAT_06037b08;
      if (*(int *)(unaff_r14 + DAT_06037b0c) == 0) {
        iVar2 = ((int)*(char *)(unaff_r14 + DAT_06037b0e) & 0xfU) * 2;
        if (*(int *)(unaff_r14 + 0x34) < (int)*(short *)(PTR_DAT_06037b14 + iVar2)) {
          if (((int)*(short *)(PTR_DAT_06037b18 + iVar2) < *(int *)(unaff_r14 + 0x34)) &&
      ...
      if ((*(char *)(DAT_06037b62 + unaff_r14) != '\0') &&
         (iVar2 = DAT_06037cb4, *(char *)(DAT_06037b62 + unaff_r14) == '\x01')) {
        iVar2 = DAT_06037b70;
      }
      lVar1 = (longlong)iVar2 * (longlong)*(int *)(unaff_r14 + 0x24);
      *(uint *)(unaff_r14 + 0x24) = (int)((ulonglong)lVar1 >> 0x20) << 0x10 | (uint)lVar1 >> 0x10;
