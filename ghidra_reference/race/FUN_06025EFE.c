/* FUN_06025EFE  0x06025EFE */


int FUN_06025efe(void)

{
  ...
  if (((('\x01' < *DAT_06025f34) && (*DAT_06025fb4 != '\0')) && (*DAT_06025fb8 == '\0')) &&
    ...
    if (*(char *)(unaff_gbr + 0x12) == '\0') {
      ...
      if (*(char *)(in_r0 + DAT_06026016) <= *(char *)(iVar9 + DAT_06026016)) goto LAB_06025f12;
      ...
      iVar8 = (uint)uVar1 * (uint)*(ushort *)(unaff_gbr + 0x1ba) +
              (int)*(short *)(unaff_gbr + 0x1a4);
      if (*(char *)(in_r0 + DAT_06025fac) <= *(char *)(DAT_06025fc8 + DAT_06025fac))
      goto LAB_06025f12;
