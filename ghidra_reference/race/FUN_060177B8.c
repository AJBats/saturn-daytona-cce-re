/* FUN_060177B8  0x060177B8 */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_060177b8(int param_1)

{
  ...
  iVar12 = DAT_060179d8;
  iVar11 = DAT_060179d8 + 4;
  *(int *)((int)aiStack_8 + DAT_060179d8 + 4) = DAT_060179d8;
  piVar6 = (int *)(*(short *)(unaff_gbr + 0x80) * 0x18 + param_1);
  iVar10 = *piVar6;
  iVar13 = piVar6[2];
  iVar16 = piVar6[8];
  *(int *)(&stack0x00000000 + DAT_060179d8) = piVar6[6] - iVar10;
  *(int *)(&stack0x00000008 + DAT_060179d8) = iVar16 - iVar13;
  iVar16 = unaff_r14[2];
  *(int *)(&stack0x0000000c + DAT_060179d8) = *unaff_r14 - iVar10;
  *(int *)(&stack0x00000014 + DAT_060179d8) = iVar16 - iVar13;
  uVar3 = *(uint *)(&stack0x0000000c + DAT_060179d8);
  uVar17 = *(uint *)(&stack0x00000000 + DAT_060179d8);
  uVar4 = uVar3 ^ uVar17;
  if ((int)uVar3 < 0) {
    uVar3 = -uVar3;
  }
  ...
  uVar3 = *(uint *)(&stack0x00000014 + DAT_060179d8);
  uVar17 = *(uint *)(&stack0x00000008 + DAT_060179d8);
  uVar4 = uVar3 ^ uVar17;
  if ((int)uVar3 < 0) {
    uVar3 = -uVar3;
  }
  ...
  uVar3 = *(uint *)(&stack0x00000000 + DAT_060179d8);
  uVar17 = *(uint *)(&stack0x00000000 + DAT_060179d8);
  uVar4 = uVar3 ^ uVar17;
  if ((int)uVar3 < 0) {
    uVar3 = -uVar3;
  ...
  uVar4 = *(uint *)(&stack0x00000008 + DAT_060179d8);
  uVar3 = *(uint *)(&stack0x00000008 + DAT_060179d8);
  uVar8 = uVar4 ^ uVar3;
  if ((int)uVar4 < 0) {
    uVar4 = -uVar4;
  }
  ...
  if (0x10000 < (int)uVar17) {
    ...
    if (*(short *)((int)DAT_060179d2 + (int)unaff_r14) <= iVar10) {
      iVar10 = iVar10 - *(short *)((int)DAT_060179d2 + (int)unaff_r14);
  ...
  *(uint *)(unaff_gbr + 0x34) =
  ...
  iVar13 = uVar17 + DAT_060179dc;
  if (DAT_060179dc * 2 < iVar13) {
    iVar10 = iVar10 + 1;
    iVar13 = iVar13 + DAT_060179dc * -2;
    if (*(short *)((int)DAT_060179d2 + (int)unaff_r14) <= iVar10) {
      iVar10 = 0;
    }
  }
  ...
  *(undefined4 *)((int)aiStack_8 + iVar11 + iVar12 + 4) = in_pr;
  iVar10 = DAT_060179e0 + iVar11 + iVar12;
  iVar16 = DAT_060179e0 + iVar11 + iVar12;
  iVar5 = DAT_060179e0 + iVar11 + iVar12;
  *(int *)((int)aiStack_8 + DAT_060179e0 + iVar11 + iVar12) = DAT_060179e0;
  *(undefined4 *)(&stack0x00000014 + DAT_060179e0 + iVar11 + iVar12) = uVar7;
  *(int *)(&stack0x00000018 + DAT_060179e0 + iVar11 + iVar12) = (int)DAT_060179d4 + (int)unaff_r14;
  *(undefined4 *)(&stack0x00000024 + DAT_060179e0 + iVar11 + iVar12) = 1;
  uVar8 = 0x10000;
  uVar17 = (int)((ulonglong)((longlong)iVar13 * (longlong)iVar13) >> 0x20) << 0x10 |
           (uint)((longlong)iVar13 * (longlong)iVar13) >> 0x10;
  iVar20 = (int)uVar17 >> 1;
  puVar18 = (uint *)(&stack0x00000028 + DAT_060179e0 + iVar11 + iVar12);
  *puVar18 = (iVar20 - iVar13) + 0x8000;
  *(uint *)(&stack0x0000002c + DAT_060179e0 + iVar11 + iVar12) = (iVar13 + 0x8000) - uVar17;
  *(int *)(&stack0x00000030 + DAT_060179e0 + iVar11 + iVar12) = iVar20;
  *(int *)(&stack0x00000034 + DAT_060179e0 + iVar11 + iVar12) = iVar13 + -0x10000;
  *(int *)(&stack0x00000038 + DAT_060179e0 + iVar11 + iVar12) = iVar13 * -2 + 0x10000;
  *(int *)(&stack0x0000003c + DAT_060179e0 + iVar11 + iVar12) = iVar13;
  uVar3 = *puVar14;
  uVar17 = *puVar18;
  uVar4 = uVar3 ^ uVar17;
  if ((int)uVar3 < 0) {
  ...
  uVar4 = puVar14[6];
  uVar3 = *(uint *)(&stack0x0000002c + DAT_060179e0 + iVar11 + iVar12);
  uVar2 = uVar4 ^ uVar3;
  if ((int)uVar4 < 0) {
    uVar4 = -uVar4;
  }
  ...
  uVar4 = puVar14[0xc];
  uVar3 = *(uint *)(&stack0x00000030 + DAT_060179e0 + iVar11 + iVar12);
  uVar2 = uVar4 ^ uVar3;
  if ((int)uVar4 < 0) {
    uVar4 = -uVar4;
  }
  ...
  *(uint *)((int)aiStack_8 + DAT_060179e0 + iVar11 + iVar12 + 4) = uVar17 << 0x10 | uVar24 >> 0x10;
  uVar3 = puVar14[2];
  uVar17 = *puVar18;
  uVar4 = uVar3 ^ uVar17;
  if ((int)uVar3 < 0) {
  ...
  *(uint *)(&stack0x00000004 + DAT_060179e0 + iVar11 + iVar12) = uVar17 << 0x10 | uVar24 >> 0x10;
  uVar3 = *puVar14;
  uVar17 = *(uint *)(&stack0x00000034 + DAT_060179e0 + iVar11 + iVar12);
  uVar4 = uVar3 ^ uVar17;
  if ((int)uVar3 < 0) {
    uVar3 = -uVar3;
  }
  ...
  uVar4 = puVar14[6];
  uVar3 = *(uint *)(&stack0x00000038 + DAT_060179e0 + iVar11 + iVar12);
  uVar2 = uVar4 ^ uVar3;
  if ((int)uVar4 < 0) {
    uVar4 = -uVar4;
  }
  ...
  uVar4 = puVar14[0xc];
  uVar3 = *(uint *)(&stack0x0000003c + DAT_060179e0 + iVar11 + iVar12);
  uVar2 = uVar4 ^ uVar3;
  if ((int)uVar4 < 0) {
    uVar4 = -uVar4;
  }
  ...
  *(uint *)(&stack0x00000008 + DAT_060179e0 + iVar11 + iVar12) = uVar17 << 0x10 | uVar24 >> 0x10;
  uVar3 = puVar14[2];
  uVar17 = *(uint *)(&stack0x00000034 + DAT_060179e0 + iVar11 + iVar12);
  uVar4 = uVar3 ^ uVar17;
  if ((int)uVar3 < 0) {
  ...
  *(uint *)(&stack0x00000010 + DAT_060179e0 + iVar11 + iVar12) = uVar17 << 0x10 | uVar24 >> 0x10;
  *(undefined4 *)(&stack0x00000000 + DAT_060179e0 + iVar11 + iVar12) = 0;
  *(undefined4 *)(&stack0x0000000c + DAT_060179e0 + iVar11 + iVar12) = 0;
  uVar7 = *(undefined4 *)(&stack0x00000004 + DAT_060179e0 + iVar11 + iVar12);
  puVar15 = *(undefined4 **)(&stack0x00000018 + DAT_060179e0 + iVar11 + iVar12);
  *puVar15 = *(undefined4 *)((int)aiStack_8 + DAT_060179e0 + iVar11 + iVar12 + 4);
  puVar15[2] = uVar7;
  ...
  if (*(int *)(&stack0x00000024 + iVar5) != 0) {
    if ((iVar12 != 0) || (uVar19 = DAT_060179d6, iVar11 != 0)) {
      sVar9 = (*DAT_060179e4)();
      uVar19 = -sVar9;
    }
    uVar8 = (uint)uVar19;
