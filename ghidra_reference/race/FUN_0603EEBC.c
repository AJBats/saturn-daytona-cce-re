...

{
  ...
  if (*(char *)(unaff_gbr + 0x94) == '\0') {
    uVar7 = *(uint *)(*(short *)(unaff_gbr + 0x80) * 0x18 + *(int *)(DAT_0603f06c + unaff_r14) +
                     0x10);
    iVar5 = (int)DAT_0603f06e;
    if ((uVar7 & 0x80000000) == 0) {
      if (((uVar7 & 0x40000000) != 0) && ((*(byte *)(unaff_gbr + iVar5) & 0x80) == 0)) {
        ...
        *(int *)(unaff_gbr + 0xa0) = *(int *)(unaff_gbr + 0x70);
        iVar5 = (int)*(short *)((((uVar7 & 0xffff0000) << 2) >> 0x11) + *DAT_0603f0a4) << 0x10;
    ...
    if (*(char *)(unaff_gbr + 0x98) != '\x04') {
      ...
      if ((int)(uVar7 * 0x100) < iVar5) {
        lVar4 = (longlong)(int)((*DAT_0603f0a8 & 0xff00) >> 8 | (*DAT_0603f0a8 & 0xff) << 8) *
                (longlong)(iVar5 << 1);
        iVar5 = *(int *)(unaff_gbr + 0x4c);
        ...
        if ((((*(ushort *)(unaff_gbr + 0x80) & 0xf) != 0) || (*(short *)(unaff_gbr + 0x1a) != 0)) ||
           ((*(uint *)(unaff_gbr + 0x60) & 3) != 0)) goto FUN_0603ef8e;
        lVar4 = (longlong)(int)(uVar7 << 9) *
                (longlong)(int)((*(uint *)(unaff_gbr + 0x60) & 0x7fff) << 1);
        iVar5 = uVar7 * -0x100;
        uVar7 = (int)((ulonglong)lVar4 >> 0x20) << 0x10 | (uint)lVar4 >> 0x10;
      }
      FUN_0603f58c(uVar7 + iVar5);
    }
  }
FUN_0603ef8e:
  ...
  if (iVar5 != 0) {
    *(char *)(unaff_gbr + 0x96) = (char)(iVar5 + -1);
    sVar9 = *(short *)((0x48 - iVar5) * 2 + DAT_0603f0ac);
    if ((*(byte *)(unaff_gbr + 0x9c) & 1) == 1) {
      sVar9 = -sVar9;
    }
    *(short *)(unaff_gbr + 0x1a) = sVar9;
    iVar6 = *(int *)(unaff_gbr + 0x48) + DAT_0603f0a0;
    if (iVar6 < 0) {
      iVar6 = 0;
    }
  ...
  if (iVar5 != 0) {
    ...
    *(char *)(unaff_gbr + 0x97) = (char)iVar5;
    puVar8 = (undefined4 *)((0x55 - iVar5) * 0xc + DAT_0603f0b0);
    uVar10 = puVar8[1];
