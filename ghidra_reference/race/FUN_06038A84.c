...
void FUN_06038a84(undefined4 *param_1)

{
  ...
  iVar4 = DAT_06038b70;
  *(undefined4 *)((char)(*(char *)((int)param_1 + in_r0) * '\x14') + DAT_06038b70) = *param_1;
  ...
  *(undefined4 *)((char)(*(char *)((int)param_1 + in_r0) * '\x14') + iVar4 + 8) = param_1[2];
  uVar2 = (*(code *)PTR_FUN_06038b74)
                    ((char)(*(char *)((int)param_1 + in_r0) * '\x14') + iVar4,iVar3 + (int)param_1);
