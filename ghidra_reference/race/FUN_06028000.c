  ...
  if ((cVar14 == '\0') || (cVar14 == '\x01')) {
    ...
    if (*pcRam060282d4 == '\0') {
      ...
      *puRam06028314 = uRam06028310;
      ...
      case '\x01':
        if (*pcRam06028550 == '\0') {
          (*(code *)PTR_FUN_06028558)(0);
        }
        else {
          (*(code *)PTR_FUN_06028554)();
        }
        (*(code *)PTR_FUN_0602855c)(0);
        if (*pcRam06028560 != '\0') {
      ...
      case '\x02':
        (*(code *)PTR_FUN_0602855c)(0);
        iVar12 = (*(code *)PTR_FUN_06028584)(0);
        if (iVar12 != 0) {
          *pcVar2 = '\x01';
        }
        break;
...
code_r0x06028618:
      ...
      if (*pcRam06028698 != '\0') {
        ...
        *puRam060286b8 = uRam060286b4;
        cVar14 = pcVar2[1];
        if (cVar14 == '\0') {
          iVar12 = (*(code *)PTR_FUN_060286bc)(1,0);
          if (iVar12 != 0) {
            pcVar2[1] = '\x01';
          }
        }
        else if (cVar14 == '\x01') {
          (*(code *)PTR_FUN_060286c0)();
    ...
    if (*pcRam060288e4 == '\0') {
      *puRam060288f0 = 1;
      ...
      do {
        ...
        *piRam06028910 = (short)(((ushort)uVar18 & 0xff) * 0x84) + iRam0602890c;
        ...
        if (acStack_28[uVar18 & 0xff] != '\0') {
          (*(code *)PTR_FUN_06028ab8)(uVar18 & 0xff);
        }
        (*(code *)PTR_FUN_06028abc)(uVar18 & 0xff);
        puVar5 = PTR_FUN_06028afc;
        puVar3 = puRam06028af8;
        cVar14 = pcVar2[uVar18 & 0xff];
        if (cVar14 == '\0') {
          iVar12 = (*(code *)PTR_FUN_06028ac4)(uVar18 & 0xff,1);
          if (iVar12 != 0) {
          ...
          *puRam06028af8 = 0;
          iVar12 = (*(code *)puVar5)();
          if (iVar12 != 0) {
            (*(code *)PTR_FUN_06028b00)();
            (*(code *)PTR_FUN_06028b04)();
      ...
      FUN_060295de((char)(*pcRam060288e8 * '\f') + iRam060288ec);
    }
  }
