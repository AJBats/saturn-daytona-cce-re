...
void FUN_060088c0(int param_1,ushort *param_2)

{
  ...
  piVar4 = DAT_06008a08;
  piVar10 = (int *)(param_1 + *(short *)(*DAT_06008a08 + 0x3c) * 8);
  iVar11 = *piVar10;
  ...
  uVar1 = *param_2;
  iVar7 = (*DAT_06008a0c)((int)(short)uVar1,iVar11,iVar6,piVar10[2] - iVar11);
  pcVar5 = DAT_06008a10;
  *(int *)(*piVar4 + 0x1c) = iVar11 + iVar7 * *(short *)(*piVar4 + 0x3e);
  (*pcVar5)((int)(short)((short)iVar6 - sVar9));
  sVar8 = (*DAT_06008a0c)();
  piVar10 = DAT_06008a18;
  pcVar5 = DAT_06008a10;
  *(short *)(*piVar4 + 0xc) =
       (short)((int)((int)*(short *)(*DAT_06008a18 + 0xc) +
                    (uint)(*(short *)(*DAT_06008a18 + 0xc) < 0)) >> 1) +
       sVar9 + sVar8 * *(short *)(*piVar4 + 0x3e);
  (*pcVar5)((int)(short)(sVar3 - sVar2));
  sVar9 = (*DAT_06008a0c)();
  iVar6 = (int)DAT_06008a06;
  *(short *)(*piVar4 + 0xe) =
