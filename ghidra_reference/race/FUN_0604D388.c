/* FUN_0604D388  0x0604D388 */


undefined4 FUN_0604d388(void)

{
  ...
  *(undefined2 *)(DAT_0604d3bc + iVar1) = *(undefined2 *)(DAT_0604d3ba + iVar1);
  ...
  if (*(short *)(DAT_0604d3be + iVar1) == 0) {
    ...
    (*(code *)PTR_FUN_0604d3d4)();
  }
  (*(code *)PTR_FUN_0604d41c)();
  (*(code *)PTR_FUN_0604d420)();
  (*(code *)PTR_FUN_0604d424)();
  (*(code *)PTR_FUN_0604d428)();
  (*(code *)PTR_FUN_0604d42c)();
  iVar1 = (*(code *)PTR_FUN_0604d430)();
  if (*(short *)(DAT_0604d414 + iVar1) == 0) {
    (*(code *)PTR_FUN_0604d49c)();
  }
  else {
    (*(code *)PTR_FUN_0604d434)();
  }
  (*(code *)PTR_FUN_0604d4a0)();
  (*(code *)PTR_FUN_0604d4a4)();
  (*(code *)PTR_FUN_0604d4a8)();
  uVar2 = (*(code *)PTR_FUN_0604d4ac)();
  return uVar2;
}
