...
void FUN_060058b4(undefined4 param_1,undefined4 param_2,int param_3,undefined4 param_4,char *param_5
                 )

{
  ...
  while( true ) {
    FUN_06005ee0(param_4,2,param_3 + 10);
    ...
    *(undefined1 *)((char)(cVar1 * '\x03') + DAT_06005978) = unaff_r10;
    ...
    FUN_06005052(DAT_060059bc,(short)param_3 * 0x80 + unaff_r8,0x12,3);
    uVar5 = DAT_060059d4;
    iVar4 = DAT_060059d0;
    puVar3 = DAT_060059c8;
    iVar6 = DAT_060059c0;
