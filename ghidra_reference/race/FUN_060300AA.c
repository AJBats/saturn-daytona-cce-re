...
void FUN_060300aa(undefined4 param_1,int param_2)

{
  ...
  puVar13 = (undefined4 *)((uint)(byte)(unaff_r9 * unaff_r14) + in_r3);
  puVar12 = (undefined4 *)((short)(unaff_r12 * in_r2) + in_r1);
  *puVar13 = *puVar12;
  ...
  *(short *)((int)puVar13 + 0xe) = sVar9;
  ...
  (*(code *)PTR_FUN_060304dc)(unaff_r9);
  return;
}
