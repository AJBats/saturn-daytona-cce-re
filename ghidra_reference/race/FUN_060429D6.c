...

{
  ...
  iVar1 = (*in_r3)((int)DAT_06042a90,0x1a);
  if (iVar1 == 0) {
    iVar1 = 0;
    *(undefined2 *)(unaff_r14 + 5) = 0;
    ...
    if (*(short *)(unaff_r14 + 5) < 1) {
      ...
      iVar1 = (*(code *)PTR_FUN_06042ab0)(*unaff_r14,unaff_r14[2],DAT_06042aac);
      if (iVar1 != 0) {
        ...
        *(short *)((int)unaff_r14 + 0xe) = (short)*(undefined4 *)(iVar1 + 0x38);
        ...
        (*(code *)PTR_FUN_06042ab4)
                  ((int)*(short *)((int)unaff_r14 + 0xe),unaff_r14 + 8,unaff_r14 + 9,iVar1);
      }
    }
    ...
    if (iVar1 == 1) {
      ...
      *(short *)((int)unaff_r14 + 0xe) = sVar2;
      (*(code *)PTR_FUN_06042ab8)((int)sVar2,&iStack_24,&iStack_20);
      *unaff_r14 = *psVar3 * 0x10000 - iStack_20 * psVar3[3];
      iVar1 = psVar3[2] * 0x10000 - iStack_24 * psVar3[3];
    }
    else {
      if (iVar1 != 2) {
        return iVar1;
    ...
    unaff_r14[2] = iVar1;
    (*(code *)PTR_FUN_06042b6c)(*unaff_r14,unaff_r14[2],auStack_1c,DAT_06042b68);
    if (sStack_c == 0) {
      iVar1 = -1;
