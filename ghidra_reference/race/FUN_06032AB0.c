...

{
  ...
  sVar4 = 0x30;
  uVar6 = 0;
  iVar3 = sRam06032ba2 + 0x52;
  puVar7 = puRam06032ba8;
  do {
    *puVar7 = 0;
    ...
    *(short *)(puVar7 + 0xc) = sVar4;
    FUN_06032e14(puVar7 + 0xe,0x28,iVar3);
    sVar5 = sVar4 + 0x20;
    if (uVar6 == 3) {
      sVar5 = sVar4 + 0x30;
    }
    ...
    *(short *)(puVar7 + 0x2a) = sVar5;
    FUN_06032e14(puVar7 + 0x2c,0x28,iVar3);
    sVar4 = sVar5 + 0x20;
    if ((ushort)(uVar6 + 1) == 3) {
      sVar4 = sVar5 + 0x30;
    }
    ...
    *(short *)(puVar7 + 0x48) = sVar4;
    FUN_06032e14(puVar7 + 0x4a,0x28,iVar3);
    sVar5 = sVar4 + 0x20;
    if ((ushort)(uVar6 + 2) == 3) {
      sVar5 = sVar4 + 0x30;
    }
    ...
    *(short *)(puVar7 + 0x66) = sVar5;
    FUN_06032e14(puVar7 + 0x68,0x28,iVar3);
    sVar4 = sVar5 + 0x20;
    if ((ushort)(uVar6 + 3) == 3) {
      sVar4 = sVar5 + 0x30;
    }
