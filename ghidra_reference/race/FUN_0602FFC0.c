...

{
  ...
  *(undefined2 *)(*piVar1 + 0x10) = *(undefined2 *)(*piVar2 + 0x10);
  puVar3 = (undefined4 *)(PTR_DAT_06030088 + (*(char *)(*piVar1 + 0x2c) * 3 & 0xffU) * 4);
