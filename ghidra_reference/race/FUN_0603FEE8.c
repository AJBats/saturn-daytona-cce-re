...
void FUN_0603fee8(int param_1,undefined4 param_2,int param_3)

{
  ...
  iVar9 = iRam0603ff44;
  iVar8 = iRam0603ff44 + 4;
  *(int *)((int)aiStack_8 + iRam0603ff44) = iRam0603ff44;
  iVar10 = *(int *)(param_3 + 8);
  uVar11 = *(undefined4 *)(param_3 + 0xc);
  *(undefined4 *)((int)aiStack_8 + iRam0603ff44 + 4) = uVar11;
  *(int *)(&stack0x00000004 + iRam0603ff44) = -iVar10;
  *(int *)(&stack0x0000000c + iRam0603ff44) = iVar10;
  *(undefined4 *)(&stack0x00000014 + iRam0603ff44) = uVar11;
  iVar10 = 3;
  do {
