...

{
  ...
  do {
    ...
    if (cVar1 == '\0') {
      ...
      FUN_06032e14(pcVar10 + 0xe,((-iVar7 >> 8) * (int)sVar8 >> 8) + 0x28,
      ...
      *(short *)(pcVar10 + 4) = *(short *)(pcVar10 + 4) + -6;
      ...
      FUN_06032e14(pcVar10 + 0xe,(int)sVar8,iVar7);
      *(short *)(pcVar10 + 6) = *(short *)(pcVar10 + 6) + sVar2;
      *(short *)(pcVar10 + 2) = *(short *)(pcVar10 + 2) + 1;
      ...
      *(short *)(pcVar10 + 8) = *(short *)(pcVar10 + 8) + 7;
      ...
      FUN_06032e14(pcVar10 + 0xe,(int)*(short *)(pcVar10 + 8),(int)*(short *)(pcVar10 + 10));
    }
    else if (cVar1 == '\x04') {
