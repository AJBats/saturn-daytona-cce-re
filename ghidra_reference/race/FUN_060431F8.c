...

{
  ...
  do {
    if (*psVar9 != 0) {
      *psVar9 = *psVar9 + -1;
      if (*psVar9 < DAT_060432ac) {
        if (*psVar9 < DAT_060432b2) {
          if (*psVar9 < 0x1e) {
            *(undefined1 **)((int)piVar11 + -0x14) = (undefined1 *)((int)piVar11 + -0x14);
            (*(code *)PTR_FUN_060433d4)();
            *(undefined4 *)((int)piVar11 + -0x18) = 0;
            *(undefined4 *)((int)piVar11 + -0x1c) = DAT_060433d8;
            puVar6 = (undefined1 *)((int)piVar11 + -0xc);
            piVar10 = (int *)((int)piVar11 + -0x20);
            piVar11 = (int *)((int)piVar11 + -0x20);
            *piVar10 = (int)puVar6;
            (*(code *)PTR_FUN_060433dc)();
            uVar3 = (*(code *)PTR_FUN_060433e0)();
            iVar7 = (*(code *)puVar2)(uVar3,(int)DAT_060433cc);
            iVar4 = (*(code *)puVar2)(uVar3,(int)DAT_060433ce);
            iVar5 = (*(code *)puVar2)(uVar3,(int)DAT_060433d0);
            ...
            *(int *)(psVar9 + 0x18) = *(int *)(psVar9 + 0x18) + iVar5;
            ...
            iVar7 = (*DAT_060432c4)();
            if (extraout_r2 != *(short *)(PTR_DAT_060432c8 + (iVar7 + -1) * 2)) {
        ...
        *(int *)(psVar9 + 4) = *(int *)(psVar9 + 4) - (int)DAT_060432ae;
        *(int *)(psVar9 + 6) = *(int *)(psVar9 + 6) - (int)DAT_060432b0;
