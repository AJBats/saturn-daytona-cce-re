...
void FUN_0603fe94(uint *param_1,undefined4 param_2,int *param_3)

{
  ...
  iVar7 = iRam0603ff44;
  iVar6 = iRam0603ff44 + 4;
  *(int *)((int)aiStack_8 + iRam0603ff44) = iRam0603ff44;
  iVar8 = *param_3;
  iVar10 = param_3[1];
  *(int *)((int)aiStack_8 + iRam0603ff44 + 4) = iVar10;
  *(int *)(&stack0x00000004 + iRam0603ff44) = -iVar8;
  *(int *)(&stack0x0000000c + iRam0603ff44) = iVar8;
  *(int *)(&stack0x00000014 + iRam0603ff44) = iVar10;
  iVar8 = 3;
  do {
    uVar9 = *param_1;
    uVar11 = param_1[2];
