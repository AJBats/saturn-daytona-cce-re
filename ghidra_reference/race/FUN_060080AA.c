...
void FUN_060080aa(undefined4 param_1,int param_2)

{
  ...
  puVar12 = (undefined4 *)((uint)(byte)(unaff_r9 * unaff_r14) + in_r3);
  puVar11 = (undefined4 *)((short)(unaff_r12 * in_r2) + in_r1);
  *puVar12 = *puVar11;
