  ...
  *puVar2 = *(undefined4 *)(param_1 + 0x14);
  ...
  if ((((*pcVar1 == '\0') && (*pcVar3 < '\x02')) && (*DAT_0602bbb8 == '\0')) &&
    ...
    *DAT_0602bbbc = *(uint *)(param_1 + 0x14);
    ...
    iVar11 = DAT_0602bbc4;
    iVar10 = 0;
    for (asStack_30[0] = 0; asStack_30[0] < (short)(ushort)(byte)puVar5[(char)(*pcVar4 * '\a')];
        asStack_30[0] = asStack_30[0] + 1) {
      iVar10 = iVar10 + *(int *)(param_1 + 0x28 + asStack_30[0] * 4);
      *(int *)(asStack_30[0] * 4 + iVar11) = iVar10;
    }
    *DAT_0602bbc8 = 1;
  }
  pcVar1 = DAT_0602bbcc;
  ...
  if (*DAT_0602bc84 == '\0') {
    ...
    if ((param_2 & 0xffff) == (uint)*DAT_0602bc8c) {
      FUN_0602bddc(param_1,asStack_30,asStack_2c);
    }
    *(short *)(param_1 + 8) = *(short *)(param_1 + 8) + 1;
    if (((*(ushort *)(param_1 + 8) <= *puVar7) && (*DAT_0602bc88 == '\0')) &&
       (*DAT_0602bc90 != '\0')) {
      (*(code *)PTR_FUN_0602bc94)(asStack_2c[0] + 1,asStack_30[0] + 6);
