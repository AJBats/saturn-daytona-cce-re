...

{
  ...
  iVar2 = iRam0603e65c;
  puVar9 = (undefined4 *)((int)aiStack_1c + iRam0603e65c + 0x18);
  iVar1 = iRam0603e65c + 0x14;
  *(int *)((int)aiStack_1c + iRam0603e65c + 0x14) = iRam0603e65c;
  puVar7 = (undefined4 *)*piRam0603e668;
  uVar3 = uRam0603e660;
  for (iVar8 = (int)*pcRam0603e664; iVar8 != 0; iVar8 = iVar8 + -1) {
    if (*(char *)((int)puVar7 + (int)sRam0603e646) < '\x02') {
      if (*pcRam0603e688 != '\0') {
        *(undefined4 *)((int)aiStack_1c + iVar2 + 0x10) = unaff_gbr;
        sVar6 = *(short *)(puVar7 + 0x20);
        if (*(char *)(iRam0603e6a8 + *(char *)((int)sVar6 + puVar7[0x22])) == '\0') {
          ...
          *(undefined2 *)((int)puVar9 + 0x1a) = *(undefined2 *)((int)puVar7 + 0x1a);
          ...
          puVar9[8] = uVar5;
          puVar9[10] = uVar4;
          if ((*pcRam0603e764 == '\0') && (*pcRam0603e768 == '\0')) {
            (*pcRam0603e76c)();
          }
    ...
    else if (*(char *)((int)puVar7 + (int)sRam0603e648) != '\0') {
    ...
    puVar7 = *(undefined4 **)((int)puVar7 + (int)sRam0603e686);
  }
