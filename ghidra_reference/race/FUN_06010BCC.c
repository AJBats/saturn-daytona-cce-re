...

{
  ...
  if ((*(char *)((int)unaff_r14 + in_r0) != '\x01') ||
     (puVar3 = DAT_06010ca8, *DAT_06010ca4 != '\x01')) {
    puVar3 = (undefined4 *)((0x27 - *(char *)((int)unaff_r14 + 0x12)) * 0x100 + DAT_06010cac);
  }
  *unaff_r14 = *puVar3;
  ...
  *(undefined4 *)((int)unaff_r14 + (int)DAT_06010c9a) = 0;
