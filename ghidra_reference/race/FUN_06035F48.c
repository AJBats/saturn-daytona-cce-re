...
LAB_06035fd0:
  ...
  if (iVar3 < DAT_06036094) {
    ...
    uStack_8 = (int)((ulonglong)((longlong)iVar3 * (longlong)iVar3) >> 0x20) << 0x10 |
               (uint)((longlong)iVar3 * (longlong)iVar3) >> 0x10;
    iVar3 = (*(code *)PTR_FUN_0603611c)(uStack_8,uVar4);
  }
  sVar7 = (short)iVar3;
  ...
  *(int *)(iVar10 + unaff_r14) = iVar9;
  ...
  if (uStack_8 != 0) {
    (*(code *)PTR_FUN_06036200)
              (uStack_8,(uint)lVar1 >> 0x18 | (int)((ulonglong)lVar1 >> 0x20) << 8,iVar3);
  }
