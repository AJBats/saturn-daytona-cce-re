...

{
  ...
  pbVar10 = *(byte **)(*DAT_060037d4 + in_r0);
  pbVar16 = (byte *)((short)((unaff_r14 * 2 + in_r3) * 4) + in_r2);
  *pbVar16 = *pbVar10 >> 4;
    ...
    *DAT_060037e8 = 0;
    ...
    if (pbVar16[1] != uVar12) {
      ...
      if (((pbVar16[6] == 1) || (pbVar16[3] == 0)) && ((uint)pbVar16[1] == (uVar14 & 0xffff))) {
        ...
        if (bVar3) {
          FUN_06003ab8(pbVar16,unaff_r10);
        }
      }
      if (*DAT_060039ac != '\0') {
