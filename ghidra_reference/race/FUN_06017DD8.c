...
void FUN_06017dd8(undefined4 param_1,uint *param_2,int *param_3)

{
  ...
  if ((int)uVar7 < DAT_06017f3c) {
    iVar4 = (*DAT_06017f40)(uVar7 << 0x10 | uVar10 >> 0x10);
  }
  else {
    iVar4 = (*DAT_06017f40)(uVar7,param_2 + 2);
    iVar4 = iVar4 * 0x100 + 0x7f;
  }
  if ((int)uVar6 < DAT_06017f3c) {
    _DAT_ffffff14 = (*DAT_06017f40)(uVar6 << 0x10 | uVar9 >> 0x10);
  }
  else {
    iVar5 = (*DAT_06017f40)(uVar6);
    _DAT_ffffff14 = iVar5 * 0x100 + 0x7f;
  }
  *param_3 = *param_2 * -0x10000;
  param_3[1] = param_2[2] << 0x10;
  param_3[2] = param_2[1] * -0x10000;
