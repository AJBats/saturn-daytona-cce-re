...
int FUN_0603e7b0(undefined4 param_1,int param_2,int param_3)

{
  ...
  piVar9 = (int *)((int)&local_4 + DAT_0603e994);
  iVar17 = (int)&local_4 + DAT_0603e994;
  *(int *)((int)auStack_10 + DAT_0603e994 + 8) = DAT_0603e994;
  iVar16 = *(int *)((int)unaff_r14 + (int)DAT_0603e98c);
  ...
  uVar12 = (uint)lVar2;
  *(int *)((int)auStack_10 + DAT_0603e994 + 4) = iVar11;
  *(int *)((int)auStack_10 + DAT_0603e994) = param_3 - iVar14;
  uVar13 = *(uint *)((int)auStack_10 + DAT_0603e994);
  uVar18 = *(uint *)((int)auStack_10 + DAT_0603e994 + 4);
  uVar7 = uVar13 ^ uVar18;
  if ((int)uVar13 < 0) {
    uVar13 = -uVar13;
  }
  ...
  *(int *)((int)auStack_10 + DAT_0603e994 + 4) = iVar11;
  ...
  uVar7 = *(uint *)((int)auStack_10 + DAT_0603e994 + 4);
  uVar13 = *(uint *)((int)auStack_10 + DAT_0603e994 + 4);
  uVar3 = uVar7 ^ uVar13;
  if ((int)uVar7 < 0) {
    uVar7 = -uVar7;
  }
  ...
  *(short *)(unaff_gbr + 0xe) = (short)((uint)piVar15[5] >> 0x10);
  ...
  uVar20 = (*(code *)PTR_FUN_0603e998)(iVar17);
  iVar10 = (int)((ulonglong)uVar20 >> 0x20);
  piVar9 = (int *)((int)DAT_0603e98e + (int)unaff_r14);
  *piVar9 = (int)uVar20;
  piVar9[1] = iVar10;
  piVar9[2] = extraout_r2;
  lVar2 = (longlong)DAT_0603e99c * (longlong)*(int *)(unaff_gbr + 0x48);
  ...
  *unaff_r14 = *unaff_r14 + uVar12;
  ...
  (*DAT_0603e9a0)();
  *(byte *)(unaff_gbr + DAT_0603e990) = *(byte *)(unaff_gbr + DAT_0603e990) & 0x7f;
