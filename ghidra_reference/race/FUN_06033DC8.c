    ...
    *puRam06033f90 = 1;
    do {
      ...
      *piRam06033fb4 = (short)(((ushort)uVar16 & 0xff) * 0x84) + iRam06033fb0;
      ...
      if ((uVar16 & 0xff) == (uint)*pbVar2) {
        *pcVar5 = '\x01';
        (*(code *)PTR_FUN_06033fbc)(uVar16 & 0xff);
        (*(code *)PTR_FUN_06033fc0)();
        if (bVar1) {
          (*(code *)PTR_FUN_06033fc4)(uVar16 & 0xff);
        }
      }
        ...
        if ((*pcRam060341c0 == '\x03') && (*pcRam060341c4 != '\0')) {
          ...
          if ((uVar16 & 0xff) == 0) {
            if (((uVar15 & 0xff) != 0) && (*pbVar4 = *pbVar4 | bVar12, *pbVar4 == 3)) {
              (*(code *)PTR_FUN_060341cc)(uVar16 & 0xff);
            }
          }
    ...
    if ((*pcRam06034350 != -1) &&
      ...
      puVar8 = PTR_FUN_0603443c;
      pcVar3[*pcVar5] = '\x05';
      pcVar3[(int)*pcVar5 ^ 1] = '\x06';
      (*(code *)puVar8)();
      (*(code *)PTR_FUN_06034440)();
      *puRam06034444 = 0;
    }
  }
  else {
    (*(code *)PTR_FUN_06033e8c)((char)(*pcRam06033e84 * '\f') + iRam06033e88);
  }
  if (bVar1) {
    *puRam06034448 = 1;
  }
