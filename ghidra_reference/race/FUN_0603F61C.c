...

{
  ...
  *(int *)((int)auStack_18 + DAT_0603f730 + 4) = DAT_0603f730;
  (*(code *)PTR_SUB_0603f734)(&stack0x00000008 + DAT_0603f730);
  (*(code *)PTR_SUB_0603f738)();
  *(uint *)((int)auStack_18 + iVar5) = *(uint *)(unaff_r14 + 0xc) >> 0x10;
  (*(code *)PTR_SUB_0603f73c)();
  (*(code *)PTR_SUB_0603f740)();
  (*(code *)PTR_SUB_0603f744)();
  ...
  *(int *)(unaff_gbr + 0x5c) = *(int *)(unaff_gbr + 0x38) - *(int *)(&stack0xfffffff8 + iVar5);
  iVar4 = (*(code *)PTR_SUB_0603f750)(DAT_0603f718 + unaff_r14);
