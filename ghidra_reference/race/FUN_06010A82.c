/* FUN_06010A82  0x06010A82 */

void FUN_06010a82(undefined4 *param_1)

{
  ...
  iVar4 = DAT_06010b70;
  *(undefined4 *)((char)(*(char *)((int)param_1 + 0x12) * '\x14') + DAT_06010b70) = *param_1;
  ...
  *(undefined4 *)((char)(*(char *)((int)param_1 + 0x12) * '\x14') + iVar4 + 8) = param_1[2];
  uVar2 = (*DAT_06010b74)((char)(*(char *)((int)param_1 + 0x12) * '\x14') + iVar4,
                          iVar3 + (int)param_1);
