...

{
  ...
  if (iVar3 != 0) {
    ...
    *(char *)(unaff_gbr + 0x97) = (char)iVar3;
    puVar5 = (undefined4 *)((0x55 - iVar3) * 0xc + DAT_0603f0b0);
    uVar7 = puVar5[1];
