/* FUN_0601DC3C  0x0601DC3C */


/* WARNING: Control flow encountered bad instruction data */
/* WARNING: Instruction at (ram,0x0601dc52) overlaps instruction at (ram,0x0601dc51)
    */

void FUN_0601dc3c(int param_1,undefined1 *param_2,undefined4 param_3,int param_4)
