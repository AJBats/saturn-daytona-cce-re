...

{
  ...
  *(undefined2 *)(iVar4 * 8 + iVar3 + 2) = DAT_06047944;
  (*DAT_06047960)();
  *DAT_06047964 = 0x11;
  FUN_0604796c(*(undefined4 *)(DAT_06047948 + 4),(int)uVar6);
  uVar2 = FUN_0604796c(*(undefined4 *)(DAT_06047948 + 8),(int)((ulonglong)uVar6 >> 0x20));
  return uVar2;
}
