...

{
  ...
  iVar2 = DAT_0601665c;
  puVar9 = (undefined4 *)((int)aiStack_1c + DAT_0601665c + 0x18);
  iVar1 = DAT_0601665c + 0x14;
  *(int *)((int)aiStack_1c + DAT_0601665c + 0x14) = DAT_0601665c;
  puVar7 = (undefined4 *)*DAT_06016668;
  uVar3 = DAT_06016660;
  for (iVar8 = (int)*DAT_06016664; iVar8 != 0; iVar8 = iVar8 + -1) {
    if (*(char *)((int)puVar7 + (int)DAT_06016646) < '\x02') {
      if (*DAT_06016688 != '\0') {
        *(undefined4 *)((int)aiStack_1c + iVar2 + 0x10) = unaff_gbr;
        sVar6 = *(short *)(puVar7 + 0x20);
        if (*(char *)(DAT_060166a8 + *(char *)((int)sVar6 + puVar7[0x22])) == '\0') {
          ...
          *(undefined2 *)((int)puVar9 + 0x1a) = *(undefined2 *)((int)puVar7 + 0x1a);
          ...
          puVar9[8] = uVar5;
          puVar9[10] = uVar4;
          if ((*DAT_06016764 == '\0') && (*DAT_06016768 == '\0')) {
            (*DAT_0601676c)();
          }
    ...
    else if (*(char *)((int)puVar7 + (int)DAT_06016648) != '\0') {
    ...
    puVar7 = *(undefined4 **)((int)puVar7 + (int)DAT_06016686);
  }
