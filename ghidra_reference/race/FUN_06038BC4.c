/* FUN_06038BC4  0x06038BC4 */


void FUN_06038bc4(undefined4 *param_1)

{
  ...
  if ((*(char *)((int)param_1 + 0x12) != '\x01') || (puVar3 = DAT_06038ca8, *DAT_06038ca4 != '\x01')
     ) {
    puVar3 = (undefined4 *)((0x27 - *(char *)((int)param_1 + 0x12)) * 0x100 + DAT_06038cac);
  }
  *param_1 = *puVar3;
  param_1[1] = puVar3[1];
  param_1[2] = puVar3[2];
  ...
  *(undefined4 *)((int)param_1 + (int)DAT_06038c9a) = 0;
