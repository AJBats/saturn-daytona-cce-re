...
uint FUN_0602fd94(int param_1,int param_2,ushort param_3,ushort param_4)

{
  ...
  if ((DAT_0602ff0a & *(ushort *)((char)(unaff_r13 * '\f') + param_1)) != 0) {
    iVar2 = (*(code *)PTR_FUN_0602ff0c)((int)*(short *)(*unaff_r14 + 0xe));
    uVar1 = (*(code *)PTR_FUN_0602ff10)((int)*(short *)(*unaff_r14 + 0xe));
