...
/* WARNING: Instruction at (ram,0x0600284a) overlaps instruction at (ram,0x06002848)
    */

void FUN_06002818(int param_1,int param_2,int *param_3,int param_4)

{
  ...
  if (*param_3 != 0) {
    ...
    do {
      puVar16 = puVar16 + 1;
      sVar1 = *(short *)(DAT_060028f4 + (unaff_r14 >> 2) * 2);
      if ((unaff_r14 & 3) == 0) {
LAB_06002850:
        ...
        if ((short)uVar7 < sVar1) goto LAB_06002850;
      }
      else if (sVar1 <= (short)uVar7) goto LAB_06002850;
      uVar7 = *puVar16;
