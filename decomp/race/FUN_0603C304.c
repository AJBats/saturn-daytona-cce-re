/* FUN_0603C304 TU — naked asm shims (decomp source of truth).
 *
 ...
 * its asm body.
 *
 * Originally seeded from src/race/FUN_0603C304.s; now hand-edited.
 */
...
int FUN_0603D4D0(void) asm {
    mov.l r14, @-r15
    mov #0x4C, r0
}

int FUN_0603D4D4(void) asm {
    sts.l pr, @-r15
    mov r4, r14
    mov.l r3, @-r15
    mov r14, r7
...
int FUN_0603EE36(void) asm {
    sts.l pr, @-r15
}

int FUN_0603EE38(void) asm {
    mov.l r14, @-r15
    mov r4, r14
    bsr FUN_0603EE48
    ldc r14, gbr
...
int FUN_0603F506(void) asm {
    sts.l pr, @-r15
}

int FUN_0603F508(void) asm {
    sts.l pr, @-r15
    mov #0x54, r4
    add r14, r4
    mov.l @(0, r4), r1
