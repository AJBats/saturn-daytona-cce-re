/* FUN_06047DF0 TU — naked asm shims (decomp source of truth).
 *
 ...
 * its asm body.
 *
 * Originally seeded from src/race/FUN_06047DF0.s; now hand-edited.
 */
