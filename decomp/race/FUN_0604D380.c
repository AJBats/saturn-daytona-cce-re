/* FUN_0604D380 TU — naked asm shims (decomp source of truth).
 *
 ...
 * its asm body.
 *
 * Originally seeded from src/race/FUN_0604D380.s; now hand-edited.
 */
...
int FUN_0604D8E4(void) asm {
    mov.w .L_wpool_0604D90E, r1
    mov.l @(r0, r1), r4
    mov.w .L_wpool_0604D90C, r1
}

int FUN_0604D8EA(void) asm {
    mov.l @(r0, r1), r5
...
int FUN_0604DEFE(void) asm {
    mov.l r14, @-r15
    mov r0, r14
}

int FUN_0604DF02(void) asm {
    sts.l pr, @-r15
    mov.l r0, @-r15
