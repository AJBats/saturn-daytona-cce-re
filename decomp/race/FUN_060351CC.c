/* FUN_060351CC TU — naked asm shims (decomp source of truth).
 *
 ...
 * its asm body.
 *
 * Originally seeded from src/race/FUN_060351CC.s; now hand-edited.
 */

int FUN_060351CC(void) asm {
    mov.l r14, @-r15
    mov.l r13, @-r15
    mov.l r12, @-r15
    mov.l r11, @-r15
...
int FUN_06037658(void) asm {
    mov.l r14, @-r15
    mov r5, r14
}

int FUN_0603765C(void) asm {
    sts.l pr, @-r15
...
int FUN_06039202(void) asm {
    mov #0x12, r0
}

int FUN_06039204(void) asm {
    mov.l r14, @-r15
    mov r4, r14
    mov.l r13, @-r15
    mov.l r12, @-r15
