/* FUN_06032E44 TU — naked asm shims (decomp source of truth).
 *
 ...
 * its asm body.
 *
 * Originally seeded from src/race/FUN_06032E44.s; now hand-edited.
 */
