/* FUN_06033DC8 TU — naked asm shims (decomp source of truth).
 *
 ...
 * its asm body.
 *
 * Originally seeded from src/race/FUN_06033DC8.s; now hand-edited.
 */
...
int FUN_06034BDC(void) asm {
    mov.l r14, @-r15
    mov r14, r7
}

int FUN_06034BE0(void) asm {
    mov.l r14, @-r15
    mov r14, r6
    mov r14, r5
    jsr @r3
