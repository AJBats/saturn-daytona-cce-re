...
FUN_06002818:
    .byte 0x2F, 0xE6  /* 06002818: mov.l r14,@-r15 */
    .byte 0xE3, 0x00  /* 0600281A: mov #0,r3 */
    .byte 0x95, 0x1B  /* 0600281C: mov.w @(0x36,PC),r5  {0x06002856} */
    .byte 0xE7, 0x40  /* 0600281E: mov #64,r7 */
    .byte 0xD2, 0x0E  /* 06002820: mov.l @(0x38,PC),r2  {[0x0600285C] = 0x06036F3E} */
    .byte 0x2F, 0xD6  /* 06002822: mov.l r13,@-r15 */
    .byte 0x2F, 0xC6  /* 06002824: mov.l r12,@-r15 */
    .byte 0x2F, 0xB6  /* 06002826: mov.l r11,@-r15 */
    .byte 0x2F, 0xA6  /* 06002828: mov.l r10,@-r15 */
    .byte 0xEB, 0x01  /* 0600282A: mov #1,r11 */
    .byte 0x2F, 0x96  /* 0600282C: mov.l r9,@-r15 */
    .byte 0x2F, 0x86  /* 0600282E: mov.l r8,@-r15 */
    .byte 0x4F, 0x22  /* 06002830: sts.l pr,@-r15 */
    .byte 0xE8, 0x68  /* 06002832: mov #104,r8 */
    .byte 0xDA, 0x08  /* 06002834: mov.l @(0x20,PC),r10  {[0x06002858] = 0x06036F40} */
    .byte 0x69, 0x83  /* 06002836: mov r8,r9 */
    .byte 0x2A, 0x30  /* 06002838: mov.b r3,@r10 */
    .byte 0x79, 0x28  /* 0600283A: add #40,r9 */
    .byte 0x60, 0x20  /* 0600283C: mov.b @r2,r0 */
    .byte 0x70, 0xFF  /* 0600283E: add #-1,r0 */
    .byte 0xE1, 0x14  /* 06002840: mov #20,r1 */
    .byte 0x30, 0x12  /* 06002842: cmp/hs r1,r0 */
    .byte 0x8B, 0x01  /* 06002844: bf 0x0600284A */
    .byte 0xA0, 0xF9  /* 06002846: bra 0x06002A3C */
    .byte 0x00, 0x09  /* 06002848: nop */
    .byte 0x40, 0x00  /* 0600284A: shll r0 */
    .byte 0x61, 0x03  /* 0600284C: mov r0,r1 */
    .byte 0xC7, 0x04  /* 0600284E: mova @(0x10,PC),r0  {0x06002860} */
    .byte 0x00, 0x1D  /* 06002850: mov.w @(r0,r1),r0 */
    .byte 0x00, 0x23  /* 06002852: braf r0 */
    .byte 0x00, 0x09  /* 06002854: nop */
    .byte 0x02, 0x40  /* 06002856: .word 0x0240 */
    .byte 0x06, 0x03  /* 06002858: bsrf r6 */
    .byte 0x6F, 0x40  /* 0600285A: mov.b @r4,r15 */
    .byte 0x06, 0x03  /* 0600285C: bsrf r6 */
    .byte 0x6F, 0x3E  /* 0600285E: exts.b r3,r15 */
    ...
    .byte 0x00, 0x24  /* 06002948: mov.b r2,@(r0,r0) */
    .byte 0x00, 0x00  /* 0600294A: .word 0x0000 */
    .byte 0x00, 0x24  /* 0600294C: mov.b r2,@(r0,r0) */
    .byte 0x7D, 0xC4  /* 0600294E: add #-60,r13 */
    .byte 0x00, 0x24  /* 06002950: mov.b r2,@(r0,r0) */
    .byte 0x7D, 0xC0  /* 06002952: add #-64,r13 */
    .byte 0x00, 0x24  /* 06002954: mov.b r2,@(r0,r0) */
    .byte 0x00, 0x00  /* 06002956: .word 0x0000 */
    .byte 0x00, 0x24  /* 06002958: mov.b r2,@(r0,r0) */
    .byte 0x4B, 0xC4  /* 0600295A: .word 0x4BC4 */
    .byte 0x00, 0x24  /* 0600295C: mov.b r2,@(r0,r0) */
    .byte 0x4B, 0xC0  /* 0600295E: .word 0x4BC0 */
    .byte 0x00, 0x24  /* 06002960: mov.b r2,@(r0,r0) */
    .byte 0x00, 0x00  /* 06002962: .word 0x0000 */
    .byte 0x00, 0x24  /* 06002964: mov.b r2,@(r0,r0) */
    .byte 0x27, 0x44  /* 06002966: mov.b r4,@-r7 */
    .byte 0x00, 0x24  /* 06002968: mov.b r2,@(r0,r0) */
    .byte 0x27, 0x40  /* 0600296A: mov.b r4,@r7 */
    .byte 0x00, 0x24  /* 0600296C: mov.b r2,@(r0,r0) */
    .byte 0x00, 0x00  /* 0600296E: .word 0x0000 */
    .byte 0x00, 0x24  /* 06002970: mov.b r2,@(r0,r0) */
    .byte 0x3D, 0x04  /* 06002972: div1 r0,r13 */
    .byte 0x00, 0x24  /* 06002974: mov.b r2,@(r0,r0) */
    .byte 0x3D, 0x00  /* 06002976: cmp/eq r0,r13 */
    .byte 0x00, 0x24  /* 06002978: mov.b r2,@(r0,r0) */
    .byte 0x00, 0x00  /* 0600297A: .word 0x0000 */
    .byte 0x00, 0x24  /* 0600297C: mov.b r2,@(r0,r0) */
    .byte 0x78, 0x44  /* 0600297E: add #68,r8 */
    .byte 0x00, 0x24  /* 06002980: mov.b r2,@(r0,r0) */
    .byte 0x78, 0x40  /* 06002982: add #64,r8 */
    .byte 0x00, 0x24  /* 06002984: mov.b r2,@(r0,r0) */
    .byte 0x00, 0x00  /* 06002986: .word 0x0000 */
    .byte 0x00, 0x24  /* 06002988: mov.b r2,@(r0,r0) */
    .byte 0x2E, 0x44  /* 0600298A: mov.b r4,@-r14 */
    .byte 0x00, 0x24  /* 0600298C: mov.b r2,@(r0,r0) */
    .byte 0x2E, 0x40  /* 0600298E: mov.b r4,@r14 */
    .byte 0x00, 0x24  /* 06002990: mov.b r2,@(r0,r0) */
    .byte 0x00, 0x00  /* 06002992: .word 0x0000 */
    .byte 0x00, 0x24  /* 06002994: mov.b r2,@(r0,r0) */
    .byte 0x42, 0x04  /* 06002996: rotl r2 */
    .byte 0x00, 0x24  /* 06002998: mov.b r2,@(r0,r0) */
    .byte 0x42, 0x00  /* 0600299A: shll r2 */
    .byte 0x00, 0x24  /* 0600299C: mov.b r2,@(r0,r0) */
    .byte 0x00, 0x00  /* 0600299E: .word 0x0000 */
    .byte 0x00, 0x24  /* 060029A0: mov.b r2,@(r0,r0) */
    .byte 0x39, 0xC4  /* 060029A2: div1 r12,r9 */
    .byte 0x00, 0x24  /* 060029A4: mov.b r2,@(r0,r0) */
    .byte 0x39, 0xC0  /* 060029A6: cmp/eq r12,r9 */
    .byte 0x00, 0x24  /* 060029A8: mov.b r2,@(r0,r0) */
    .byte 0x00, 0x00  /* 060029AA: .word 0x0000 */
    .byte 0x00, 0x24  /* 060029AC: mov.b r2,@(r0,r0) */
    .byte 0x5A, 0x44  /* 060029AE: mov.l @(0x10,r4),r10 */
    .byte 0x00, 0x24  /* 060029B0: mov.b r2,@(r0,r0) */
    .byte 0x5A, 0x40  /* 060029B2: mov.l @(0x0,r4),r10 */
    .byte 0x00, 0x24  /* 060029B4: mov.b r2,@(r0,r0) */
    .byte 0x00, 0x00  /* 060029B6: .word 0x0000 */
    .byte 0x00, 0x24  /* 060029B8: mov.b r2,@(r0,r0) */
    .byte 0xDA, 0x44  /* 060029BA: mov.l @(0x110,PC),r10  {[0x06002ACC] = 0x00240000} */
    .byte 0x00, 0x24  /* 060029BC: mov.b r2,@(r0,r0) */
    .byte 0xDA, 0x40  /* 060029BE: mov.l @(0x100,PC),r10  {[0x06002AC0] = 0x00240000} */
    .byte 0x00, 0x24  /* 060029C0: mov.b r2,@(r0,r0) */
    .byte 0x00, 0x00  /* 060029C2: .word 0x0000 */
    .byte 0x00, 0x24  /* 060029C4: mov.b r2,@(r0,r0) */
    .byte 0x89, 0x84  /* 060029C6: bt 0x060028D2 */
    .byte 0x00, 0x24  /* 060029C8: mov.b r2,@(r0,r0) */
    .byte 0x89, 0x80  /* 060029CA: bt 0x060028CE */
    .byte 0x00, 0x24  /* 060029CC: mov.b r2,@(r0,r0) */
    .byte 0x00, 0x00  /* 060029CE: .word 0x0000 */
    .byte 0x00, 0x24  /* 060029D0: mov.b r2,@(r0,r0) */
    .byte 0x8A, 0x44  /* 060029D2: .word 0x8A44 */
    .byte 0x00, 0x24  /* 060029D4: mov.b r2,@(r0,r0) */
    .byte 0x8A, 0x40  /* 060029D6: .word 0x8A40 */
    .byte 0x00, 0x24  /* 060029D8: mov.b r2,@(r0,r0) */
    .byte 0x00, 0x00  /* 060029DA: .word 0x0000 */
    .byte 0x00, 0x25  /* 060029DC: mov.w r2,@(r0,r0) */
    .byte 0x1A, 0x04  /* 060029DE: mov.l r0,@(0x10,r10) */
    .byte 0x00, 0x25  /* 060029E0: mov.w r2,@(r0,r0) */
    .byte 0x1A, 0x00  /* 060029E2: mov.l r0,@(0x0,r10) */
    .byte 0x00, 0x24  /* 060029E4: mov.b r2,@(r0,r0) */
    .byte 0x00, 0x00  /* 060029E6: .word 0x0000 */
    .byte 0x00, 0x24  /* 060029E8: mov.b r2,@(r0,r0) */
    .byte 0x5C, 0x84  /* 060029EA: mov.l @(0x10,r8),r12 */
    .byte 0x00, 0x24  /* 060029EC: mov.b r2,@(r0,r0) */
    .byte 0x5C, 0x80  /* 060029EE: mov.l @(0x0,r8),r12 */
    ...
    .byte 0x38, 0xE8  /* 06002A3E: sub r14,r8 */
    .byte 0x48, 0x09  /* 06002A40: shlr2 r8 */
    .byte 0x48, 0x09  /* 06002A42: shlr2 r8 */
    .byte 0x63, 0x83  /* 06002A44: mov r8,r3 */
    .byte 0x23, 0xB8  /* 06002A46: tst r11,r3 */
    .byte 0x89, 0x00  /* 06002A48: bt 0x06002A4C */
    .byte 0x78, 0x01  /* 06002A4A: add #1,r8 */
    ...
    .byte 0x43, 0x0B  /* 06002A50: jsr @r3 */
    ...
    .byte 0x42, 0x0B  /* 06002A5C: jsr @r2 */
    .byte 0x66, 0x93  /* 06002A5E: mov r9,r6 */
    ...
    .byte 0x43, 0x0B  /* 06002A66: jsr @r3 */
    .byte 0x66, 0x93  /* 06002A68: mov r9,r6 */
    .byte 0x60, 0xA0  /* 06002A6A: mov.b @r10,r0 */
    .byte 0x20, 0x08  /* 06002A6C: tst r0,r0 */
    .byte 0x89, 0x0A  /* 06002A6E: bt 0x06002A86 */
    .byte 0xD3, 0x2A  /* 06002A70: mov.l @(0xA8,PC),r3  {[0x06002B1C] = 0x06036F3F} */
    .byte 0x23, 0xB0  /* 06002A72: mov.b r11,@r3 */
    ...
    .byte 0x41, 0x0B  /* 06002A7C: jsr @r1 */
    .byte 0x66, 0x22  /* 06002A7E: mov.l @r2,r6 */
    .byte 0xD3, 0x26  /* 06002A80: mov.l @(0x98,PC),r3  {[0x06002B1C] = 0x06036F3F} */
    .byte 0xBE, 0x72  /* 06002A82: bsr 0x0600276A */
    .byte 0x64, 0x30  /* 06002A84: mov.b @r3,r4 */
    .byte 0x4C, 0x09  /* 06002A86: shlr2 r12 */
    .byte 0xD5, 0x21  /* 06002A88: mov.l @(0x84,PC),r5  {[0x06002B10] = 0x25E64000} */
    .byte 0x4E, 0x09  /* 06002A8A: shlr2 r14 */
    .byte 0xD2, 0x27  /* 06002A8C: mov.l @(0x9C,PC),r2  {[0x06002B2C] = 0x0602C10E} */
    .byte 0xE7, 0x0A  /* 06002A8E: mov #10,r7 */
    .byte 0x2F, 0x96  /* 06002A90: mov.l r9,@-r15 */
    .byte 0x66, 0x83  /* 06002A92: mov r8,r6 */
    .byte 0xD3, 0x1C  /* 06002A94: mov.l @(0x70,PC),r3  {[0x06002B08] = 0x25E20000} */
    .byte 0x4C, 0x01  /* 06002A96: shlr r12 */
    .byte 0x2F, 0x36  /* 06002A98: mov.l r3,@-r15 */
    .byte 0x4E, 0x01  /* 06002A9A: shlr r14 */
    .byte 0x2F, 0xC6  /* 06002A9C: mov.l r12,@-r15 */
