...
.L_06005BDC:
    ...
    bf/s .L_06005C06
    mov.w r0, @(130, gbr)
    .reloc ., R_SH_IND12W, FUN_06006A6C - 4
    .2byte 0xB000    /* bsr FUN_06006A6C (linker-resolved) */
    mov.l r7, @-r15
    mov.l @r15+, r7
    dt r7
    bf .L_06005BDC
.L_06005BFC:
    ...
    ldc.l @r15+, gbr
.L_06005C06:
    .reloc ., R_SH_IND12W, FUN_06006AAE - 4
    .2byte 0xB000    /* bsr FUN_06006AAE (linker-resolved) */
    mov.l r7, @-r15
    mov.l @r15+, r7
    dt r7
    bf .L_06005BDC
