...
FUN_060045C0:
    .byte 0x2F, 0xE6  /* 060045C0: mov.l r14,@-r15 */
    .byte 0x41, 0x0B  /* 060045C2: jsr @r1 */
    .byte 0xE4, 0x37  /* 060045C4: mov #55,r4 */
    .byte 0x7F, 0x08  /* 060045C6: add #8,r15 */
    .byte 0x64, 0xF3  /* 060045C8: mov r15,r4 */
    .byte 0x74, 0x10  /* 060045CA: add #16,r4 */
    .byte 0x4A, 0x15  /* 060045CC: cmp/pl r10 */
    .byte 0x8B, 0x0E  /* 060045CE: bf 0x060045EE */
    .byte 0x85, 0xD2  /* 060045D0: mov.w @(0x4,r13),r0 */
    .byte 0x67, 0xE3  /* 060045D2: mov r14,r7 */
    .byte 0x24, 0x01  /* 060045D4: mov.w r0,@r4 */
    .byte 0xE6, 0x23  /* 060045D6: mov #35,r6 */
    .byte 0x60, 0xD1  /* 060045D8: mov.w @r13,r0 */
    .byte 0x81, 0xF9  /* 060045DA: mov.w r0,@(0x12,r15) */
    .byte 0x85, 0xD1  /* 060045DC: mov.w @(0x2,r13),r0 */
    .byte 0x60, 0x0D  /* 060045DE: extu.w r0,r0 */
    .byte 0x2F, 0x06  /* 060045E0: mov.l r0,@-r15 */
    .byte 0x84, 0xF4  /* 060045E2: mov.b @(0x4,r15),r0 */
    .byte 0x64, 0x03  /* 060045E4: mov r0,r4 */
    .byte 0x48, 0x0B  /* 060045E6: jsr @r8 */
    .byte 0xE5, 0x37  /* 060045E8: mov #55,r5 */
    .byte 0xA0, 0x33  /* 060045EA: bra 0x06004654 */
    .byte 0x7F, 0x04  /* 060045EC: add #4,r15 */
    .byte 0x2A, 0xA8  /* 060045EE: tst r10,r10 */
    .byte 0x8B, 0x22  /* 060045F0: bf 0x06004638 */
    .byte 0x65, 0xD3  /* 060045F2: mov r13,r5 */
    .byte 0x63, 0x51  /* 060045F4: mov.w @r5,r3 */
    .byte 0x67, 0xE3  /* 060045F6: mov r14,r7 */
    .byte 0x24, 0x31  /* 060045F8: mov.w r3,@r4 */
    .byte 0xE6, 0x23  /* 060045FA: mov #35,r6 */
    .byte 0x60, 0x51  /* 060045FC: mov.w @r5,r0 */
    .byte 0x81, 0xF9  /* 060045FE: mov.w r0,@(0x12,r15) */
    .byte 0x85, 0xD1  /* 06004600: mov.w @(0x2,r13),r0 */
    .byte 0x60, 0x0D  /* 06004602: extu.w r0,r0 */
    .byte 0x2F, 0x06  /* 06004604: mov.l r0,@-r15 */
    .byte 0x84, 0xF4  /* 06004606: mov.b @(0x4,r15),r0 */
    .byte 0x64, 0x03  /* 06004608: mov r0,r4 */
    .byte 0xA0, 0x20  /* 0600460A: bra 0x0600464E */
    .byte 0xE5, 0x37  /* 0600460C: mov #55,r5 */
    .byte 0x00, 0x90  /* 0600460E: .word 0x0090 */
    .byte 0x00, 0xA0  /* 06004610: .word 0x00A0 */
    .byte 0xFF, 0xFF  /* 06004612: .word 0xFFFF */
    .byte 0x06, 0x02  /* 06004614: stc sr,r6 */
    .byte 0x9C, 0x56  /* 06004616: mov.w @(0xAC,PC),r12  {0x060046C6} */
    .byte 0x06, 0x02  /* 06004618: stc sr,r6 */
    .byte 0x99, 0x1C  /* 0600461A: mov.w @(0x38,PC),r9  {0x06004656} */
    .byte 0x25, 0xE0  /* 0600461C: mov.b r14,@r5 */
    .byte 0x00, 0x00  /* 0600461E: .word 0x0000 */
    .byte 0x25, 0xE6  /* 06004620: mov.l r14,@-r5 */
    .byte 0x00, 0x00  /* 06004622: .word 0x0000 */
    .byte 0x06, 0x04  /* 06004624: mov.b r0,@(r0,r6) */
    .byte 0x23, 0x6A  /* 06004626: xor r6,r3 */
    .byte 0x00, 0x28  /* 06004628: clrmac */
    .byte 0x60, 0x64  /* 0600462A: mov.b @r6+,r0 */
    .byte 0x00, 0x28  /* 0600462C: clrmac */
    .byte 0x62, 0xC8  /* 0600462E: swap.b r12,r2 */
    .byte 0x00, 0x28  /* 06004630: clrmac */
    .byte 0x62, 0xB6  /* 06004632: mov.l @r11+,r2 */
    .byte 0x06, 0x02  /* 06004634: stc sr,r6 */
    .byte 0x8B, 0x80  /* 06004636: bf 0x0600453A */
    .byte 0x62, 0xD1  /* 06004638: mov.w @r13,r2 */
    .byte 0x67, 0xE3  /* 0600463A: mov r14,r7 */
    .byte 0x24, 0x21  /* 0600463C: mov.w r2,@r4 */
    .byte 0xE6, 0x23  /* 0600463E: mov #35,r6 */
    .byte 0x85, 0xD2  /* 06004640: mov.w @(0x4,r13),r0 */
    .byte 0xE5, 0x37  /* 06004642: mov #55,r5 */
    .byte 0x81, 0xF9  /* 06004644: mov.w r0,@(0x12,r15) */
    .byte 0x64, 0xAB  /* 06004646: neg r10,r4 */
    .byte 0x85, 0xD1  /* 06004648: mov.w @(0x2,r13),r0 */
    .byte 0x60, 0x0D  /* 0600464A: extu.w r0,r0 */
    .byte 0x2F, 0x06  /* 0600464C: mov.l r0,@-r15 */
    .byte 0x48, 0x0B  /* 0600464E: jsr @r8 */
    .byte 0x00, 0x09  /* 06004650: nop */
    .byte 0x7F, 0x04  /* 06004652: add #4,r15 */
    .byte 0x85, 0xD1  /* 06004654: mov.w @(0x2,r13),r0 */
