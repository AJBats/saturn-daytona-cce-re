...
FUN_06008D10:
    mov.l r14, @-r15
    mov #0x0, r7
    mov.l .L_pool_06008E8C, r5
    mov #0x0, r4
    mov.w .L_wpool_06008E84, r6
    add r5, r4
    mov.l r13, @-r15
    mov.l r12, @-r15
    mov.l r11, @-r15
...
.L_06008D2C:
    ...
    add #0xC, r0
    mov.w r7, @(r0, r5)
    mov.l .L_pool_06008E90, r13
    add #0xC, r0
    mov.l .L_pool_06008E94, r12
    mov #0x0, r4
    mov.w .L_wpool_06008E88, r14
    mov r13, r3
    mov.w .L_wpool_06008E8A, r6
    mov r3, r2
    mov.w r7, @(r0, r5)
    mov r3, r1
    mov.l r3, @(40, r15)
...
.L_pool_060092CC:
    .4byte DAT_0600581A  /* 060092CC = 0x0600581A (FUN_06005520 + 0x2FA) */
