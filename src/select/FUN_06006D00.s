...
.L_06007482:
    mov #0x14, r0
    mov.l .L_pool_06007520, r1
    mov.b r0, @r1
.L_06007488:
    .byte 0xB6, 0x5E  /* 06007488: bsr 0x06008148 */
    nop
    mov.l .L_pool_06007524, r4
    jsr @r10
    nop
    mov.l .L_pool_06007528, r4
    jsr @r10
    nop
    bra .L_06007508
    nop
.L_0600749C:
    ...
    nop
    mov #0x1, r3
    mov.l .L_pool_06007530, r2
    mov.l r3, @r2
    mov.l .L_pool_0600751C, r1
    mov.b @r1, r0
    cmp/eq #0xA, r0
    bt .L_060074D8
    cmp/eq #0xB, r0
