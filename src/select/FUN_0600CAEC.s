...
FUN_0600CAEC:
    mov.l r14, @-r15
    mov #0x3, r3
    mov.l .L_pool_0600CBE8, r4
    mov.l r13, @-r15
    mov.l r12, @-r15
    mov #0x0, r13
    mov.l .L_pool_0600CBE4, r14
    mov.l r11, @-r15
    mov.l r10, @-r15
    sts.l pr, @-r15
    mov.l .L_pool_0600CBDC, r12
    mov.w r3, @r12
    mov.l .L_pool_0600CBE0, r10
    mov.w .L_wpool_0600CBDA, r11
    mov.b @r10, r0
    cmp/eq #0x0, r0
    bt/s .L_0600CB78
    mov.w @r14, r5
...
.L_pool_0600CBEC:
    .4byte FUN_0600581A  /* 0600CBEC = 0x0600581A */
.L_pool_0600CBF0:
    .4byte DAT_0600584C  /* 0600CBF0 = 0x0600584C (FUN_0600581A + 0x32) */
