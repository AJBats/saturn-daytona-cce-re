...
FUN_06002656:
    .byte 0x4F, 0x22  /* 06002656: sts.l pr,@-r15 */
    .byte 0x2F, 0x46  /* 06002658: mov.l r4,@-r15 */
    .byte 0x2F, 0x06  /* 0600265A: mov.l r0,@-r15 */
    .byte 0xD1, 0x05  /* 0600265C: mov.l @(0x14,PC),r1  {[0x06002674] = 0x0602D084} */
    .byte 0x41, 0x0B  /* 0600265E: jsr @r1 */
    .byte 0x64, 0x03  /* 06002660: mov r0,r4 */
    .byte 0x65, 0x03  /* 06002662: mov r0,r5 */
    .byte 0x60, 0xF6  /* 06002664: mov.l @r15+,r0 */
    .byte 0xD1, 0x04  /* 06002666: mov.l @(0x10,PC),r1  {[0x06002678] = 0x0602D080} */
    .byte 0x41, 0x0B  /* 06002668: jsr @r1 */
    .byte 0x64, 0x03  /* 0600266A: mov r0,r4 */
    .byte 0x66, 0x03  /* 0600266C: mov r0,r6 */
    .byte 0x64, 0xF6  /* 0600266E: mov.l @r15+,r4 */
    .byte 0xAF, 0x5A  /* 06002670: bra 0x06002528 */
    .byte 0x4F, 0x26  /* 06002672: lds.l @r15+,pr */
    .byte 0x06, 0x02  /* 06002674: stc sr,r6 */
    .byte 0xD0, 0x84  /* 06002676: mov.l @(0x210,PC),r0  {[0x06002888] = 0x00000000} */
    .byte 0x06, 0x02  /* 06002678: stc sr,r6 */
    .byte 0xD0, 0x80  /* 0600267A: mov.l @(0x200,PC),r0  {[0x0600287C] = 0x00000000} */
    ...
    .byte 0x40, 0x00  /* 06002688: shll r0 */
    .byte 0x00, 0x00  /* 0600268A: .word 0x0000 */
    ...
    .byte 0x06, 0x09  /* 0600269C: .word 0x0609 */
    .byte 0x9E, 0xB8  /* 0600269E: mov.w @(0x170,PC),r14  {0x06002812} */
    .byte 0x06, 0x09  /* 060026A0: .word 0x0609 */
    .byte 0xA2, 0xB8  /* 060026A2: bra 0x06002C16 */
    ...
    .byte 0x06, 0x09  /* 060026B4: .word 0x0609 */
    .byte 0x9E, 0xB8  /* 060026B6: mov.w @(0x170,PC),r14  {0x0600282A} */
    .byte 0x06, 0x09  /* 060026B8: .word 0x0609 */
    .byte 0xA2, 0xB8  /* 060026BA: bra 0x06002C2E */
    ...
    .byte 0x06, 0x05  /* 060026CC: mov.w r0,@(r0,r6) */
    .byte 0x78, 0x2C  /* 060026CE: add #44,r8 */
    .byte 0x06, 0x05  /* 060026D0: mov.w r0,@(r0,r6) */
    .byte 0x7C, 0x2C  /* 060026D2: add #44,r12 */
    ...
    .byte 0x06, 0x05  /* 060026E4: mov.w r0,@(r0,r6) */
    .byte 0x78, 0x2C  /* 060026E6: add #44,r8 */
    .byte 0x06, 0x05  /* 060026E8: mov.w r0,@(r0,r6) */
    .byte 0x7C, 0x2C  /* 060026EA: add #44,r12 */
    ...
    .byte 0x06, 0x01  /* 06002704: .word 0x0601 */
    .byte 0xBF, 0x00  /* 06002706: bsr 0x0600250A */
    .byte 0x04, 0x21  /* 06002708: .word 0x0421 */
    .byte 0x04, 0x21  /* 0600270A: .word 0x0421 */
