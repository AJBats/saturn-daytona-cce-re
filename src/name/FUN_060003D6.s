...
.L_060006F8:
    ...
    mov.w @r12, r2
    sub r3, r2
    .reloc ., R_SH_IND12W, FUN_06001662 - 4
    .2byte 0xB000    /* bsr FUN_06001662 (linker-resolved) */
    mov.w r2, @r12
    tst r0, r0
    bt .L_0600074A
    mov.b @r14, r0
...
.L_060007EC:
    ...
    jsr @r2
    nop
    .reloc ., R_SH_IND12W, FUN_06001776 - 4
    .2byte 0xB000    /* bsr FUN_06001776 (linker-resolved) */
    nop
