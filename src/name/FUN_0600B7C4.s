/* FUN_0600B7C4  0x0600B7C4 */

    .section .text.FUN_0600B7C4
    .global FUN_0600B7C4
    .type FUN_0600B7C4, @function
FUN_0600B7C4:
    mov #-0x1, r1
    shll8 r1
    mov.l @(0, gbr), r0
    ...
    .reloc ., R_SH_IND12W, FUN_0600B8D4 - 4
    .2byte 0xA000    /* bra FUN_0600B8D4 (linker-resolved) */
