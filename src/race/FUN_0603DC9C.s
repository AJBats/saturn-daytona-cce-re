...
FUN_0603DC9C:
    mov.l r14, @-r15
    mov r4, r14
    .byte 0xD5, 0x2A    /* mov.l @(0x0603DD4C), r5 */
...
.L_0603DCDC:
    ...
    cmp/eq #0x3, r0
    bf .L_0603DD10
    .byte 0xD3, 0x17    /* mov.l @(0x0603DD50), r3 */
    mov.b @r3, r2
    .byte 0xD1, 0x15    /* mov.l @(0x0603DD4C), r1 */
    mov.w .L_wpool_0603DD44, r0
    mov.b @(r0, r1), r0
    cmp/eq r0, r2
    bt .L_0603DD10
    .byte 0xD5, 0x13    /* mov.l @(0x0603DD4C), r5 */
    mov.l r5, @r15
    bsr FUN_0603DEBC
    mov r14, r4
    mov.l @r15, r2
    mov.w .L_wpool_0603DD44, r0
    mov.b @(r0, r2), r3
    .byte 0xD1, 0x10    /* mov.l @(0x0603DD50), r1 */
    mov.b r3, @r1
.L_0603DD10:
    add #0x4, r15
    lds.l @r15+, pr
...
.L_0603DD72:
    ...
    cmp/eq #0x3, r0
    bf .L_0603DDA6
    .byte 0xD3, 0x31    /* mov.l @(0x0603DE4C), r3 */
    .byte 0xD0, 0x31    /* mov.l @(0x0603DE50), r0 */
    mov.b @r3, r2
    mov.l @r0, r1
    ...
    mov.l @r13, r2
    mov.w .L_wpool_0603DE46, r0
    .byte 0xD1, 0x2A    /* mov.l @(0x0603DE4C), r1 */
    mov.b @(r0, r2), r3
    mov.b r3, @r1
.L_0603DDA6:
    lds.l @r15+, pr
...
FUN_0603DE68:
    mov.l r14, @-r15
    sts.l pr, @-r15
    .byte 0xD3, 0x2A    /* mov.l @(0x0603DF18), r3 */
    add #-0x4C, r15
    mov.l r4, @r15
    mov r15, r4
    add #0x1C, r4
    ...
    mov r5, r14
    mov r15, r4
    .byte 0xD3, 0x27    /* mov.l @(0x0603DF1C), r3 */
    add #0x1C, r4
    ...
    sub r3, r1
    mov.l r1, @(24, r15)
    .byte 0xD3, 0x1C    /* mov.l @(0x0603DF20), r3 */
    jsr @r3
    nop
    mov.l @(4, r15), r0
    add #0x4C, r15
