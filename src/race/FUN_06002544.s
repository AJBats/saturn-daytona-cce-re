...
FUN_06002544:
    ...
    .byte 0x06, 0x05  /* 0600262C: mov.w r0,@(r0,r6) */
    .byte 0x20, 0x94  /* 0600262E: mov.b r9,@-r0 */
    .byte 0x04, 0x00  /* 06002630: .word 0x0400 */
    .byte 0x00, 0x00  /* 06002632: .word 0x0000 */
    .byte 0x06, 0x05  /* 06002634: mov.w r0,@(r0,r6) */
    .byte 0x49, 0x34  /* 06002636: .word 0x4934 */
    .byte 0x06, 0x02  /* 06002638: stc sr,r6 */
    .byte 0xA3, 0xA4  /* 0600263A: bra 0x06002D86 */
    .byte 0x06, 0x05  /* 0600263C: mov.w r0,@(r0,r6) */
    .byte 0x20, 0xC6  /* 0600263E: mov.l r12,@-r0 */
    .byte 0x06, 0x05  /* 06002640: mov.w r0,@(r0,r6) */
    .byte 0x16, 0x1C  /* 06002642: mov.l r1,@(0x30,r6) */
    .byte 0x06, 0x00  /* 06002644: .word 0x0600 */
    .byte 0x75, 0x1C  /* 06002646: add #28,r5 */
    .byte 0x06, 0x00  /* 06002648: .word 0x0600 */
    .byte 0x51, 0x00  /* 0600264A: mov.l @(0x0,r0),r1 */
    .byte 0x06, 0x05  /* 0600264C: mov.w r0,@(r0,r6) */
    .byte 0x45, 0x0C  /* 0600264E: shad r0,r5 */
    .byte 0x06, 0x02  /* 06002650: stc sr,r6 */
    .byte 0xA6, 0x64  /* 06002652: bra 0x0600331E */
    .byte 0x06, 0x00  /* 06002654: .word 0x0600 */
    .byte 0x75, 0x00  /* 06002656: add #0,r5 */
    .byte 0x26, 0x05  /* 06002658: mov.w r0,@-r6 */
    .byte 0x17, 0x3C  /* 0600265A: mov.l r3,@(0x30,r7) */
    .byte 0x06, 0x05  /* 0600265C: mov.w r0,@(r0,r6) */
    .byte 0x17, 0x38  /* 0600265E: mov.l r3,@(0x20,r7) */
    .byte 0x06, 0x04  /* 06002660: mov.b r0,@(r0,r6) */
    .byte 0x59, 0x58  /* 06002662: mov.l @(0x20,r5),r9 */
