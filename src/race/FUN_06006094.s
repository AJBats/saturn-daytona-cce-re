...
.L_060060C2:
    ...
    mulu.w r3, r5
    sts macl, r5
    .reloc ., R_SH_IND12W, FUN_06005C80 - 4
    .2byte 0xB000    /* bsr FUN_06005C80 (linker-resolved) */
    mov.l @(52, r14), r4
    extu.b r13, r3
...
.L_060060F4:
    ...
    lds.l @r15+, pr
    mov.l @r15+, r13
    .reloc ., R_SH_IND12W, FUN_06005270 - 4
    .2byte 0xA000    /* bra FUN_06005270 (linker-resolved) */
    mov.l @r15+, r14
