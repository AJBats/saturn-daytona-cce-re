...
FUN_0602D876:
    ...
    mov.w @r1, r3
    mov.w r3, @(r0, r9)
    .byte 0xD2, 0x50    /* mov.l @(0x0602D9CC), r2 */
    add #-0x2, r0
    mov.w @r2, r3
    mov.w r3, @(r0, r9)
    .reloc ., R_SH_IND12W, FUN_0602D052 - 4
    ...
    mov #0x0, r4
    mov #0x1, r7
    .byte 0xD4, 0x4E    /* mov.l @(0x0602D9D8), r4 */
    mov #0x7, r6
    mov r14, r5
    add #0x9, r5
    shll2 r5
...
FUN_0602D9F0:
    ...
    sts.l pr, @-r15
    add #-0x4, r15
    .byte 0xD2, 0x40    /* mov.l @(0x0602DB00), r2 */
    mov.b @r2, r0
    tst r0, r0
    bf .L_0602DAA0
    .byte 0x93, 0x7A    /* mov.w @(0x0602DAFC), r3 */
    mov #0x1, r12
    and r5, r12
    extu.b r5, r6
    tst r6, r3
...
.L_0602DA24:
    tst r2, r6
    bt .L_0602DA42
    .byte 0x95, 0x69    /* mov.w @(0x0602DAFE), r5 */
    add r5, r13
    bra .L_0602DA42
    add r5, r14
.L_0602DA30:
...
.L_0602DA42:
    extu.b r4, r1
    .byte 0xD3, 0x2F    /* mov.l @(0x0602DB04), r3 */
    mov.l r1, @r15
    jsr @r3
    mov #0xA, r0
    mov r0, r11
    ...
    tst r1, r1
    bt .L_0602DA74
    .byte 0xD3, 0x2C    /* mov.l @(0x0602DB08), r3 */
    extu.b r11, r4
    .byte 0xD2, 0x2C    /* mov.l @(0x0602DB0C), r2 */
    mov #0x2, r7
    mov #0x1, r6
    extu.w r13, r5
    shll r5
    ...
    add #0x1, r14
.L_0602DA74:
    .byte 0xD3, 0x24    /* mov.l @(0x0602DB08), r3 */
    mov #0x2, r7
    mov.l @r15, r1
    mov #0x1, r6
    .byte 0xD2, 0x24    /* mov.l @(0x0602DB10), r2 */
    extu.w r14, r5
    shll r5
    add r3, r5
    jsr @r2
    mov #0xA, r0
    .byte 0xD2, 0x20    /* mov.l @(0x0602DB0C), r2 */
    add #0x4, r15
    lds.l @r15+, pr
    shll r0
    mov.l @r15+, r11
...
FUN_0602DC80:
    ...
    jsr @r3
    mov #0x64, r0
    .byte 0xDB, 0x3D    /* mov.l @(0x0602DD94), r11 */
    extu.w r5, r12
    .byte 0xDA, 0x40    /* mov.l @(0x0602DDA4), r10 */
    mov r0, r14
    add #0x3, r12
    shll2 r12
    shll2 r12
...
.L_0602DCD2:
    mov #0xA, r9
    .byte 0xDA, 0x34    /* mov.l @(0x0602DDA8), r10 */
    mov r13, r1
    .byte 0xD2, 0x29    /* mov.l @(0x0602DD80), r2 */
    add r12, r10
    jsr @r2
    mov r9, r0
    tst r0, r0
    bt .L_0602DD0E
    .byte 0xD2, 0x26    /* mov.l @(0x0602DD80), r2 */
    extu.w r14, r14
    mov #0x64, r3
    mov r13, r1
    mul.l r3, r14
...
.L_0602DD16:
    mov #0x2, r7
    .byte 0xD5, 0x24    /* mov.l @(0x0602DDAC), r5 */
    mov r13, r1
    .byte 0xD3, 0x1A    /* mov.l @(0x0602DD88), r3 */
    mov r7, r6
    add r12, r5
    jsr @r3
    mov r9, r0
