...
.L_0603162E:
    ...
    mov.b r12, @r9
.L_06031632:
    .byte 0xD0, 0x2F    /* mov.l @(0x060316F0), r0 */
    mov.b @(r0, r14), r0
    add #0x4, r15
    lds.l @r15+, pr
    mov.l @r15+, r8
...
.L_0603170C:
    .byte 0xD1, 0x3E    /* mov.l @(0x06031808), r1 */
    jsr @r1
    nop
    mov.l @r9, r0
...
.L_06031724:
    ...
    cmp/eq #0x2, r0
    bf FUN_060317DC
    .byte 0xD3, 0x37    /* mov.l @(0x06031810), r3 */
    add r13, r8
    mov.b @r8, r2
    add r12, r14
...
.L_06031744:
    ...
    cmp/ge r2, r3
    bt .L_06031776
    .byte 0xD3, 0x2E    /* mov.l @(0x06031818), r3 */
    mov.b @r3, r1
    extu.b r1, r1
    cmp/eq r1, r10
    bt .L_06031770
    .byte 0xD1, 0x2D    /* mov.l @(0x0603181C), r1 */
    mov.b @r1, r0
    extu.b r0, r0
    cmp/eq #0x1, r0
    bf .L_06031776
.L_06031770:
    .byte 0xD3, 0x2B    /* mov.l @(0x06031820), r3 */
    jsr @r3
    mov r10, r4
.L_06031776:
    mov r12, r0
    ...
    cmp/eq r3, r2
    bf .L_06031794
    .byte 0xD1, 0x28    /* mov.l @(0x06031824), r1 */
    jsr @r1
    mov.l @r9, r4
    mov.l .L_pool_0603180C, r0
    .byte 0xD3, 0x28    /* mov.l @(0x0603182C), r3 */
    mov.b r11, @(r0, r13)
    .byte 0xD0, 0x26    /* mov.l @(0x06031828), r0 */
    mov.b r11, @(r0, r13)
    jsr @r3
    mov r10, r4
.L_06031794:
