...
.L_06013038:
    mov.l r4, @-r15
    mov.l r0, @-r15
    mov.w .L_wpool_06013068, r0
    mov.l @(r0, r14), r4
    mov.l .L_pool_06013070, r0
    or r0, r4
    mov.w .L_wpool_06013068, r0
    mov.l r4, @(r0, r14)
    mov.w .L_wpool_0601306A, r0
    mov.w .L_wpool_0601306C, r4
    mov.l r4, @(r0, r14)
    mov.w .L_wpool_06013068, r0
    mov.l @(r0, r13), r4
    mov.l .L_pool_06013070, r0
...
.L_06013074:
    mov.l @(36, r14), r1
    mov.l @(36, r13), r3
    mov.l .L_pool_060130D4, r2
    sub r3, r1
    cmp/ge r1, r2
    bt .L_060130AC
    mov.l r4, @-r15
    mov.l r0, @-r15
    mov.w .L_wpool_060130CC, r0
    mov.l @(r0, r14), r4
    mov.l .L_pool_060130D8, r0
    or r0, r4
    mov.w .L_wpool_060130CC, r0
    mov.l r4, @(r0, r14)
    mov.w .L_wpool_060130CE, r0
    mov.w .L_wpool_060130D0, r4
    mov.l r4, @(r0, r14)
    mov.w .L_wpool_060130CC, r0
    mov.l @(r0, r13), r4
    mov.l .L_pool_060130D8, r0
...
.L_060130AC:
    ...
    tst r8, r8
    mov.l @(48, r14), r2
    mov.l .L_pool_060130DC, r3
    bt .L_060130C6
    mov.l .L_pool_060130E0, r3
.L_060130C6:
    or r3, r2
    bra .L_06013132
    mov.l r2, @(48, r14)
