...
FUN_06002118:
    ...
    .byte 0x06, 0x05  /* 060021DC: mov.w r0,@(r0,r6) */
    .byte 0x20, 0x94  /* 060021DE: mov.b r9,@-r0 */
    .byte 0x00, 0x00  /* 060021E0: .word 0x0000 */
    .byte 0x00, 0x60  /* 060021E2: .word 0x0060 */
    .byte 0x00, 0x00  /* 060021E4: .word 0x0000 */
    .byte 0x00, 0x6E  /* 060021E6: mov.l @(r0,r6),r0 */
    .byte 0x06, 0x05  /* 060021E8: mov.w r0,@(r0,r6) */
    .byte 0x49, 0x34  /* 060021EA: .word 0x4934 */
    .byte 0x06, 0x00  /* 060021EC: .word 0x0600 */
    .byte 0x75, 0x1C  /* 060021EE: add #28,r5 */
    .byte 0x06, 0x00  /* 060021F0: .word 0x0600 */
    .byte 0x51, 0x00  /* 060021F2: mov.l @(0x0,r0),r1 */
    .byte 0x06, 0x05  /* 060021F4: mov.w r0,@(r0,r6) */
    .byte 0x45, 0x0C  /* 060021F6: shad r0,r5 */
    .byte 0x06, 0x02  /* 060021F8: stc sr,r6 */
    .byte 0xA2, 0x0C  /* 060021FA: bra 0x06002616 */
    .byte 0x06, 0x00  /* 060021FC: .word 0x0600 */
    .byte 0x75, 0x00  /* 060021FE: add #0,r5 */
    .byte 0x06, 0x05  /* 06002200: mov.w r0,@(r0,r6) */
    .byte 0x17, 0x3C  /* 06002202: mov.l r3,@(0x30,r7) */
    .byte 0x06, 0x05  /* 06002204: mov.w r0,@(r0,r6) */
    .byte 0x17, 0x38  /* 06002206: mov.l r3,@(0x20,r7) */
    .byte 0x06, 0x04  /* 06002208: mov.b r0,@(r0,r6) */
    .byte 0x59, 0x58  /* 0600220A: mov.l @(0x20,r5),r9 */
