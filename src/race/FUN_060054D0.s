...
FUN_060054D0:
    ...
    bf .L_06005506
    mov #0x1, r7
    mov.l .L_pool_06005664, r5
    mov.l .L_pool_06005668, r4
    .byte 0xBD, 0xB3  /* 060054E8: bsr 0x06005052 */
    mov #0x4, r6
    mov.l .L_pool_0600566C, r5
    mov #0x2, r7
    mov.l .L_pool_06005670, r4
    .byte 0xBD, 0xAE  /* 060054F2: bsr 0x06005052 */
    mov r7, r6
    mov #0x1, r5
    mov.l .L_pool_06005674, r2
    mov.b @r2, r4
...
.L_06005506:
    mov #0x3, r7
    mov.l .L_pool_06005678, r5
    mov.l .L_pool_0600567C, r4
    .byte 0xBD, 0xA1  /* 0600550C: bsr 0x06005052 */
    mov #0x12, r6
    mov.l .L_pool_06005680, r2
    mov.w @r2, r3
    mov.l .L_pool_06005684, r1
    mov.w r3, @r1
    mov.l .L_pool_06005688, r0
    mov.w @r0, r3
    mov.l .L_pool_0600568C, r2
    mov.w r3, @r2
    .byte 0xB4, 0x0F  /* 06005520: bsr 0x06005D42 */
    mov #0x0, r4
    mov.l .L_pool_06005690, r5
    mov #0x2, r7
    mov.l .L_pool_06005694, r4
