...
FUN_060093FC:
    mov.l r14, @-r15
    mov #0x0, r5
    mov.l .L_pool_06009490, r0
    mov.l r13, @-r15
    mov.l r12, @-r15
    mov #0x1, r12
    mov.l .L_pool_060094A0, r13
    mov.l r11, @-r15
    mov.l r10, @-r15
    mov r4, r11
    mov.l r9, @-r15
    extu.b r11, r14
    mov.l .L_pool_0600949C, r10
    mov.l r8, @-r15
    sts.l pr, @-r15
    add #-0x4, r15
    mov.l .L_pool_06009494, r8
    mov.b r5, @(r0, r14)
    mov.l .L_pool_06009498, r9
    mov.l @r13, r4
    mov.b @r10, r7
    mov r4, r0
    add #0x33, r0
...
.L_060094CA:
    ...
    tst r6, r6
    bt .L_06009548
    mov.l .L_pool_060095B0, r2
    mov.l @r2, r3
    mov.l .L_pool_060095B4, r1
    mov.w @(8, r3), r0
    mov.w @r1, r3
    cmp/hs r3, r0
    bt .L_06009538
    mov #0x9, r3
    mov.w .L_wpool_060095AC, r0
    mov.w @(r0, r4), r0
    extu.w r0, r0
    cmp/ge r3, r0
    bt .L_06009538
    ...
    tst #0x20, r0
    bf .L_06009538
    mov.l .L_pool_060095B8, r0
    extu.b r11, r3
    mov.l .L_pool_060095CC, r4
    shll r3
    mov.b r12, @(r0, r14)
    mov.l .L_pool_060095BC, r0
    mov.b r5, @(r0, r14)
    mov.l .L_pool_060095C0, r0
    mov.w r5, @(r0, r3)
    mov #0x4, r3
    mov.l .L_pool_060095C4, r0
    mov.b r5, @(r0, r14)
    mov.l .L_pool_060095C8, r0
    mov.b r5, @(r0, r14)
    mov.l @r13, r2
    mov #0x5C, r0
    mov.l r3, @(r0, r2)
    ...
    mov #0x48, r0
    mov.b r1, @(r0, r3)
    mov.l .L_pool_060095D0, r0
    mov.l .L_pool_060095D8, r3
    mov.b r5, @(r0, r14)
    mov.l .L_pool_060095D4, r0
    mov.b r5, @(r0, r14)
    mov.b @r3, r1
    tst r1, r1
    bt .L_06009538
    mov.l .L_pool_060095DC, r2
    jsr @r2
    nop
.L_06009538:
    mov.b @r8, r3
