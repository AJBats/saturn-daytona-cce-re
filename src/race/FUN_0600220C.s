...
FUN_0600220C:
    ...
    .byte 0xFE, 0x92  /* 0600228A: .word 0xFE92 */
    .byte 0x06, 0x04  /* 0600228C: mov.b r0,@(r0,r6) */
    .byte 0x56, 0x98  /* 0600228E: mov.l @(0x20,r9),r6 */
    .byte 0x06, 0x00  /* 06002290: .word 0x0600 */
    .byte 0x51, 0x00  /* 06002292: mov.l @(0x0,r0),r1 */
    .byte 0x06, 0x05  /* 06002294: mov.w r0,@(r0,r6) */
    .byte 0x49, 0x34  /* 06002296: .word 0x4934 */
    .byte 0x06, 0x05  /* 06002298: mov.w r0,@(r0,r6) */
    .byte 0x17, 0x3C  /* 0600229A: mov.l r3,@(0x30,r7) */
    .byte 0x06, 0x05  /* 0600229C: mov.w r0,@(r0,r6) */
    .byte 0x17, 0x38  /* 0600229E: mov.l r3,@(0x20,r7) */
    .byte 0x06, 0x04  /* 060022A0: mov.b r0,@(r0,r6) */
    .byte 0x59, 0x58  /* 060022A2: mov.l @(0x20,r5),r9 */
