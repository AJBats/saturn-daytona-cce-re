...
FUN_060330B0:
    ...
    mov #0x0, r5
    .byte 0xD7, 0x1F    /* mov.l @(0x0603313C), r7 */
    mov #0x8, r14
    .byte 0xD6, 0x1F    /* mov.l @(0x06033140), r6 */
    mov r5, r4
...
.L_060330CC:
    ...
    bf/s .L_060330CC
    add #0x4, r4
    .byte 0xD3, 0x15    /* mov.l @(0x06033144), r3 */
    mov.l .L_pool_06033138, r1
    mov.l @r1, r2
    mov.w @(8, r2), r0
    mov.w r0, @r3
    ...
    mov.w @r0, r2
    .byte 0xD3, 0x13    /* mov.l @(0x0603314C), r3 */
    mov.w r2, @r3
    .byte 0xD2, 0x13    /* mov.l @(0x06033150), r2 */
    mov.b @r2, r1
    .byte 0xD3, 0x13    /* mov.l @(0x06033154), r3 */
    mov.b r1, @r3
    lds.l @r15+, pr
    .byte 0xD1, 0x13    /* mov.l @(0x06033158), r1 */
    jmp @r1
    mov.l @r15+, r14
...
.L_060331EE:
    ...
    .byte 0xD5, 0x26    /* mov.l @(0x0603329C), r5 */
    shll2 r2
    .byte 0xDA, 0x26    /* mov.l @(0x060332A0), r10 */
    mov.l r12, @(r0, r2)
    mov.b @r6, r11
    extu.b r11, r11
    .byte 0xD2, 0x22    /* mov.l @(0x06033298), r2 */
    mov r11, r3
    shll2 r11
    shll r11
    add r3, r11
...
FUN_060332A4:
    ...
    mov #0x2, r9
    sts.l macl, @-r15
    .byte 0xD8, 0x40    /* mov.l @(0x060333BC), r8 */
.L_060332BC:
    .byte 0xD2, 0x40    /* mov.l @(0x060333C0), r2 */
    extu.w r7, r0
    .byte 0xD1, 0x41    /* mov.l @(0x060333C8), r1 */
    mov r7, r5
    mov r7, r3
    shll2 r5
    shll2 r5
    ...
    mov.l r3, @(r0, r8)
    mov #0x3C, r12
    .byte 0xD3, 0x38    /* mov.l @(0x060333C4), r3 */
    extu.w r7, r13
    muls.w r12, r7
    shll r13
    sts macl, r12
...
.L_060332F0:
    ...
    cmp/ge r9, r3
    bf .L_060332BC
    .byte 0xD3, 0x23    /* mov.l @(0x060333CC), r3 */
    mov.b r14, @r3
    .byte 0xD1, 0x23    /* mov.l @(0x060333D0), r1 */
    mov.w @r1, r2
    .byte 0xD0, 0x23    /* mov.l @(0x060333D4), r0 */
    mov.w r2, @r0
    .byte 0xD2, 0x23    /* mov.l @(0x060333D8), r2 */
    mov.b @r2, r3
    .byte 0xD1, 0x23    /* mov.l @(0x060333DC), r1 */
    mov.b r3, @r1
    .byte 0xD3, 0x23    /* mov.l @(0x060333E0), r3 */
    mov.b @r3, r0
    .byte 0xD2, 0x23    /* mov.l @(0x060333E4), r2 */
    mov.b r0, @r2
...
.L_060333FC:
    .byte 0xD1, 0x60    /* mov.l @(0x06033580), r1 */
    mov.b @r1, r0
    tst r0, r0
    bf .L_06033406
    mov #0x1, r13
.L_06033406:
    .byte 0xD2, 0x5F    /* mov.l @(0x06033584), r2 */
    mov.b @r2, r0
    cmp/eq #0x0, r0
    bt .L_06033422
    cmp/eq #0x1, r0
    ...
    nop
.L_06033422:
    .byte 0xD3, 0x59    /* mov.l @(0x06033588), r3 */
    jsr @r3
    nop
    mov.w @r14, r0
    cmp/eq #0x28, r0
    bf .L_0603343E
    mov #0x0, r5
    .byte 0xD2, 0x57    /* mov.l @(0x06033590), r2 */
    .byte 0xD3, 0x56    /* mov.l @(0x0603358C), r3 */
    mov.b @r3, r6
    extu.b r6, r6
    add #0x4, r6
    jsr @r2
...
.L_0603343E:
    mov #0x0, r2
    .byte 0xD3, 0x54    /* mov.l @(0x06033594), r3 */
    mov r13, r0
    mov.b r2, @r3
    lds.l @r15+, pr
    mov.l @r15+, r13
...
FUN_0603344E:
    ...
    mov.l r13, @-r15
    mov r4, r13
    .byte 0xDE, 0x53    /* mov.l @(0x060335A4), r14 */
    mov.l r12, @-r15
    mov.l r11, @-r15
    mov #0x0, r12
    mov.l r10, @-r15
    ...
    mov.l r8, @-r15
    mov #0x8, r8
    .byte 0xD9, 0x4C    /* mov.l @(0x06033598), r9 */

    .global FUN_06033466
    .type FUN_06033466, @function
FUN_06033466:
    sts.l pr, @-r15
    .byte 0xDA, 0x4C    /* mov.l @(0x0603359C), r10 */
    .byte 0xDB, 0x4D    /* mov.l @(0x060335A0), r11 */
.L_0603346C:
    mov #0x2, r7
    mov #0x1, r6
    mov r13, r5
...
.L_pool_060335B0:
    ...
    .byte 0xD5, 0x38    /* mov.l @(0x06033698), r5 */
    mov #0x3C, r2
    mov.w @r5, r3
    add #0x1, r3
    mov.w r3, @r5
    ...
    bf/s .L_060335E0
    mov #0x0, r6
    .byte 0xD5, 0x35    /* mov.l @(0x0603369C), r5 */
...
.L_06033640:
    ...
    rts
    mov.l @r15+, r14
    .byte 0xD2, 0x17    /* mov.l @(0x060336B4), r2 */
    mov.b @r2, r3
    tst r3, r3
    bf .L_0603368E
    .byte 0xD1, 0x16    /* mov.l @(0x060336B8), r1 */
    mov.b @r1, r0
    extu.b r0, r0
    cmp/eq #0x1, r0
    bf .L_0603368E
    .byte 0xD3, 0x14    /* mov.l @(0x060336BC), r3 */
    mov #0x1, r2
    mov.b @r3, r0
    cmp/ge r2, r0
    bf .L_0603368E
    .byte 0xD3, 0x13    /* mov.l @(0x060336C0), r3 */
    mov.b @r3, r0
    tst r0, r0
    bf .L_0603368E
    .byte 0xD2, 0x12    /* mov.l @(0x060336C4), r2 */
    mov.b @r2, r0
    extu.b r0, r0
    cmp/eq #0x1F, r0
    bf .L_0603368E
    .byte 0xD2, 0x0E    /* mov.l @(0x060336C0), r2 */
    mov #0x1, r4
    mov.b r4, @r2
    rts
    mov r4, r0
...
FUN_060336C8:
    mov.l r14, @-r15
    sts.l pr, @-r15
    .byte 0xD3, 0x3E    /* mov.l @(0x060337C8), r3 */
    jsr @r3
    nop
    mov #0x1, r2
    mov.l .L_pool_060337CC, r3
    mov.b r2, @r3
    .byte 0xD1, 0x3D    /* mov.l @(0x060337D0), r1 */
    .byte 0xD0, 0x3E    /* mov.l @(0x060337D4), r0 */
    .byte 0xD3, 0x3E    /* mov.l @(0x060337D8), r3 */
    jsr @r3
    mov.l r1, @r0
    mov #0x0, r14
    .byte 0xD2, 0x3D    /* mov.l @(0x060337DC), r2 */
    .byte 0xD3, 0x3E    /* mov.l @(0x060337E0), r3 */
    jsr @r3
    mov.b r14, @r2
    ...
    mov.l @r15+, r14
    mov #0x0, r5
    .byte 0xD4, 0x3B    /* mov.l @(0x060337EC), r4 */
    mov #0x4C, r0
    mov r4, r3
    add #0x4A, r3
    mov.w r5, @r3
    ...
    mov #0x4E, r0
    mov.w r3, @(r0, r4)
    .byte 0xD3, 0x37    /* mov.l @(0x060337F0), r3 */
    mov #0x50, r0
    jmp @r3
    mov.w r2, @(r0, r4)
...
FUN_06033830:
    ...
    sts.l pr, @-r15
    add #-0x14, r15
    .byte 0xDD, 0x64    /* mov.l @(0x060339CC), r13 */
    mov.b r4, @r15
    mov.b @r13, r3
    tst r3, r3
    bf .L_06033848
    .byte 0xD4, 0x63    /* mov.l @(0x060339D0), r4 */
    bra .L_0603384A
    nop
.L_06033848:
    .byte 0xD4, 0x62    /* mov.l @(0x060339D4), r4 */
.L_0603384A:
    mov r15, r14
    add #0x4, r14
    bra .L_06033858
...
.L_06033872:
    ...
    mov.b r0, @(2, r14)
.L_06033876:
    .byte 0xD5, 0x58    /* mov.l @(0x060339D8), r5 */
    .byte 0xD3, 0x58    /* mov.l @(0x060339DC), r3 */
    jsr @r3
    mov r14, r4
    mov.b @r13, r2
    tst r2, r2
...
.L_0603388E:
    mov #0x54, r3
    .byte 0xD5, 0x51    /* mov.l @(0x060339D8), r5 */
    mov #0x58, r2
    mov.b r3, @r4
    add #0x1, r4
    mov #0x45, r3
    mov.b r3, @r4
    .byte 0xD3, 0x50    /* mov.l @(0x060339E0), r3 */
    add #0x1, r4
    mov.b r2, @r4
    jsr @r3
    mov r14, r4
    .byte 0xDE, 0x4F    /* mov.l @(0x060339E4), r14 */
    mov.b @r15, r4
    mov.b @r13, r3
    tst r3, r3
    bf/s .L_0603390E
    ...
    nop
.L_060338CC:
    .byte 0xD3, 0x46    /* mov.l @(0x060339E8), r3 */
    mov.l @r3, r6
    .byte 0xD2, 0x46    /* mov.l @(0x060339EC), r2 */
    .byte 0xD1, 0x47    /* mov.l @(0x060339F0), r1 */
    bra .L_06033906
    mov.l @r2, r5
.L_060338D8:
    .byte 0xD2, 0x46    /* mov.l @(0x060339F4), r2 */
    .byte 0xD3, 0x47    /* mov.l @(0x060339F8), r3 */
    .byte 0xD1, 0x47    /* mov.l @(0x060339FC), r1 */
    mov.l @r3, r5
    bra .L_06033906
    mov.l @r2, r6
.L_060338E4:
    .byte 0xD2, 0x46    /* mov.l @(0x06033A00), r2 */
    .byte 0xD3, 0x47    /* mov.l @(0x06033A04), r3 */
    .byte 0xD1, 0x47    /* mov.l @(0x06033A08), r1 */
    mov.l @r3, r5
    bra .L_06033906
    mov.l @r2, r6
.L_060338F0:
    .byte 0xD2, 0x46    /* mov.l @(0x06033A0C), r2 */
    .byte 0xD3, 0x47    /* mov.l @(0x06033A10), r3 */
    .byte 0xD1, 0x47    /* mov.l @(0x06033A14), r1 */
    mov.l @r3, r5
    bra .L_06033906
    mov.l @r2, r6
.L_060338FC:
    .byte 0xD2, 0x46    /* mov.l @(0x06033A18), r2 */
    mov.l @r2, r6
    .byte 0xD3, 0x46    /* mov.l @(0x06033A1C), r3 */
    mov.l @r3, r5
    .byte 0xD1, 0x46    /* mov.l @(0x06033A20), r1 */
.L_06033906:
    jsr @r14
    mov.l @r1, r4
    bra .L_06033966
...
.L_0603390E:
    ...
    nop
.L_06033928:
    .byte 0xD3, 0x3E    /* mov.l @(0x06033A24), r3 */
    mov.l @r3, r6
    .byte 0xD2, 0x3E    /* mov.l @(0x06033A28), r2 */
    .byte 0xD1, 0x3F    /* mov.l @(0x06033A2C), r1 */
    bra .L_06033962
    mov.l @r2, r5
.L_06033934:
    .byte 0xD2, 0x3E    /* mov.l @(0x06033A30), r2 */
    .byte 0xD3, 0x3F    /* mov.l @(0x06033A34), r3 */
    .byte 0xD1, 0x3F    /* mov.l @(0x06033A38), r1 */
    mov.l @r3, r5
    bra .L_06033962
    mov.l @r2, r6
.L_06033940:
    .byte 0xD2, 0x3E    /* mov.l @(0x06033A3C), r2 */
    .byte 0xD3, 0x3F    /* mov.l @(0x06033A40), r3 */
    .byte 0xD1, 0x3F    /* mov.l @(0x06033A44), r1 */
    mov.l @r3, r5
    bra .L_06033962
    mov.l @r2, r6
.L_0603394C:
    .byte 0xD2, 0x3E    /* mov.l @(0x06033A48), r2 */
    .byte 0xD3, 0x3F    /* mov.l @(0x06033A4C), r3 */
    .byte 0xD1, 0x3F    /* mov.l @(0x06033A50), r1 */
    mov.l @r3, r5
    bra .L_06033962
    mov.l @r2, r6
.L_06033958:
    .byte 0xD2, 0x3E    /* mov.l @(0x06033A54), r2 */
    mov.l @r2, r6
    .byte 0xD3, 0x3E    /* mov.l @(0x06033A58), r3 */
    mov.l @r3, r5
    .byte 0xD1, 0x3E    /* mov.l @(0x06033A5C), r1 */
.L_06033962:
    jsr @r14
    mov.l @r1, r4
.L_06033966:
...
FUN_06033A78:
    mov.l r14, @-r15
    sts.l pr, @-r15
    .byte 0xD5, 0x6C    /* mov.l @(0x06033C30), r5 */
    add #-0x10, r15
    mov r15, r14
    bra .L_06033A8C
    mov r14, r6
...
.L_06033A8C:
    ...
    bf .L_06033A86
    mov #0x0, r3
    .byte 0xD5, 0x67    /* mov.l @(0x06033C34), r5 */
    mov r4, r0
    mov.b r3, @r6
    add #0x30, r0
    .byte 0xD3, 0x66    /* mov.l @(0x06033C38), r3 */
    mov.b r0, @(6, r14)
    jsr @r3
    mov r14, r4
    add #0x10, r15
...
FUN_06033AAC:
    mov.l r14, @-r15
    sts.l pr, @-r15
    .byte 0xD5, 0x62    /* mov.l @(0x06033C3C), r5 */
    add #-0x10, r15
    mov r15, r14
    bra .L_06033AC0
    mov r14, r6
...
.L_06033AC0:
    ...
    mov.b r3, @r6
    mov r4, r0
    .byte 0xD3, 0x5C    /* mov.l @(0x06033C40), r3 */
    add #0x30, r0
    mov.b r0, @(2, r14)
    mov.b @r3, r0
    extu.b r0, r0
    ...
    .byte 0xD4, 0x59    /* mov.l @(0x06033C48), r4 */
    bra .L_06033AEC
    nop
.L_06033AE8:
    mov.l .L_pool_06033C44, r5
    mov r14, r4
.L_06033AEC:
    .byte 0xD3, 0x52    /* mov.l @(0x06033C38), r3 */
    jsr @r3
    nop
    add #0x10, r15
    lds.l @r15+, pr
...
FUN_06033AFA:
    ...
    sts.l pr, @-r15
    add #-0x10, r15
    .byte 0xD5, 0x52    /* mov.l @(0x06033C4C), r5 */
    mov r15, r14
    bra .L_06033B0E
    mov r14, r6
.L_06033B08:
...
.L_06033B0E:
    ...
    mov.b r3, @r6
    mov r4, r0
    .byte 0xD3, 0x4C    /* mov.l @(0x06033C50), r3 */
    add #0x30, r0
    mov.b r0, @(2, r14)
    jsr @r3
    mov r14, r4
...
FUN_06033B2E:
    ...
    sts.l pr, @-r15
    add #-0x10, r15
    .byte 0xD5, 0x47    /* mov.l @(0x06033C54), r5 */
    mov r15, r14
    bra .L_06033B42
    mov r14, r6
.L_06033B3C:
...
.L_06033B42:
    ...
    tst r2, r2
    bf .L_06033B3C
    .byte 0xD5, 0x43    /* mov.l @(0x06033C58), r5 */
    mov #0x0, r3
    mov.b r3, @r6
    mov r4, r0
    .byte 0xD3, 0x39    /* mov.l @(0x06033C38), r3 */
    add #0x30, r0
    mov.b r0, @(2, r14)
    jsr @r3
    mov r14, r4
...
FUN_06033B64:
    ...
    .byte 0xDE, 0x38    /* mov.l @(0x06033C50), r14 */
    bt .L_06033BA2
    cmp/eq #0x1, r0
    bt .L_06033B9C
    cmp/eq #0x2, r0
    ...
    nop
.L_06033B96:
    .byte 0xD4, 0x31    /* mov.l @(0x06033C5C), r4 */
    bra .L_06033BCA
    mov r13, r5
.L_06033B9C:
    .byte 0xD4, 0x30    /* mov.l @(0x06033C60), r4 */
    bra .L_06033BCA
    mov r13, r5
.L_06033BA2:
    .byte 0xD4, 0x30    /* mov.l @(0x06033C64), r4 */
    bra .L_06033BCA
    mov r13, r5
.L_06033BA8:
    .byte 0xD4, 0x2F    /* mov.l @(0x06033C68), r4 */
    bra .L_06033BCA
    mov r13, r5
.L_06033BAE:
    .byte 0xD4, 0x2F    /* mov.l @(0x06033C6C), r4 */
    bra .L_06033BCA
    mov r13, r5
.L_06033BB4:
    .byte 0xD4, 0x2E    /* mov.l @(0x06033C70), r4 */
    bra .L_06033BCA
    mov r13, r5
.L_06033BBA:
    .byte 0xD4, 0x2E    /* mov.l @(0x06033C74), r4 */
    bra .L_06033BCA
    mov r13, r5
.L_06033BC0:
    .byte 0xD4, 0x2D    /* mov.l @(0x06033C78), r4 */
    bra .L_06033BCA
    mov r13, r5
.L_06033BC6:
    mov r13, r5
    .byte 0xD4, 0x2C    /* mov.l @(0x06033C7C), r4 */
.L_06033BCA:
    jsr @r14
    nop
.L_06033BCE:
...
.L_06033C94:
    .byte 0xD4, 0x41    /* mov.l @(0x06033D9C), r4 */
    mov r13, r6
    bra .L_06033CB2
    mov r14, r5
.L_06033C9C:
    .byte 0xD4, 0x40    /* mov.l @(0x06033DA0), r4 */
    mov r13, r6
    bra .L_06033CB2
    mov r14, r5
.L_06033CA4:
    .byte 0xD4, 0x3F    /* mov.l @(0x06033DA4), r4 */
    mov r13, r6
    bra .L_06033CB2
    mov r14, r5
.L_06033CAC:
    .byte 0xD4, 0x3E    /* mov.l @(0x06033DA8), r4 */
    mov r13, r6
    mov r14, r5
.L_06033CB2:
    mov.l @r15+, r13
