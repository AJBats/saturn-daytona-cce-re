...
FUN_060346E8:
    .byte 0xD3, 0x26    /* mov.l @(0x06034784), r3 */
    mov #0x0, r5
    .byte 0xD6, 0x26    /* mov.l @(0x06034788), r6 */
    mov r5, r4
    mov.w r4, @r3
    mov.w @r6, r2
    add #0x1, r2
    ...
    mov #0x2, r4
.L_06034702:
    .byte 0xD6, 0x22    /* mov.l @(0x0603478C), r6 */
    .byte 0xD3, 0x22    /* mov.l @(0x06034790), r3 */
    add r6, r3
    mov.b @r3, r2
    tst r2, r2
    bt .L_06034734
    .byte 0xD3, 0x21    /* mov.l @(0x06034794), r3 */
    mov.l @(16, r3), r0
    tst r0, r0
    bf .L_06034734
    .byte 0xD2, 0x20    /* mov.l @(0x06034798), r2 */
    mov.l @(16, r2), r0
    tst r0, r0
    bf .L_06034734
    mov #0x1, r7
    .byte 0xD0, 0x1B    /* mov.l @(0x06034790), r0 */
    mov.b @(r0, r6), r0
    cmp/eq #0x2, r0
    bf/s .L_06034730
    mov r7, r4
...
.L_060347BA:
    ...
    mov.b @r12, r0
    mov r0, r3
    .byte 0xD1, 0x40    /* mov.l @(0x060348E0), r1 */
    shll r0
    .byte 0xD2, 0x40    /* mov.l @(0x060348E4), r2 */
    shll2 r3
    add r3, r0
    exts.b r0, r0
    mov.w .L_wpool_060348D8, r3
    mov.b @(r0, r1), r0
    .byte 0xD1, 0x3E    /* mov.l @(0x060348E8), r1 */
    mov.b r0, @(8, r4)
    mov.b @r12, r0
    extu.b r0, r0
    muls.w r3, r0
    ...
    shll2 r3
    exts.w r3, r3
    .byte 0xD0, 0x34    /* mov.l @(0x060348EC), r0 */
    mov.l @(r0, r3), r3
    .byte 0xD2, 0x34    /* mov.l @(0x060348F0), r2 */
    jsr @r2
    mov.l r3, @(12, r4)
.L_06034822:
...
FUN_06034834:
    sts.l macl, @-r15
    mov #0x0, r5
    .byte 0xD4, 0x2F    /* mov.l @(0x060348F8), r4 */
    mov #0x20, r7
    mov.l r5, @r4
    mov r5, r6
    mov.l r5, @(4, r4)
.L_06034842:
    ...
    cmp/ge r7, r3
    bf .L_06034842
    .byte 0xD6, 0x26    /* mov.l @(0x060348FC), r6 */
    mov.b @r6, r0
    .byte 0xD1, 0x1E    /* mov.l @(0x060348E0), r1 */
    mov r0, r3
    .byte 0xD2, 0x1E    /* mov.l @(0x060348E4), r2 */
    shll r0
    shll2 r3
    add r3, r0
    mov.w .L_wpool_060348D8, r3
    ...
    extu.b r0, r0
    muls.w r3, r0
    .byte 0xD1, 0x1A    /* mov.l @(0x060348E8), r1 */
    sts macl, r0
    exts.w r0, r0
    mov.b @(r0, r2), r0
    mov.b r0, @(9, r4)
    ...
    add r0, r3
    shll2 r3
    .byte 0xD0, 0x12    /* mov.l @(0x060348EC), r0 */
    exts.w r3, r3
    .byte 0xD2, 0x12    /* mov.l @(0x060348F0), r2 */
    mov.l @(r0, r3), r3
    mov.l r3, @(12, r4)
    jmp @r2
    lds.l @r15+, macl
