...
FUN_0602F332:
    sts.l pr, @-r15
    mov.w r3, @r2
    .byte 0xD3, 0x16  /* 0602F336: mov.l @(0x58,PC),r3  {[0x0602F390] = 0x0602D102} */
    jsr @r3
    mov #0x2C, r5
    .byte 0xD5, 0x26  /* 0602F33C: mov.l @(0x98,PC),r5  {[0x0602F3D8] = 0x25E6A080} */
    mov #0x5, r7
    .byte 0xD4, 0x26  /* 0602F340: mov.l @(0x98,PC),r4  {[0x0602F3DC] = 0x002E3B88} */
    mov #0x2A, r6
    .byte 0xD2, 0x10  /* 0602F344: mov.l @(0x40,PC),r2  {[0x0602F388] = 0x0602D052} */
    jmp @r2
    lds.l @r15+, pr
    .global FUN_0602F34A
FUN_0602F34A:
    .byte 0xE2, 0x7F  /* 0602F34A: mov #127,r2 */
    .byte 0xD1, 0x25  /* 0602F34C: mov.l @(0x94,PC),r1  {[0x0602F3E4] = 0x25F80110} */
    .byte 0xE0, 0x00  /* 0602F34E: mov #0,r0 */
    .byte 0xD3, 0x23  /* 0602F350: mov.l @(0x8C,PC),r3  {[0x0602F3E0] = 0x060131BE} */
    .byte 0x23, 0x41  /* 0602F352: mov.w r4,@r3 */
    .byte 0x21, 0x21  /* 0602F354: mov.w r2,@r1 */
    .byte 0x71, 0x06  /* 0602F356: add #6,r1 */
    .byte 0xD2, 0x23  /* 0602F358: mov.l @(0x8C,PC),r2  {[0x0602F3E8] = 0x25F80112} */
    .byte 0x22, 0x01  /* 0602F35A: mov.w r0,@r2 */
    .byte 0xD3, 0x23  /* 0602F35C: mov.l @(0x8C,PC),r3  {[0x0602F3EC] = 0x25F80114} */
    .byte 0x72, 0x06  /* 0602F35E: add #6,r2 */
    .byte 0x23, 0x41  /* 0602F360: mov.w r4,@r3 */
    .byte 0x73, 0x06  /* 0602F362: add #6,r3 */
    .byte 0x21, 0x41  /* 0602F364: mov.w r4,@r1 */
    .byte 0x71, 0x06  /* 0602F366: add #6,r1 */
    .byte 0x22, 0x41  /* 0602F368: mov.w r4,@r2 */
    .byte 0x72, 0x06  /* 0602F36A: add #6,r2 */
    .byte 0x23, 0x41  /* 0602F36C: mov.w r4,@r3 */
    .byte 0x21, 0x41  /* 0602F36E: mov.w r4,@r1 */
    .byte 0x00, 0x0B  /* 0602F370: rts */
    .byte 0x22, 0x41  /* 0602F372: mov.w r4,@r2 */
