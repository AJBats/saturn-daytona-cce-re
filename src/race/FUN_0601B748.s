...
FUN_0601B748:
    ...
    .byte 0x06, 0x04  /* 0601B7E4: mov.b r0,@(r0,r6) */
    .byte 0x4D, 0xBA  /* 0601B7E6: .word 0x4DBA */
    .byte 0x06, 0x04  /* 0601B7E8: mov.b r0,@(r0,r6) */
    .byte 0x4E, 0x3C  /* 0601B7EA: shad r3,r14 */
    .byte 0x06, 0x04  /* 0601B7EC: mov.b r0,@(r0,r6) */
    .byte 0x76, 0x70  /* 0601B7EE: add #112,r6 */
    .byte 0x06, 0x04  /* 0601B7F0: mov.b r0,@(r0,r6) */
    .byte 0x50, 0x7E  /* 0601B7F2: mov.l @(0x38,r7),r0 */
    .byte 0x06, 0x04  /* 0601B7F4: mov.b r0,@(r0,r6) */
    .byte 0x50, 0xF2  /* 0601B7F6: mov.l @(0x8,r15),r0 */
    .byte 0x00, 0x20  /* 0601B7F8: .word 0x0020 */
    .byte 0x00, 0x00  /* 0601B7FA: .word 0x0000 */
    .byte 0x06, 0x04  /* 0601B7FC: mov.b r0,@(r0,r6) */
    .byte 0x4F, 0x30  /* 0601B7FE: .word 0x4F30 */
    .byte 0x06, 0x05  /* 0601B800: mov.w r0,@(r0,r6) */
    .byte 0x6A, 0x08  /* 0601B802: swap.b r0,r10 */
    .byte 0x06, 0x04  /* 0601B804: mov.b r0,@(r0,r6) */
    .byte 0x59, 0x58  /* 0601B806: mov.l @(0x20,r5),r9 */
    .byte 0x06, 0x04  /* 0601B808: mov.b r0,@(r0,r6) */
    .byte 0x7D, 0x50  /* 0601B80A: add #80,r13 */
    .byte 0x06, 0x04  /* 0601B80C: mov.b r0,@(r0,r6) */
    .byte 0x38, 0x10  /* 0601B80E: cmp/eq r1,r8 */
