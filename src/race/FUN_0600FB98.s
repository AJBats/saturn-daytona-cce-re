...
FUN_0600FB98:
    sts.l pr, @-r15
    mov.l r11, @-r15
    mov.l .L_pool_0600FCBC, r0
    mov.l .L_pool_0600FCC0, r5
    mov.b r5, @(r0, r14)
    mov.l @(12, r2), r8
    mov.w .L_wpool_0600FCA0, r0
    mov.l @(r0, r14), r4
    shll8 r4
    add r4, r8
    mov.l @(8, r2), r4
    mov.l @(0, r2), r5
    mov.l .L_pool_0600FCC4, r13
    jsr @r13
    nop
    exts.w r0, r0
    mov r0, r9
    mov r0, r4
    mov.l .L_pool_0600FCC8, r13
    jsr @r13
    nop
    mov r0, r10
    mov r9, r4
    mov.l .L_pool_0600FCCC, r13
    jsr @r13
    nop
    mov r0, r11
    mov r8, r4
    mov r10, r5
    mov.l .L_pool_0600FCD0, r13
    jsr @r13
    nop
    mov.l @(0, r14), r3
    add r0, r3
...
.L_pool_0600FCD0:
    ...
    .4byte sym_243D1E49  /* 0600FD3C = 0x243D1E49 */
