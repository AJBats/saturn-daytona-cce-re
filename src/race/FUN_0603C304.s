...
FUN_0603C338:
    ...
    mov.l r12, @-r15
    mov r4, r13
    .byte 0xD3, 0x13    /* mov.l @(0x0603C390), r3 */
    add #0x10, r13
...
.L_0603C398:
    .byte 0x92, 0x7F    /* mov.w @(0x0603C49A), r2 */
    mov #0x60, r0
    mov.l @(r0, r14), r1
    add r2, r1
    mov.l r1, @(r0, r14)
    .byte 0xD0, 0x3F    /* mov.l @(0x0603C4A0), r0 */
    cmp/gt r0, r1
    bf .L_0603C3D4
    .byte 0x90, 0x78    /* mov.w @(0x0603C49C), r0 */
    mov.w @(r0, r14), r1
    add #0x1, r1
    mov.w r1, @(r0, r14)
    .byte 0xD0, 0x3C    /* mov.l @(0x0603C4A4), r0 */
    exts.w r1, r1
    mov.b @r0, r3
    extu.b r3, r3
    .byte 0xD0, 0x3B    /* mov.l @(0x0603C4A8), r0 */
    mov r3, r2
    shll2 r3
    add r2, r3
    shll2 r3
    ...
    bf/s .L_0603C3D0
    mov #0x0, r4
    .byte 0x90, 0x66    /* mov.w @(0x0603C49C), r0 */
    mov.w r4, @(r0, r14)
.L_0603C3D0:
    mov #0x60, r0
    mov.l r4, @(r0, r14)
.L_0603C3D4:
    .byte 0xD3, 0x35    /* mov.l @(0x0603C4AC), r3 */
    mov #0x0, r6
    .byte 0xDD, 0x35    /* mov.l @(0x0603C4B0), r13 */
    mov #0x60, r0
    mov.l r3, @-r15
    mov r13, r7
    mov.l @(r0, r14), r5
    ...
    shll r4
    add r2, r4
    .byte 0xD2, 0x30    /* mov.l @(0x0603C4B4), r2 */
    shll2 r4
    shll r4
    jsr @r2
    add r1, r4
    ...
    mov.l r0, @(4, r14)
    mov.l @(8, r13), r2
    .byte 0xDD, 0x25    /* mov.l @(0x0603C4B8), r13 */
    mov.l r2, @(8, r14)
    jsr @r13
    mov #0x2, r4
    .byte 0xD3, 0x24    /* mov.l @(0x0603C4BC), r3 */
    mov r0, r5
    .byte 0x90, 0x36    /* mov.w @(0x0603C49C), r0 */
    jsr @r3
    mov.w @(r0, r14), r4
    mov #0x15, r5
    .byte 0xDC, 0x22    /* mov.l @(0x0603C4C0), r12 */
    jsr @r13
    mov #0x2, r4
    mov r0, r5
    mov #0x60, r0
    ...
    jsr @r13
    mov #0x2, r4
    .byte 0xD4, 0x1E    /* mov.l @(0x0603C4C4), r4 */
    mov r0, r5
    mov.l r4, @r15
    jsr @r12
    mov.l @r4, r4
