...
FUN_0602B6D4:
    ...
    mov.l r10, @-r15
    mov r4, r10
    .byte 0xD2, 0x3B    /* mov.l @(0x0602B7D0), r2 */
    extu.b r10, r14
...
.L_0602B9D4:
    .byte 0xD1, 0x6A    /* mov.l @(0x0602BB80), r1 */
    extu.b r10, r2
    mov.b @r1, r3
    extu.b r3, r3
    cmp/eq r3, r2
    ...
    mov.w r13, @r12
.L_0602B9FE:
    .byte 0xD3, 0x61    /* mov.l @(0x0602BB84), r3 */
    jsr @r3
    mov.w @r12, r4
.L_0602BA04:
    .byte 0xD9, 0x60    /* mov.l @(0x0602BB88), r9 */
    mov.w @(8, r14), r0
    .byte 0xD2, 0x60    /* mov.l @(0x0602BB8C), r2 */
    mov.w @r2, r3
    cmp/hi r3, r0
    bt .L_0602BA78
    ...
    tst r0, r0
    bt .L_0602BA78
    .byte 0xDC, 0x5E    /* mov.l @(0x0602BB94), r12 */
...
.L_0602BA4A:
    ...
    mov #0x3, r5
.L_0602BA52:
    .byte 0xD4, 0x52    /* mov.l @(0x0602BB9C), r4 */
    add r8, r4
    mov.b @r4, r2
    tst r2, r2
    bf .L_0602BA72
...
.L_0602BA78:
    ...
    tst r0, r0
    bt .L_0602BAA2
    .byte 0xD3, 0x48    /* mov.l @(0x0602BBA0), r3 */
    mov.b r11, @r3
    mov.b @r9, r0
    tst r0, r0
    bt .L_0602BAA2
    mov.b r13, @r9
    add #0x8, r15
    .byte 0xD2, 0x45    /* mov.l @(0x0602BBA4), r2 */
    lds.l @r15+, macl
    lds.l @r15+, pr
    mov.l @r15+, r8
    mov.l @r15+, r9
...
FUN_0602BAB8:
    mov.l r14, @-r15
    mov r4, r14
    .byte 0xD0, 0x3A    /* mov.l @(0x0602BBA8), r0 */
    mov.l r13, @-r15
    mov.l r12, @-r15
    mov.l r11, @-r15
    mov.l r10, @-r15
    mov #0x1, r10
    .byte 0xDB, 0x39    /* mov.l @(0x0602BBB0), r11 */
    mov.l r9, @-r15
    mov.l r8, @-r15
    mov r5, r8
    .byte 0xD9, 0x36    /* mov.l @(0x0602BBAC), r9 */
...
FUN_0602BDDC:
    ...
    mov.l r5, @(4, r15)
    mov.l r6, @r15
    .byte 0xD6, 0x7B    /* mov.l @(0x0602BFE4), r6 */
    mov.w @(8, r12), r0
    extu.w r0, r0
    cmp/ge r3, r0
    bt/s .L_0602BE16
...
.L_0602BE1E:
    ...
    add #0x4, r4
    mov #0x9, r4
    .byte 0xD3, 0x6B    /* mov.l @(0x0602BFE8), r3 */
    mov.l @(20, r12), r2
    mov.l r2, @r3
    mov.w @(8, r12), r0
    mov r0, r13
...
.L_0602BE4C:
    ...
    bf .L_0602BE66
    exts.w r14, r2
    .byte 0xD0, 0x62    /* mov.l @(0x0602BFE4), r0 */
    shll2 r2
    mov.l @(r0, r2), r3
    tst r3, r3
    bt .L_0602BE66
...
.L_0602BE66:
    mov r11, r9
.L_0602BE68:
    .byte 0xD3, 0x60    /* mov.l @(0x0602BFEC), r3 */
    exts.w r14, r10
    mov.b @r3, r0
    tst r0, r0
    bt/s .L_0602BE86
    add #0x6, r10
    .byte 0xD0, 0x5B    /* mov.l @(0x0602BFE4), r0 */
    extu.b r9, r7
    ...
    mov.l @(r0, r4), r4
.L_0602BE86:
    .byte 0xD2, 0x5B    /* mov.l @(0x0602BFF4), r2 */
    mov.b @r2, r3
    tst r3, r3
    bf .L_0602BE98
    mov r10, r5
    .byte 0xD3, 0x59    /* mov.l @(0x0602BFF8), r3 */
    exts.w r13, r4
    jsr @r3
    add #0x1, r4
.L_0602BE98:
...
.L_pool_0602C01C:
    ...
    shll r5
    .byte 0xD1, 0x3D    /* mov.l @(0x0602C124), r1 */
    extu.b r4, r4
    mov.w r3, @(r0, r5)
    .byte 0xD0, 0x3B    /* mov.l @(0x0602C120), r0 */
    muls.w r2, r4
    sts macl, r4
    exts.w r4, r4
    add r4, r1
    ...
    muls.w r3, r6
    .byte 0xD2, 0x36    /* mov.l @(0x0602C128), r2 */
    sts macl, r6
    ...
    shar r5
.L_0602C070:
    .byte 0xD0, 0x2B    /* mov.l @(0x0602C120), r0 */
    mov r5, r7
    extu.b r4, r6
    shll r6
    mov.w @(r0, r6), r3
...
.L_0602C08C:
    ...
    mov.w r1, @(r0, r6)
.L_0602C09A:
    .byte 0xD0, 0x21    /* mov.l @(0x0602C120), r0 */
    mov.w r5, @(r0, r6)
    rts
    lds.l @r15+, macl
...
.L_0602C160:
    ...
    tst r0, r0
    bf .L_0602C1C4
    .byte 0xD3, 0x3E    /* mov.l @(0x0602C260), r3 */
...
.L_0602C1A4:
    ...
    mov.l r2, @(16, r15)
.L_0602C1A8:
    .byte 0xD3, 0x2E    /* mov.l @(0x0602C264), r3 */
    jsr @r3
    mov r13, r5
    neg r0, r0
    mov.l r0, @(4, r15)
...
.L_0602C1D6:
    sub r8, r5
    mov.l @(4, r15), r4
    .byte 0xD3, 0x23    /* mov.l @(0x0602C268), r3 */
    jsr @r3
    sub r9, r13
    mov r13, r4
    sub r0, r4
...
.L_0602C1FC:
    mov.b @r15, r2
    extu.b r2, r2
    .byte 0xD1, 0x1A    /* mov.l @(0x0602C26C), r1 */
    mov.b @r1, r3
    cmp/ge r3, r2
    bt .L_0602C20C
    bra .L_0602C0F0
...
.L_0602C36A:
    ...
    mov r6, r14
.L_0602C380:
    .byte 0xD3, 0x53    /* mov.l @(0x0602C4D0), r3 */
    sub r11, r5
    jsr @r3
    sub r9, r14
    mov r14, r4
...
.L_0602C3BA:
    rts
    mov r4, r0
    .byte 0xD2, 0x45    /* mov.l @(0x0602C4D4), r2 */
    mov.b @r2, r3
    tst r3, r3
    bf .L_0602C3D8
    ...
    mov.l @r0, r1
    mov.w @(8, r1), r0
    .byte 0xD1, 0x43    /* mov.l @(0x0602C4DC), r1 */
    mov.w @r1, r3
    cmp/hi r3, r0
    bf .L_0602C3D8
    rts
...
.L_0602C3D8:
    ...
    rts
    nop
    .byte 0xD2, 0x40    /* mov.l @(0x0602C4E0), r2 */
    mov.b @r2, r3
    tst r3, r3
    bf .L_0602C3F2
    .byte 0xD0, 0x3F    /* mov.l @(0x0602C4E4), r0 */
    mov.w @r0, r1
    tst r1, r1
    bf .L_0602C3F2
    rts
...
FUN_0602C3F8:
    ...
    extu.b r4, r6
    .byte 0xD2, 0x38    /* mov.l @(0x0602C4EC), r2 */
    mov.b @r2, r3
    tst r3, r3
    bf/s .L_0602C41C
    shll2 r6
...
.L_0602C42A:
    sub r1, r4
    .byte 0xD6, 0x30    /* mov.l @(0x0602C4F0), r6 */
    cmp/pz r4
    bf/s .L_0602C43A
    mov #0x1, r5
    mov #0x0, r2
...
.L_0602C43A:
    ...
    mov.b r5, @r6
.L_0602C43E:
    .byte 0xD2, 0x2D    /* mov.l @(0x0602C4F4), r2 */
    .byte 0xD3, 0x2D    /* mov.l @(0x0602C4F8), r3 */
    mov.l r4, @r2
    .byte 0xD4, 0x2D    /* mov.l @(0x0602C4FC), r4 */
    .byte 0xD1, 0x2E    /* mov.l @(0x0602C500), r1 */
    jsr @r1
    mov.b r5, @r3
    .byte 0xD3, 0x2D    /* mov.l @(0x0602C504), r3 */
    mov r0, r4
    jmp @r3
    lds.l @r15+, pr
.L_0602C454:
...
.L_0602C51C:
    .byte 0xD4, 0x3C    /* mov.l @(0x0602C610), r4 */
    mov.w @(8, r4), r0
    .byte 0xD3, 0x3C    /* mov.l @(0x0602C614), r3 */
    extu.w r0, r0
    mov.w @r3, r6
    extu.w r6, r6
    cmp/gt r6, r0
    ...
    bt .L_0602C592
    mov #0x0, r3
    .byte 0xD2, 0x37    /* mov.l @(0x0602C618), r2 */
    mov #0x1, r1
    mov.w @(8, r5), r0
    extu.w r0, r0
    mov.l @(28, r5), r4
    shll2 r0
    .byte 0xD5, 0x36    /* mov.l @(0x0602C620), r5 */
    shll2 r0
    add r14, r0
    mov.l @(r0, r7), r6
    mov.b r3, @r2
    sub r6, r4
    .byte 0xD0, 0x32    /* mov.l @(0x0602C61C), r0 */
    mov.b r1, @r0
    .byte 0xD3, 0x33    /* mov.l @(0x0602C624), r3 */
    tst r4, r3
    bt .L_0602C57C
    neg r4, r4
    ...
    mov.b @r14, r0
    xor #0x1, r0
    .byte 0xD4, 0x30    /* mov.l @(0x0602C62C), r4 */
    .byte 0xD3, 0x31    /* mov.l @(0x0602C630), r3 */
    jsr @r3
    mov.b r0, @r14
    .byte 0xD2, 0x30    /* mov.l @(0x0602C634), r2 */
    jsr @r2
    mov r0, r4
    mov.b @r15, r3
    bra .L_0602C592
...
.L_0602C57C:
    mov.l r4, @r5
    .byte 0xD4, 0x2B    /* mov.l @(0x0602C62C), r4 */
    .byte 0xD3, 0x2B    /* mov.l @(0x0602C630), r3 */
    jsr @r3
    nop
    mov r0, r4
    .byte 0xD2, 0x2A    /* mov.l @(0x0602C634), r2 */
    add #0x4, r15
    lds.l @r15+, pr
    jmp @r2
    mov.l @r15+, r14
...
.L_0602C650:
    .byte 0xD4, 0x35    /* mov.l @(0x0602C728), r4 */
    mov.w @(8, r4), r0
    .byte 0xD1, 0x35    /* mov.l @(0x0602C72C), r1 */
    extu.w r0, r0
    mov.w @r1, r2
    extu.w r2, r2
    mov.l r2, @r15
    ...
    mov.l @(28, r5), r4
    extu.w r0, r0
    .byte 0xD1, 0x30    /* mov.l @(0x0602C738), r1 */
    shll2 r0
    .byte 0xD5, 0x2E    /* mov.l @(0x0602C734), r5 */
    shll2 r0
    mov.b @r1, r2
    add r6, r0
    mov.l @(r0, r7), r6
    sub r6, r4
    .byte 0xD6, 0x2A    /* mov.l @(0x0602C730), r6 */
    mov.b @r6, r3
    cmp/eq r2, r3
    bf .L_0602C696
    .byte 0xD3, 0x2B    /* mov.l @(0x0602C73C), r3 */
    mov #0x0, r2
    mov.b r2, @r5
    bra .L_0602C698
    mov.b r14, @r3
.L_0602C696:
    mov.b r14, @r5
.L_0602C698:
    .byte 0xD3, 0x29    /* mov.l @(0x0602C740), r3 */
    mov.l r4, @r3
    mov.b @r6, r2
    extu.b r2, r2
    .byte 0xD0, 0x28    /* mov.l @(0x0602C744), r0 */
    mov.b @(r0, r2), r1
    tst r1, r1
    bf .L_0602C6BE
    .byte 0xD4, 0x27    /* mov.l @(0x0602C748), r4 */
    .byte 0xD1, 0x28    /* mov.l @(0x0602C74C), r1 */
    jsr @r1
    nop
    .byte 0xD3, 0x27    /* mov.l @(0x0602C750), r3 */
    mov.l r0, @r3
    .byte 0xD2, 0x27    /* mov.l @(0x0602C754), r2 */
    jsr @r2
    mov r0, r4
    .byte 0xD3, 0x27    /* mov.l @(0x0602C758), r3 */
    mov.b r14, @r3
.L_0602C6BE:
    add #0x4, r15
    lds.l @r15+, pr
