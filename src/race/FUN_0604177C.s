...
.L_06041BA0:
    ...
    nop
    .byte 0xD3, 0x37    /* mov.l @(0x06041C88), r3 */
    mov.b @r3, r0
    cmp/eq #0x2, r0
    bf .L_06041BB6
    bra .L_06041FF2
...
.L_06041BB6:
    mov r13, r6
    .byte 0xD5, 0x34    /* mov.l @(0x06041C8C), r5 */
    .byte 0xD4, 0x35    /* mov.l @(0x06041C90), r4 */
    .byte 0xD1, 0x35    /* mov.l @(0x06041C94), r1 */
    mov.b @r1, r7
    extu.b r7, r7
    tst r7, r7
    bt/s .L_06041BEE
...
.L_06041BC8:
    ...
    bf .L_06041BE4
    mov #0x23, r1
    .byte 0xD3, 0x31    /* mov.l @(0x06041C98), r3 */
...
.L_06041BEE:
    mov #0x11, r0
    .byte 0xD4, 0x2A    /* mov.l @(0x06041C9C), r4 */
    mov.b @(r0, r4), r1
    tst r1, r1
    bf .L_06041CA8
    tst r14, r14
...
.L_06041C28:
    ...
    bt/s .L_06041C40
    mov.b r12, @(r0, r4)
    .byte 0xD6, 0x19    /* mov.l @(0x06041CA0), r6 */
    bra .L_06041C4C
    nop
.L_06041C40:
...
.L_06041C4C:
    mov.w @(18, r4), r0
    .byte 0xD3, 0x15    /* mov.l @(0x06041CA4), r3 */
    jsr @r3
    mov r6, r1
    mov.w r0, @(20, r4)
...
.L_06041C6A:
    mov.w @(18, r4), r0
    .byte 0xD3, 0x0D    /* mov.l @(0x06041CA4), r3 */
    jsr @r3
    mov r5, r1
    bra .L_06041FF2
    mov.w r0, @(22, r4)
...
.L_06041CA8:
    ...
    mov.l @(4, r4), r3
    shll8 r0
    .byte 0xD2, 0x0E    /* mov.l @(0x06041CF0), r2 */
    shll2 r0
    shll2 r0
    add r0, r3
    mov.l r3, @(4, r4)
