...
FUN_0601B1F8:
    ...
    mov.l r9, @-r15
    mov #0x1E, r9
    mov.l .L_pool_0601B2C0, r12
    mov.l r8, @-r15
    sts.l pr, @-r15
    add #-0x4, r15
    mov.l .L_pool_0601B2B4, r14
    mov.l r3, @r15
    mov.w .L_wpool_0601B2AA, r8
.L_0601B216:
    mov.w @r14, r1
    tst r1, r1
    bf .L_0601B220
...
.L_0601B220:
    ...
    mov.w r3, @r14
    mov.w @r14, r2
    mov.w .L_wpool_0601B2AC, r3
    cmp/ge r3, r2
    bf .L_0601B24A
    mov.w .L_wpool_0601B2AE, r2
    mov.l @(8, r14), r1
    sub r2, r1
    mov.l r1, @(8, r14)
    mov.w .L_wpool_0601B2B0, r1
    mov.l @(12, r14), r0
    sub r1, r0
    mov.l r0, @(12, r14)
    mov #0x36, r0
...
.L_0601B256:
    ...
    mov.w @r14, r1
    mov #0x34, r0
    mov.l .L_pool_0601B2C4, r3
    mov.w @(r0, r14), r2
    jsr @r3
    mov r9, r0
    mov.l .L_pool_0601B2C8, r1
    add #-0x1, r0
    shll r0
    mov.w @(r0, r1), r1
    cmp/eq r1, r2
...
.L_pool_0601B2B4:
    ...
    .4byte DAT_06008E48  /* 0601B2B8 = 0x06008E48 (FUN_06008E32 + 0x16) */
    .4byte sym_060515F4  /* 0601B2BC = 0x060515F4 */
.L_pool_0601B2C0:
    .4byte sym_06048180  /* 0601B2C0 = 0x06048180 */
.L_pool_0601B2C4:
    .4byte DAT_06008A5C  /* 0601B2C4 = 0x06008A5C (FUN_06008A48 + 0x14) */
.L_pool_0601B2C8:
    .4byte sym_06051600  /* 0601B2C8 = 0x06051600 */
.L_0601B2CC:
    mov.w @r14, r0
    add #-0x10, r15
