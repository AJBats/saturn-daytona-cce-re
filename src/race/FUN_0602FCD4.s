...
.L_0602FE08:
    .byte 0x95, 0x7E    /* mov.w @(0x0602FF08), r5 */
    mov r13, r2
    mov r13, r3
    shll r2
    add r3, r2
...
.L_0602FE86:
    ...
    add r3, r1
    shll2 r1
    .byte 0x93, 0x3B    /* mov.w @(0x0602FF0A), r3 */
    exts.b r1, r1
    add r4, r1
    mov.w @r1, r2
    extu.w r2, r2
    ...
    bt .L_0602FECE
    mov.l @r14, r4
    .byte 0xD2, 0x1A    /* mov.l @(0x0602FF0C), r2 */
    mov.w @(14, r4), r0
    jsr @r2
    mov r0, r4
    .byte 0xD3, 0x19    /* mov.l @(0x0602FF10), r3 */
    shll r0
    neg r0, r0
    mov.l r0, @r15
    mov.l @r14, r4
...
.L_0602FECE:
    ...
    tst r13, r13
    bf .L_0602FEE2
    .byte 0xD3, 0x0F    /* mov.l @(0x0602FF14), r3 */
    add #0x4, r15
    lds.l @r15+, pr
    mov.l @r15+, r12
    mov.l @r15+, r13
...
FUN_0602FFE4:
    mov.b @(r0, r2), r1
    extu.b r1, r1
    .byte 0xD0, 0x26    /* mov.l @(0x06030084), r0 */
    shll r1
    mov.w @(r0, r1), r2
