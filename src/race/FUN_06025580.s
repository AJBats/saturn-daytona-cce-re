/* FUN_06025580  0x06025580 */
    ...
    .section .text.FUN_06025580
    .global FUN_06025580
    .type FUN_06025580, @function
FUN_06025580:
    .byte 0x2F, 0xE6  /* 06025580: mov.l r14,@-r15 */
    .byte 0x4F, 0x22  /* 06025582: sts.l pr,@-r15 */
    .byte 0x60, 0xE3  /* 06025584: mov r14,r0 */
    .byte 0xE1, 0x00  /* 06025586: mov #0,r1 */
    .byte 0xE2, 0x00  /* 06025588: mov #0,r2 */
    .byte 0xE3, 0x00  /* 0602558A: mov #0,r3 */
    .byte 0xE4, 0x00  /* 0602558C: mov #0,r4 */
    .byte 0xE7, 0x00  /* 0602558E: mov #0,r7 */
    .byte 0x6E, 0x03  /* 06025590: mov r0,r14 */
    .byte 0x91, 0x12  /* 06025592: mov.w @(0x24,PC),r1  {0x060255BA} */
    .byte 0x01, 0x1E  /* 06025594: mov.l @(r0,r1),r1 */
    .byte 0x66, 0x13  /* 06025596: mov r1,r6 */
    .byte 0x92, 0x10  /* 06025598: mov.w @(0x20,PC),r2  {0x060255BC} */
    .byte 0x93, 0x10  /* 0602559A: mov.w @(0x20,PC),r3  {0x060255BE} */
    .byte 0x41, 0x11  /* 0602559C: cmp/pz r1 */
    .byte 0x89, 0x00  /* 0602559E: bt 0x060255A2 */
    .byte 0x61, 0x1B  /* 060255A0: neg r1,r1 */
    .byte 0x31, 0x28  /* 060255A2: sub r2,r1 */
    .byte 0x41, 0x11  /* 060255A4: cmp/pz r1 */
    .byte 0x89, 0x2B  /* 060255A6: bt 0x06025600 */
    .byte 0xA0, 0x31  /* 060255A8: bra 0x0602560E */
    .byte 0xE1, 0x00  /* 060255AA: mov #0,r1 */
    ...
    .byte 0x00, 0x00  /* 060255C0: .word 0x0000 */
    .byte 0x00, 0x84  /* 060255C2: mov.b r8,@(r0,r0) */
    .byte 0x00, 0x00  /* 060255C4: .word 0x0000 */
    .byte 0x00, 0x38  /* 060255C6: .word 0x0038 */
    .byte 0x00, 0x00  /* 060255C8: .word 0x0000 */
    .byte 0x1B, 0x58  /* 060255CA: mov.l r5,@(0x20,r11) */
    .byte 0x00, 0x00  /* 060255CC: .word 0x0000 */
    .byte 0x00, 0x03  /* 060255CE: bsrf r0 */
    .byte 0x09, 0x00  /* 060255D0: .word 0x0900 */
    .byte 0x00, 0x00  /* 060255D2: .word 0x0000 */
    .byte 0x08, 0x00  /* 060255D4: .word 0x0800 */
    .byte 0x00, 0x00  /* 060255D6: .word 0x0000 */
    .byte 0x06, 0x04  /* 060255D8: mov.b r0,@(r0,r6) */
    .byte 0xD5, 0x80  /* 060255DA: mov.l @(0x200,PC),r5  {[0x060257DC] = 0x000B0326} */
    .byte 0x06, 0x04  /* 060255DC: mov.b r0,@(r0,r6) */
    .byte 0xD7, 0x80  /* 060255DE: mov.l @(0x200,PC),r7  {[0x060257E0] = 0x007800AC} */
    .byte 0x06, 0x04  /* 060255E0: mov.b r0,@(r0,r6) */
    .byte 0xDB, 0x10  /* 060255E2: mov.l @(0x40,PC),r11  {[0x06025624] = 0x046E0626} */
    .byte 0x06, 0x03  /* 060255E4: bsrf r6 */
    .byte 0x5E, 0xE8  /* 060255E6: mov.l @(0x20,r14),r14 */
    .byte 0x06, 0x04  /* 060255E8: mov.b r0,@(r0,r6) */
    .byte 0xD6, 0xB8  /* 060255EA: mov.l @(0x2E0,PC),r6  {[0x060258CC] = 0x4308332C} */
    .byte 0x06, 0x04  /* 060255EC: mov.b r0,@(r0,r6) */
    .byte 0xD8, 0x3C  /* 060255EE: mov.l @(0xF0,PC),r8  {[0x060256E0] = 0x06048160} */
    .byte 0x06, 0x03  /* 060255F0: bsrf r6 */
    .byte 0x66, 0xEC  /* 060255F2: extu.b r14,r6 */
    .byte 0x06, 0x03  /* 060255F4: bsrf r6 */
    .byte 0x67, 0x90  /* 060255F6: mov.b @r9,r7 */
    .byte 0x06, 0x03  /* 060255F8: bsrf r6 */
    .byte 0x74, 0x84  /* 060255FA: add #-124,r4 */
    .byte 0x06, 0x04  /* 060255FC: mov.b r0,@(r0,r6) */
    .byte 0xD3, 0x88  /* 060255FE: mov.l @(0x220,PC),r3  {[0x06025820] = 0x008800AC} */
    .byte 0x33, 0x28  /* 06025600: sub r2,r3 */
    .byte 0x33, 0x17  /* 06025602: cmp/gt r1,r3 */
    .byte 0x89, 0x00  /* 06025604: bt 0x06025608 */
    .byte 0x61, 0x33  /* 06025606: mov r3,r1 */
    .byte 0x46, 0x11  /* 06025608: cmp/pz r6 */
    .byte 0x89, 0x00  /* 0602560A: bt 0x0602560E */
    .byte 0x61, 0x1B  /* 0602560C: neg r1,r1 */
    .byte 0x6E, 0x03  /* 0602560E: mov r0,r14 */
    .byte 0x92, 0x11  /* 06025610: mov.w @(0x22,PC),r2  {0x06025636} */
    .byte 0x22, 0x1F  /* 06025612: muls.w r1,r2 */
    .byte 0x90, 0x10  /* 06025614: mov.w @(0x20,PC),r0  {0x06025638} */
    .byte 0x01, 0x1A  /* 06025616: sts macl,r1 */
    .byte 0xDC, 0x08  /* 06025618: mov.l @(0x20,PC),r12  {[0x0602563C] = 0x06048160} */
    .byte 0x4C, 0x0B  /* 0602561A: jsr @r12 */
    .byte 0x00, 0x09  /* 0602561C: nop */
    .byte 0x62, 0x03  /* 0602561E: mov r0,r2 */
    .byte 0x60, 0xE3  /* 06025620: mov r14,r0 */
    .byte 0x96, 0x0A  /* 06025622: mov.w @(0x14,PC),r6  {0x0602563A} */
    .byte 0x04, 0x6E  /* 06025624: mov.l @(r0,r6),r4 */
    .byte 0x06, 0x26  /* 06025626: mov.l r2,@(r0,r6) */
    ...
    .byte 0x06, 0x04  /* 0602563C: mov.b r0,@(r0,r6) */
    .byte 0x81, 0x60  /* 0602563E: mov.w r0,@(0x0,r6) */
    .byte 0x00, 0x00  /* 06025640: .word 0x0000 */
    .byte 0x00, 0xB8  /* 06025642: .word 0x00B8 */
    ...
    .byte 0x00, 0x00  /* 0602567C: .word 0x0000 */
    .byte 0x00, 0x38  /* 0602567E: .word 0x0038 */
    .byte 0x00, 0x00  /* 06025680: .word 0x0000 */
    .byte 0x00, 0x80  /* 06025682: .word 0x0080 */
    .byte 0x06, 0x04  /* 06025684: mov.b r0,@(r0,r6) */
    .byte 0x81, 0x60  /* 06025686: mov.w r0,@(0x0,r6) */
    .byte 0x00, 0x00  /* 06025688: .word 0x0000 */
    .byte 0x00, 0xB8  /* 0602568A: .word 0x00B8 */
    ...
    .byte 0x03, 0x16  /* 060256AC: mov.l r1,@(r0,r3) */
    .byte 0x4F, 0x26  /* 060256AE: lds.l @r15+,pr */
    ...
    .byte 0x00, 0x00  /* 060256DC: .word 0x0000 */
    .byte 0x00, 0x38  /* 060256DE: .word 0x0038 */
    .byte 0x06, 0x04  /* 060256E0: mov.b r0,@(r0,r6) */
    .byte 0x81, 0x60  /* 060256E2: mov.w r0,@(0x0,r6) */
    .byte 0x00, 0x6C  /* 060256E4: mov.b @(r0,r6),r0 */
    .byte 0x00, 0x00  /* 060256E6: .word 0x0000 */
    .byte 0x00, 0x00  /* 060256E8: .word 0x0000 */
    .byte 0x01, 0x4E  /* 060256EA: mov.l @(r0,r4),r1 */
    ...
    .byte 0x00, 0x00  /* 06025718: .word 0x0000 */
    .byte 0x01, 0x40  /* 0602571A: .word 0x0140 */
    .byte 0x00, 0x00  /* 0602571C: .word 0x0000 */
    .byte 0x00, 0x01  /* 0602571E: .word 0x0001 */
    .byte 0x00, 0x00  /* 06025720: .word 0x0000 */
    .byte 0x00, 0x00  /* 06025722: .word 0x0000 */
    ...
    .byte 0x00, 0x00  /* 06025730: .word 0x0000 */
    .byte 0x2A, 0xAA  /* 06025732: xor r10,r10 */
    ...
    .byte 0x91, 0x13  /* 06025780: mov.w @(0x26,PC),r1  {0x060257AA} */
    .byte 0x02, 0x1D  /* 06025782: mov.w @(r0,r1),r2 */
    ...
    .byte 0x00, 0x00  /* 060257B0: .word 0x0000 */
    .byte 0x0A, 0xAA  /* 060257B2: .word 0x0AAA */
    ...
    .byte 0x00, 0x0B  /* 060257DC: rts */
    .byte 0x03, 0x26  /* 060257DE: mov.l r2,@(r0,r3) */
    .byte 0x00, 0x78  /* 060257E0: .word 0x0078 */
    .byte 0x00, 0xAC  /* 060257E2: mov.b @(r0,r10),r0 */
    ...
    .byte 0x00, 0x00  /* 060257F0: .word 0x0000 */
    .byte 0x00, 0x90  /* 060257F2: .word 0x0090 */
    ...
    .byte 0x00, 0x88  /* 06025820: .word 0x0088 */
    .byte 0x00, 0xAC  /* 06025822: mov.b @(r0,r10),r0 */
    .byte 0x00, 0x00  /* 06025824: .word 0x0000 */
    .byte 0x07, 0x1C  /* 06025826: mov.b @(r0,r1),r7 */
    ...
    .byte 0xA0, 0x35  /* 06025876: bra 0x060258E4 */
    ...
    .byte 0x00, 0x2D  /* 06025880: mov.w @(r0,r2),r0 */
    .byte 0xD6, 0x30  /* 06025882: mov.l @(0xC0,PC),r6  {[0x06025944] = 0x6493000B} */
    .byte 0x00, 0x2D  /* 06025884: mov.w @(r0,r2),r0 */
    .byte 0xD6, 0x20  /* 06025886: mov.l @(0x80,PC),r6  {[0x06025908] = 0xA00D0009} */
    ...
    .byte 0xA0, 0x19  /* 060258AE: bra 0x060258E4 */
    .byte 0x08, 0x16  /* 060258B0: mov.l r1,@(r0,r8) */
    .byte 0x00, 0xD0  /* 060258B2: .word 0x00D0 */
    .byte 0x00, 0x2D  /* 060258B4: mov.w @(r0,r2),r0 */
    .byte 0xD6, 0x50  /* 060258B6: mov.l @(0x140,PC),r6  {[0x060259F8] = 0x6523D822} */
    ...
    .byte 0x43, 0x08  /* 060258CC: shll2 r3 */
    .byte 0x33, 0x2C  /* 060258CE: add r2,r3 */
