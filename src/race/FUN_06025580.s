...
FUN_06025580:
    ...
    mov #0x0, r7
    mov r0, r14
    mov.w .L_wpool_060255BA, r1
    mov.l @(r0, r1), r1
    mov r1, r6
    mov.w .L_wpool_060255BC, r2
    mov.w .L_wpool_060255BE, r3
    cmp/pz r1
    bt .L_060255A2
    neg r1, r1
.L_060255A2:
...
.L_0602560E:
    mov r0, r14
    mov.w .L_wpool_06025636, r2
    muls.w r1, r2
    mov.w .L_wpool_06025638, r0
    sts macl, r1
    mov.l .L_pool_0602563C, r12
    jsr @r12
    nop
    mov r0, r2
    mov r14, r0
    mov.w .L_wpool_0602563A, r6
