...
FUN_060477FC:
    ...
    mov.w r2, @r1
    mov.l r0, @(4, r4)
    .byte 0xD0, 0x21  /* 0601F80A: mov.l @(0x84,PC),r0  {[0x0601F890] = 0x0602F51C} */
    jsr @r0
    nop
    ...
    .byte 0xD0, 0x1F  /* 0601F826: mov.l @(0x7C,PC),r0  {[0x0601F8A4] = 0x0602F500} */
    jsr @r0
    nop
    ...
    mov.w r0, @(2, r1)
    .byte 0xD0, 0x10  /* 0601F84C: mov.l @(0x40,PC),r0  {[0x0601F890] = 0x0602F51C} */
    jsr @r0
    nop
