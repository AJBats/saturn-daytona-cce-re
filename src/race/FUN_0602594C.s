...
.L_060259EC:
    ...
    mov r14, r0
    mov.l r4, @(r0, r3)
    mov.w .L_wpool_06025A72, r5
    mov.w .L_wpool_06025A74, r1
    add r5, r4
    mov.l r4, @(r0, r1)
    mov #0x10, r4
    neg r4, r4
    mov.w .L_wpool_06025A76, r3
    mov.l r4, @(r0, r3)
.L_06025A34:
...
.L_06025A96:
    add r4, r3
    mov.l .L_pool_06025AA8, r8
    mov.w .L_wpool_06025AA6, r9
    cmp/gt r8, r3
    bt .L_06025AAC
    mov r8, r3
    bra .L_06025AB2
