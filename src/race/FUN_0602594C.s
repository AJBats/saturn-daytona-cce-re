...
FUN_0602594C:
    .byte 0x4F, 0x22  /* 0602594C: sts.l pr,@-r15 */
    .byte 0x91, 0x07  /* 0602594E: mov.w @(0xE,PC),r1  {0x06025960} */
    .byte 0x03, 0x1E  /* 06025950: mov.l @(r0,r1),r3 */
    .byte 0x23, 0x38  /* 06025952: tst r3,r3 */
    .byte 0x89, 0x12  /* 06025954: bt 0x0602597C */
    .byte 0x43, 0x11  /* 06025956: cmp/pz r3 */
    .byte 0x8B, 0x03  /* 06025958: bf 0x06025962 */
    .byte 0x73, 0xFF  /* 0602595A: add #-1,r3 */
    .byte 0xA0, 0x0E  /* 0602595C: bra 0x0602597C */
    .byte 0x01, 0x36  /* 0602595E: mov.l r3,@(r0,r1) */
    .byte 0x00, 0xB8  /* 06025960: .word 0x00B8 */
    .byte 0x73, 0x01  /* 06025962: add #1,r3 */
    .byte 0x01, 0x36  /* 06025964: mov.l r3,@(r0,r1) */
    .byte 0x92, 0x13  /* 06025966: mov.w @(0x26,PC),r2  {0x06025990} */
    .byte 0x01, 0x2E  /* 06025968: mov.l @(r0,r2),r1 */
    .byte 0x21, 0x18  /* 0602596A: tst r1,r1 */
    .byte 0x89, 0x06  /* 0602596C: bt 0x0602597C */
    .byte 0x92, 0x10  /* 0602596E: mov.w @(0x20,PC),r2  {0x06025992} */
    .byte 0x91, 0x10  /* 06025970: mov.w @(0x20,PC),r1  {0x06025994} */
    .byte 0x03, 0x2E  /* 06025972: mov.l @(r0,r2),r3 */
    .byte 0x01, 0x36  /* 06025974: mov.l r3,@(r0,r1) */
    .byte 0x94, 0x0E  /* 06025976: mov.w @(0x1C,PC),r4  {0x06025996} */
    .byte 0x33, 0x48  /* 06025978: sub r4,r3 */
    .byte 0x02, 0x36  /* 0602597A: mov.l r3,@(r0,r2) */
    .byte 0x91, 0x0C  /* 0602597C: mov.w @(0x18,PC),r1  {0x06025998} */
    .byte 0x02, 0x1D  /* 0602597E: mov.w @(r0,r1),r2 */
    .byte 0x95, 0x0B  /* 06025980: mov.w @(0x16,PC),r5  {0x0602599A} */
    .byte 0x06, 0x5D  /* 06025982: mov.w @(r0,r5),r6 */
    .byte 0x36, 0x20  /* 06025984: cmp/eq r2,r6 */
    .byte 0x89, 0x55  /* 06025986: bt 0x06025A34 */
    .byte 0x36, 0x27  /* 06025988: cmp/gt r2,r6 */
    .byte 0x89, 0x07  /* 0602598A: bt 0x0602599C */
    .byte 0xA0, 0x2E  /* 0602598C: bra 0x060259EC */
    .byte 0x00, 0x09  /* 0602598E: nop */
    ...
    .byte 0xE3, 0x03  /* 0602599C: mov #3,r3 */
    .byte 0x32, 0x30  /* 0602599E: cmp/eq r3,r2 */
    .byte 0x89, 0x48  /* 060259A0: bt 0x06025A34 */
    .byte 0x01, 0x65  /* 060259A2: mov.w r6,@(r0,r1) */
    .byte 0x93, 0x1B  /* 060259A4: mov.w @(0x36,PC),r3  {0x060259DE} */
    .byte 0x04, 0x3E  /* 060259A6: mov.l @(r0,r3),r4 */
    .byte 0x44, 0x28  /* 060259A8: shll16 r4 */
    .byte 0x65, 0x23  /* 060259AA: mov r2,r5 */
    .byte 0xD8, 0x0D  /* 060259AC: mov.l @(0x34,PC),r8  {[0x060259E4] = 0x002DD640} */
    .byte 0x69, 0x83  /* 060259AE: mov r8,r9 */
    .byte 0x45, 0x08  /* 060259B0: shll2 r5 */
    .byte 0x38, 0x5C  /* 060259B2: add r5,r8 */
    .byte 0x67, 0x82  /* 060259B4: mov.l @r8,r7 */
    .byte 0x65, 0x63  /* 060259B6: mov r6,r5 */
    .byte 0x34, 0x7D  /* 060259B8: dmuls.l r7,r4 */
    .byte 0x45, 0x08  /* 060259BA: shll2 r5 */
    .byte 0x39, 0x5C  /* 060259BC: add r5,r9 */
    .byte 0x07, 0x0A  /* 060259BE: sts mach,r7 */
    .byte 0x04, 0x1A  /* 060259C0: sts macl,r4 */
    .byte 0x65, 0x92  /* 060259C2: mov.l @r9,r5 */
    .byte 0x24, 0x7D  /* 060259C4: xtrct r7,r4 */
    .byte 0xD0, 0x08  /* 060259C6: mov.l @(0x20,PC),r0  {[0x060259E8] = 0x0604818C} */
    .byte 0x40, 0x0B  /* 060259C8: jsr @r0 */
    .byte 0x00, 0x09  /* 060259CA: nop */
    .byte 0x93, 0x07  /* 060259CC: mov.w @(0xE,PC),r3  {0x060259DE} */
    .byte 0x40, 0x29  /* 060259CE: shlr16 r0 */
    .byte 0x64, 0x03  /* 060259D0: mov r0,r4 */
    .byte 0x60, 0xE3  /* 060259D2: mov r14,r0 */
    .byte 0x03, 0x46  /* 060259D4: mov.l r4,@(r0,r3) */
    .byte 0xE5, 0x10  /* 060259D6: mov #16,r5 */
    .byte 0x91, 0x02  /* 060259D8: mov.w @(0x4,PC),r1  {0x060259E0} */
    .byte 0xA0, 0x2B  /* 060259DA: bra 0x06025A34 */
    .byte 0x01, 0x56  /* 060259DC: mov.l r5,@(r0,r1) */
    .byte 0x00, 0xD0  /* 060259DE: .word 0x00D0 */
    .byte 0x00, 0xB8  /* 060259E0: .word 0x00B8 */
    .byte 0x00, 0x00  /* 060259E2: .word 0x0000 */
    .byte 0x00, 0x2D  /* 060259E4: mov.w @(r0,r2),r0 */
    .byte 0xD6, 0x40  /* 060259E6: mov.l @(0x100,PC),r6  {[0x06025AE8] = 0x01353350} */
    .byte 0x06, 0x04  /* 060259E8: mov.b r0,@(r0,r6) */
    .byte 0x81, 0x8C  /* 060259EA: mov.w r0,@(0x18,r8) */
    .byte 0x22, 0x28  /* 060259EC: tst r2,r2 */
    .byte 0x89, 0x21  /* 060259EE: bt 0x06025A34 */
    .byte 0x01, 0x65  /* 060259F0: mov.w r6,@(r0,r1) */
    .byte 0x93, 0x3D  /* 060259F2: mov.w @(0x7A,PC),r3  {0x06025A70} */
    .byte 0x04, 0x3E  /* 060259F4: mov.l @(r0,r3),r4 */
    .byte 0x44, 0x28  /* 060259F6: shll16 r4 */
    .byte 0x65, 0x23  /* 060259F8: mov r2,r5 */
    .byte 0xD8, 0x22  /* 060259FA: mov.l @(0x88,PC),r8  {[0x06025A84] = 0x002DD640} */
    ...
    .byte 0x93, 0x20  /* 06025A34: mov.w @(0x40,PC),r3  {0x06025A78} */
    .byte 0x91, 0x1B  /* 06025A36: mov.w @(0x36,PC),r1  {0x06025A70} */
    .byte 0x04, 0x1E  /* 06025A38: mov.l @(r0,r1),r4 */
    .byte 0x33, 0x47  /* 06025A3A: cmp/gt r4,r3 */
    .byte 0x89, 0x04  /* 06025A3C: bt 0x06025A48 */
    .byte 0xE4, 0xFF  /* 06025A3E: mov #-1,r4 */
    .byte 0x64, 0x4C  /* 06025A40: extu.b r4,r4 */
    .byte 0x95, 0x1A  /* 06025A42: mov.w @(0x34,PC),r5  {0x06025A7A} */
    .byte 0x01, 0x36  /* 06025A44: mov.l r3,@(r0,r1) */
    .byte 0x05, 0x46  /* 06025A46: mov.l r4,@(r0,r5) */
    .byte 0x96, 0x18  /* 06025A48: mov.w @(0x30,PC),r6  {0x06025A7C} */
    .byte 0x92, 0x18  /* 06025A4A: mov.w @(0x30,PC),r2  {0x06025A7E} */
    .byte 0x03, 0x6E  /* 06025A4C: mov.l @(r0,r6),r3 */
    .byte 0x04, 0x1E  /* 06025A4E: mov.l @(r0,r1),r4 */
    .byte 0x05, 0x2E  /* 06025A50: mov.l @(r0,r2),r5 */
    .byte 0x34, 0x5C  /* 06025A52: add r5,r4 */
    .byte 0x34, 0x38  /* 06025A54: sub r3,r4 */
    .byte 0x91, 0x13  /* 06025A56: mov.w @(0x26,PC),r1  {0x06025A80} */
    .byte 0xD7, 0x0C  /* 06025A58: mov.l @(0x30,PC),r7  {[0x06025A8C] = 0x0604DAB8} */
    .byte 0x02, 0x1D  /* 06025A5A: mov.w @(r0,r1),r2 */
    ...
    .byte 0x00, 0x2D  /* 06025A84: mov.w @(r0,r2),r0 */
    .byte 0xD6, 0x40  /* 06025A86: mov.l @(0x100,PC),r6  {[0x06025B88] = 0x001A204D} */
    .byte 0x06, 0x04  /* 06025A88: mov.b r0,@(r0,r6) */
    .byte 0x81, 0x8C  /* 06025A8A: mov.w r0,@(0x18,r8) */
    .byte 0x06, 0x04  /* 06025A8C: mov.b r0,@(r0,r6) */
    .byte 0xDA, 0xB8  /* 06025A8E: mov.l @(0x2E0,PC),r10  {[0x06025D70] = 0x002DC620} */
    ...
    .byte 0x00, 0x00  /* 06025AA8: .word 0x0000 */
    .byte 0x01, 0xF4  /* 06025AAA: mov.b r15,@(r0,r1) */
    ...
    .byte 0x01, 0x35  /* 06025AE8: mov.w r3,@(r0,r1) */
    .byte 0x33, 0x50  /* 06025AEA: cmp/eq r5,r3 */
