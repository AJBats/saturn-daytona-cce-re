...
FUN_0603F9FC:
    mov.l r14, @-r15
    .byte 0xD0, 0x8E    /* mov.l @(0x0603FC38), r0 */
    jsr @r0
    nop
    mov.l @r15+, r14
    mov.l @r15+, r13
...
FUN_0603FA32:
    mov.l r14, @-r15
    .byte 0xD0, 0x81    /* mov.l @(0x0603FC3C), r0 */
    jsr @r0
    nop
    mov.l @r15+, r14
    mov.l @r15+, r13
...
FUN_0603FCB2:
    sts.l pr, @-r15
    .byte 0xD0, 0xA2    /* mov.l @(0x0603FF40), r0 */
    jsr @r0
    mov r1, r4
    lds.l @r15+, pr
    shll8 r0
...
FUN_0603FDD8:
    ...
    mov.l r0, @-r15
    mov.l r1, @-r15
    .byte 0xD2, 0x50    /* mov.l @(0x0603FF3C), r2 */
    sts mach, r1
    sts macl, r4
    cmp/ge r2, r1
    bt .L_0603FE0E
    .byte 0xD0, 0x4E    /* mov.l @(0x0603FF40), r0 */
    jsr @r0
    xtrct r1, r4
    bra .L_0603FE18
    nop
.L_0603FE0E:
    .byte 0xD0, 0x4C    /* mov.l @(0x0603FF40), r0 */
    jsr @r0
    mov r1, r4
    shll8 r0
    add #0x7F, r0
.L_0603FE18:
    ...
    mov.l @r15+, r1
    mov.l r0, @-r15
    .byte 0xD2, 0x47    /* mov.l @(0x0603FF3C), r2 */
    cmp/ge r2, r1
    bt .L_0603FE2E
    .byte 0xD0, 0x46    /* mov.l @(0x0603FF40), r0 */
    jsr @r0
    xtrct r1, r4
    bra .L_0603FE38
    nop
.L_0603FE2E:
    .byte 0xD0, 0x44    /* mov.l @(0x0603FF40), r0 */
    jsr @r0
    mov r1, r4
    shll8 r0
    add #0x7F, r0
