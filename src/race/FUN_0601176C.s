...
FUN_0601176C:
    ...
    mov.l r8, @-r15
    sts.l pr, @-r15
    mov.l .L_pool_06011844, r3
    add #-0x8, r15
    jsr @r3
    nop
    mov.l .L_pool_06011848, r14
    mov r14, r13
    mov.l .L_pool_0601184C, r2
    jsr @r2
    mov r14, r4
    .reloc ., R_SH_IND12W, FUN_0601138A - 4
    ...
    bf .L_060117A6
.L_060117A0:
    mov.l .L_pool_06011850, r2
    jsr @r2
    mov r14, r4
.L_060117A6:
    mov #0x2, r1
    mov.l .L_pool_06011854, r2
    mov.b @r2, r3
    cmp/ge r1, r3
    bf .L_060117D4
    mov.w .L_wpool_0601183E, r13
    add r14, r13
    mov.l .L_pool_0601184C, r3
    jsr @r3
    mov r13, r4
    .reloc ., R_SH_IND12W, FUN_0601138A - 4
    .2byte 0xB000    /* bsr FUN_0601138A (linker-resolved) */
    ...
    bf .L_060117D4
.L_060117CC:
    mov.w .L_wpool_0601183E, r4
    mov.l .L_pool_06011850, r2
    jsr @r2
    add r14, r4
.L_060117D4:
    mov.l .L_pool_06011858, r2
    mov #0x2, r1
    mov.b @r2, r3
    cmp/ge r1, r3
    bt .L_060117E2
...
.L_060117E2:
    mov #0x0, r8
    mov.l .L_pool_06011860, r9
    mov.l .L_pool_0601185C, r2
    mov.l .L_pool_06011864, r10
    mov.l @r2, r13
    mov.l r8, @r15
    mov.l .L_pool_06011868, r11
    bra .L_0601192E
    nop
.L_060117F4:
    mov.w .L_wpool_06011840, r0
    mov.l @(r0, r13), r14
    mov.l @r15, r3
    bra .L_06011912
    nop
...
.L_pool_06011844:
    .4byte sym_0602B21C  /* 06011844 = 0x0602B21C */
.L_pool_06011848:
    .4byte sym_0605224C  /* 06011848 = 0x0605224C */
.L_pool_0601184C:
    .4byte sym_06040E80  /* 0601184C = 0x06040E80 */
.L_pool_06011850:
    .4byte sym_0604DD34  /* 06011850 = 0x0604DD34 */
.L_pool_06011854:
...
.L_pool_06011860:
    .4byte sym_06048180  /* 06011860 = 0x06048180 */
.L_pool_06011864:
...
.L_0601186C:
    ...
    mov r2, r12
.L_06011874:
    mov.l .L_pool_060119A8, r3
    add r4, r12
    cmp/ge r3, r12
    bt .L_0601190A
    mov.l .L_pool_060119AC, r1
    mov.l @(40, r13), r2
    cmp/ge r1, r2
    bt .L_0601190A
    mov.l @(40, r14), r2
...
.L_pool_060119B0:
    .4byte sym_06047D20  /* 060119B0 = 0x06047D20 */
.L_pool_060119B4:
    .4byte sym_06047D3C  /* 060119B4 = 0x06047D3C */
.L_pool_060119B8:
    .4byte sym_0603B248  /* 060119B8 = 0x0603B248 */
.L_pool_060119BC:
