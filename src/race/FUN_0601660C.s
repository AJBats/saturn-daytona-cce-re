...
FUN_0601660C:
    sts.l pr, @-r15
    mov.l .L_pool_0601665C, r0
    add r0, r15
    mov r15, r13
    mov.l r0, @-r15
    mov.l .L_pool_06016660, r4
    mov.l .L_pool_06016664, r7
    mov.l .L_pool_06016668, r5
    mov.b @r7, r7
    mov.l @r5, r5
    tst r7, r7
    bt .L_0601667C
.L_06016624:
    mov.w .L_wpool_06016646, r0
    mov #0x1, r6
    mov.b @(r0, r5), r1
    mov.w .L_wpool_06016648, r0
    cmp/gt r6, r1
    bf .L_0601666C
    mov.b @(r0, r5), r1
    tst r1, r1
...
.L_wpool_06016648:
    ...
    .4byte sym_0603EE48  /* 06016654 = 0x0603EE48 */
.L_pool_06016658:
    .4byte sym_06040B8C  /* 06016658 = 0x06040B8C */
.L_pool_0601665C:
...
.L_0601666C:
    mov.l .L_pool_06016688, r1
    mov.b @r1, r1
    tst r1, r1
    bf .L_0601668C
.L_06016674:
    mov.w .L_wpool_06016686, r0
    dt r7
    bf/s .L_06016624
    mov.l @(r0, r5), r5
.L_0601667C:
...
.L_060166B8:
    ...
    mov.l r2, @(32, r13)
    mov.l r3, @(40, r13)
    mov.l .L_pool_06016764, r1
    mov.l .L_pool_06016768, r2
    mov.b @r1, r1
    mov.b @r2, r2
    tst r1, r1
    bf .L_06016744
...
.L_pool_0601676C:
    .4byte sym_0603EE48  /* 0601676C = 0x0603EE48 */
.L_pool_06016770:
    .4byte sym_06040B8C  /* 06016770 = 0x06040B8C */
