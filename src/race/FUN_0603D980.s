...
FUN_0603D980:
    mov.l r14, @-r15
    mov #0x7C, r0
    .byte 0xD3, 0x47    /* mov.l @(0x0603DAA4), r3 */
    mov #0x27, r14
    .byte 0xD1, 0x47    /* mov.l @(0x0603DAA8), r1 */
    sub r4, r14
    mov.l r13, @-r15
    shll8 r14
    mov.l r12, @-r15
    mov #0xA, r4
    .byte 0xDD, 0x46    /* mov.l @(0x0603DAB0), r13 */
    add r3, r14
...
FUN_0603D998:
    ...
    add r3, r1
    shll2 r1
    .byte 0xD3, 0x41    /* mov.l @(0x0603DAB4), r3 */
    shll r1
    add r13, r1
    mov.w @(2, r1), r0
    mov r0, r1
    ...
    .byte 0xD2, 0x3E    /* mov.l @(0x0603DAB8), r2 */
    add r14, r1
    mov.w r0, @r1
    mov.l @r2, r3
    ...
    shll2 r1
    add r3, r1
    .byte 0xD3, 0x39    /* mov.l @(0x0603DABC), r3 */
    shll2 r1
    shll r1
    add r13, r1
    mov.w @(2, r1), r0
    ...
    jsr @r3
    mov r4, r0
    .byte 0xD3, 0x33    /* mov.l @(0x0603DAB4), r3 */
    mov r0, r1
    jsr @r3
    mov r4, r0
    .byte 0xD1, 0x34    /* mov.l @(0x0603DAC0), r1 */
    add #-0x8, r15
    jsr @r1
    mov.l r15, @-r15
    .byte 0xD0, 0x34    /* mov.l @(0x0603DAC8), r0 */
    mov #0x0, r3
    mov.l r3, @-r15
    .byte 0xD3, 0x32    /* mov.l @(0x0603DAC4), r3 */
    mov.l r3, @-r15
    mov r15, r1
    add #0x10, r1
    jsr @r0
    mov.l r1, @-r15
    .byte 0xD3, 0x31    /* mov.l @(0x0603DACC), r3 */
    jsr @r3
    nop
    .byte 0xD3, 0x30    /* mov.l @(0x0603DAD0), r3 */
    mov #0x60, r1
    add r14, r1
    mov.l r0, @r1
    .byte 0xD1, 0x2F    /* mov.l @(0x0603DAD4), r1 */
    mov #0x4C, r0
    mov.l r3, @(r0, r14)
    mov #0x48, r0
    mov.l r1, @(r0, r14)
    ...
    mov.l @r15+, r14
    mov #0x0, r5
    .byte 0xD1, 0x21    /* mov.l @(0x0603DADC), r1 */
    mov r5, r6
    mov.w .L_wpool_0603DAA0, r7
    mov.l r13, @-r15
    .byte 0xDD, 0x1E    /* mov.l @(0x0603DAD8), r13 */
    bra .L_0603DA6E
    mov r5, r4
.L_0603DA62:
    add #0x1, r6
...
.L_0603DAE0:
    .byte 0xD4, 0x5A    /* mov.l @(0x0603DC4C), r4 */
    bra .L_0603DAE8
    nop
.L_0603DAE6:
    .byte 0xD4, 0x5A    /* mov.l @(0x0603DC50), r4 */
.L_0603DAE8:
    rts
    mov r4, r0
...
FUN_0603DAEC:
    .byte 0xD2, 0x59    /* mov.l @(0x0603DC54), r2 */
    mov.b @r2, r0
    .byte 0xD1, 0x5A    /* mov.l @(0x0603DC5C), r1 */
    mov r0, r3
    shll r0
    add r3, r0
    .byte 0xD3, 0x57    /* mov.l @(0x0603DC58), r3 */
    exts.b r0, r0
    mov.b @r3, r5
    add r0, r1
    mov.l .L_pool_0603DC64, r3
    extu.b r5, r5
    .byte 0xD0, 0x56    /* mov.l @(0x0603DC60), r0 */
    add r1, r5
    mov.b @r5, r5
    extu.b r5, r5
    shll2 r5
