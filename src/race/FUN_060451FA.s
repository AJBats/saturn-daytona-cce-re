...
FUN_060451FA:
    ...
    mov.l r4, @-r15
    mov.l r0, @-r15
    .byte 0xD1, 0x15    /* mov.l @(disp,PC), r1 -> .L_pool_06045258 */
    jsr @r1
    mov r0, r4
    mov r0, r5
    mov.l @r15+, r0
    .byte 0xD1, 0x14    /* mov.l @(disp,PC), r1 -> .L_pool_0604525C */
    jsr @r1
    mov r0, r4
    mov r0, r6
    mov.l @r15+, r4
...
FUN_0604521A:
    ...
    mov.l r4, @-r15
    mov.l r0, @-r15
    .byte 0xD1, 0x0D    /* mov.l @(disp,PC), r1 -> .L_pool_06045258 */
    jsr @r1
    mov r0, r4
    mov r0, r5
    mov.l @r15+, r0
    .byte 0xD1, 0x0C    /* mov.l @(disp,PC), r1 -> .L_pool_0604525C */
    jsr @r1
    mov r0, r4
    mov r0, r6
    mov.l @r15+, r4
...
FUN_0604523A:
    ...
    mov.l r4, @-r15
    mov.l r0, @-r15
    .byte 0xD1, 0x05    /* mov.l @(disp,PC), r1 -> .L_pool_06045258 */
    jsr @r1
    mov r0, r4
    mov r0, r5
    mov.l @r15+, r0
    .byte 0xD1, 0x04    /* mov.l @(disp,PC), r1 -> .L_pool_0604525C */
    jsr @r1
    mov r0, r4
    mov r0, r6
    mov.l @r15+, r4
