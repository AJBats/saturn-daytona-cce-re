...
FUN_0602D13A:
    ...
    sts.l pr, @-r15
    sts.l macl, @-r15
    .byte 0xD2, 0x1E    /* mov.l @(disp,PC), r2 -> .L_pool_0602D1C8 */
    mov.b @r2, r3
    tst r3, r3
    bt .L_0602D158
    bra .L_0602D25C
    nop
.L_0602D158:
    .byte 0xD8, 0x1C    /* mov.l @(disp,PC), r8 -> .L_pool_0602D1CC */
    mov #0xA, r5
    .byte 0xDC, 0x1C    /* mov.l @(disp,PC), r12 -> .L_pool_0602D1D0 */
    .byte 0xDD, 0x1D    /* mov.l @(disp,PC), r13 -> .L_pool_0602D1D4 */
    .byte 0xD4, 0x1D    /* mov.l @(disp,PC), r4 -> .L_pool_0602D1D8 */
    .byte 0xD3, 0x1E    /* mov.l @(disp,PC), r3 -> .L_pool_0602D1DC */
    mov.b @r3, r0
    cmp/eq #0x0, r0
    bt/s .L_0602D184
    mov #0x0, r10
...
.L_0602D184:
    ...
    mov.b @r13, r4
.L_0602D1A6:
    .byte 0xD2, 0x0E    /* mov.l @(disp,PC), r2 -> .L_pool_0602D1E0 */
    jsr @r2
    nop
    .byte 0xD3, 0x0D    /* mov.l @(disp,PC), r3 -> .L_pool_0602D1E4 */
    jsr @r3
    mov.l @r12, r4
    bra .L_0602D256
    nop
.L_0602D1B6:
    ...
    nop
    .byte 0xD3, 0x0B    /* mov.l @(disp,PC), r3 -> .L_pool_0602D1E8 */
    jsr @r3
    nop
    bra .L_0602D25C
    nop
...
.L_0602D1EC:
    ...
    cmp/gt r5, r0
    bf .L_0602D250
    .byte 0xD1, 0x29    /* mov.l @(disp,PC), r1 -> .L_pool_0602D2A0 */
    jsr @r1
    mov.b r10, @r4
    .byte 0xD3, 0x28    /* mov.l @(disp,PC), r3 -> .L_pool_0602D2A4 */
    mov r10, r14
    mov r0, r11
    mov #0x1, r9
    mov.b r11, @r3
    mov #0x2, r10
.L_0602D20C:
    .byte 0xD3, 0x26    /* mov.l @(disp,PC), r3 -> .L_pool_0602D2A8 */
    mov.b @r3, r0
    tst r0, r0
    bt .L_0602D21C
    jsr @r8
...
.L_0602D22A:
    ...
    .byte 0xD0, 0x1F    /* mov.l @(disp,PC), r0 -> .L_pool_0602D2AC */
    muls.w r3, r2
    .byte 0xD3, 0x1F    /* mov.l @(disp,PC), r3 -> .L_pool_0602D2B0 */
    sts macl, r2
    exts.w r2, r2
    mov.b r4, @(r0, r2)
    mov.b @r3, r1
...
.L_0602D248:
    ...
    bf .L_0602D20C
.L_0602D250:
    .byte 0xD3, 0x18    /* mov.l @(disp,PC), r3 -> .L_pool_0602D2B4 */
    jsr @r3
    mov.l @r12, r4
.L_0602D256:
    .byte 0xD2, 0x18    /* mov.l @(disp,PC), r2 -> .L_pool_0602D2B8 */
    jsr @r2
    mov.l @r12, r4
.L_0602D25C:
    lds.l @r15+, macl
...
FUN_0602D270:
    sts.l pr, @-r15
    mov r4, r5
    .byte 0xD2, 0x11    /* mov.l @(disp,PC), r2 -> .L_pool_0602D2BC */
    extu.b r4, r6
    .byte 0xD1, 0x11    /* mov.l @(disp,PC), r1 -> .L_pool_0602D2C0 */
    mov r4, r3
    .byte 0xD0, 0x12    /* mov.l @(disp,PC), r0 -> .L_pool_0602D2C8 */
    shll r5
    sts.l macl, @-r15
    add r3, r5
    exts.b r5, r5
    ...
    mov #0x74, r3
    mul.l r3, r6
    .byte 0xD3, 0x0D    /* mov.l @(disp,PC), r3 -> .L_pool_0602D2C4 */
    sts macl, r6
    mov.b r4, @r3
    add r1, r6
    mov.b @r0, r2
...
.L_0602D2D6:
    extu.b r4, r4
    .byte 0xD0, 0x65    /* mov.l @(disp,PC), r0 -> .L_pool_0602D470 */
    mov.b @(r0, r4), r3
    tst r3, r3
    bt .L_0602D376
    .byte 0xD1, 0x64    /* mov.l @(disp,PC), r1 -> .L_pool_0602D474 */
    mov.b @r1, r2
    tst r2, r2
    bf .L_0602D376
    mov.b @r5, r0
...
.L_0602D322:
    exts.w r7, r4
    .byte 0xD3, 0x54    /* mov.l @(disp,PC), r3 -> .L_pool_0602D478 */
    extu.b r6, r6
    shll2 r4
    shll2 r4
    shll2 r4
    ...
    mov #0xE, r6
    mov r4, r5
    .byte 0xD4, 0x4F    /* mov.l @(disp,PC), r4 -> .L_pool_0602D47C */
...
.L_0602D344:
    ...
    mov #0xE, r5
    .byte 0xD2, 0x4D    /* mov.l @(disp,PC), r2 -> .L_pool_0602D480 */
    mov.b @r2, r3
    tst r3, r3
    bf .L_0602D376
    lds.l @r15+, macl
    .byte 0xD1, 0x4B    /* mov.l @(disp,PC), r1 -> .L_pool_0602D484 */
    jmp @r1
    lds.l @r15+, pr
.L_0602D35A:
    mov #0x6E, r0
    ...
    bf .L_0602D376
    mov #0x1, r2
    .byte 0xD3, 0x48    /* mov.l @(disp,PC), r3 -> .L_pool_0602D488 */
    mov r4, r0
    mov.b r2, @r5
    mov #0x5, r4
    mov.b r0, @(1, r5)
...
.L_0602D376:
    ...
    nop
    mov #0x1C, r6
    .byte 0xD4, 0x42    /* mov.l @(disp,PC), r4 -> .L_pool_0602D48C */
...
FUN_0602D382:
    ...
    .2byte 0xB000    /* bsr FUN_0602D102 (linker-resolved) */
    mov #0x40, r5
    .byte 0xD4, 0x41    /* mov.l @(disp,PC), r4 -> .L_pool_0602D490 */
    mov #0x1C, r6
    mov #0x40, r5
    .reloc ., R_SH_IND12W, FUN_0602D102 - 4
...
FUN_0602D392:
    ...
    mov.l r9, @-r15
    mov.l r8, @-r15
    .byte 0xDA, 0x3C    /* mov.l @(disp,PC), r10 -> .L_pool_0602D494 */
    .byte 0xDC, 0x3D    /* mov.l @(disp,PC), r12 -> .L_pool_0602D498 */
    .byte 0xD2, 0x36    /* mov.l @(disp,PC), r2 -> .L_pool_0602D480 */
    mov.b @r2, r3
    tst r3, r3
    bf .L_0602D3F2
    .byte 0xD7, 0x3B    /* mov.l @(disp,PC), r7 -> .L_pool_0602D49C */
    mov.l @r7, r4
    mov.w @(14, r4), r0
    mov r0, r4
    mov.b @r10, r0
    ...
    neg r4, r4
.L_0602D3C4:
    .byte 0xD6, 0x36    /* mov.l @(disp,PC), r6 -> .L_pool_0602D4A0 */
    mov r4, r3
    .byte 0xD2, 0x36    /* mov.l @(disp,PC), r2 -> .L_pool_0602D4A4 */
    mov r6, r5
    mov.l r4, @r5
    shlr16 r3
    mov.w r3, @r2
    ...
    mov.w @(12, r3), r0
    shll8 r0
    .byte 0xD3, 0x32    /* mov.l @(disp,PC), r3 -> .L_pool_0602D4A8 */
    shll r0
    neg r0, r0
    add r3, r0
    mov.l r0, @r4
    mov r0, r1
    .byte 0xD0, 0x30    /* mov.l @(disp,PC), r0 -> .L_pool_0602D4AC */
    shlr16 r1
    exts.w r1, r1
    bra .L_0602D458
    mov.w r1, @r0
.L_0602D3F2:
    mov #0x0, r8
    .byte 0xDD, 0x2F    /* mov.l @(disp,PC), r13 -> .L_pool_0602D4B4 */
    mov #0x70, r9
    .byte 0xDE, 0x2F    /* mov.l @(disp,PC), r14 -> .L_pool_0602D4B8 */
    mov r8, r11
    .byte 0xD5, 0x2C    /* mov.l @(disp,PC), r5 -> .L_pool_0602D4B0 */
.L_0602D3FE:
    mov r13, r4
    mov.w @(14, r4), r0
    mov r0, r6
...
.L_0602D414:
    mov.w @(12, r4), r0
    shll8 r0
    .byte 0xD4, 0x28    /* mov.l @(disp,PC), r4 -> .L_pool_0602D4BC */
    shll r0
    .byte 0xD3, 0x28    /* mov.l @(disp,PC), r3 -> .L_pool_0602D4C0 */
    neg r0, r0
    add r0, r4
    mov.b @r3, r0
    extu.b r0, r0
    ...
    bf/s .L_0602D430
    mov r8, r7
    .byte 0xD1, 0x25    /* mov.l @(disp,PC), r1 -> .L_pool_0602D4C4 */
    sub r1, r4
.L_0602D430:
    mov.l r6, @r5
    add #0x2, r7
    ...
    add #0x74, r13
.L_0602D458:
    .byte 0xD3, 0x1B    /* mov.l @(disp,PC), r3 -> .L_pool_0602D4C8 */
    mov.w @r3, r1
    .byte 0xD0, 0x1B    /* mov.l @(disp,PC), r0 -> .L_pool_0602D4CC */
    mov.w r1, @r0
    mov.l @r15+, r8
    mov.l @r15+, r9
    mov.l @r15+, r10
