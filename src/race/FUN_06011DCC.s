...
FUN_06011DCC:
    mov.l r14, @-r15
    mov r4, r14
    mov.w .L_wpool_06011EAA, r0
    mov.l r13, @-r15
    sts.l pr, @-r15
    mov.l .L_pool_06011EBC, r13
    mov.l @(r0, r14), r0
    tst r0, r0
    bt .L_06011E46
    mov.w .L_wpool_06011EAC, r0
    mov.w @(r0, r14), r5
    add #-0x2, r0
    mov.l @(r0, r14), r3
    neg r5, r5
    ...
    tst #0x40, r0
    bt .L_06011E02
    mov.l .L_pool_06011EC0, r0
    bra .L_06011E04
    nop
.L_06011E02:
    mov.l .L_pool_06011EC4, r0
.L_06011E04:
    mov.w @(r0, r4), r5
    mov.w .L_wpool_06011EAE, r0
    mov.b @(r0, r14), r0
    cmp/pz r0
    bt .L_06011E12
    bra .L_06011E16
...
.L_06011E12:
    ...
    neg r0, r0
.L_06011E16:
    mov.w .L_wpool_06011EB0, r5
    mov.w .L_wpool_06011EB2, r4
    mov.l .L_pool_06011EC8, r2
    jsr @r2
    mov.w r0, @(26, r14)
    mov.l @(36, r14), r3
    sub r0, r3
    ...
    mov.l @(48, r14), r2
    mov #0x1, r5
    mov.l .L_pool_06011ECC, r1
    and r1, r2
    mov.l r2, @(48, r14)
    jsr @r13
    mov r14, r4
    mov.w .L_wpool_06011EB4, r3
    mov.w .L_wpool_06011EB6, r0
    bra .L_06011E94
    mov.w r3, @(r0, r14)
.L_06011E46:
    mov #0x14, r1
...
.L_06011E94:
    mov.l @(48, r14), r3
    mov.l .L_pool_06011ED0, r2
    mov.l .L_pool_06011ED4, r0
    and r2, r3
    mov r3, r1
    and r0, r1
    mov.l r1, @(48, r14)
...
.L_pool_06011EBC:
    .4byte sym_06039AA4  /* 06011EBC = 0x06039AA4 */
.L_pool_06011EC0:
    .4byte sym_002E0224  /* 06011EC0 = 0x002E0224 */
.L_pool_06011EC4:
    .4byte sym_002E02B4  /* 06011EC4 = 0x002E02B4 */
.L_pool_06011EC8:
    .4byte sym_06048180  /* 06011EC8 = 0x06048180 */
.L_pool_06011ECC:
