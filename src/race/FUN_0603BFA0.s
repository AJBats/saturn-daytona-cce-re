...
FUN_0603BFFE:
    ...
    nop
.L_0603C020:
    .byte 0xDD, 0x2E    /* mov.l @(0x0603C0DC), r13 */
    mov #0x0, r11
    .byte 0x98, 0x4C    /* mov.w @(0x0603C0C0), r8 */
    .byte 0x99, 0x4C    /* mov.w @(0x0603C0C2), r9 */
    .byte 0xDA, 0x2D    /* mov.l @(0x0603C0E0), r10 */
.L_0603C02A:
    mov r13, r14
    mov.l @(4, r12), r3
    mov.l @r14, r2
    ...
    bf .L_0603C04E
    mov #0x2, r6
    .byte 0xD4, 0x29    /* mov.l @(0x0603C0E4), r4 */
    bsr FUN_0603C2BC
    mov #0x8, r5
    mov #0x1C, r6
    mov #0x2C, r5
...
.L_0603C04E:
    mov #0x66, r3
    .byte 0x92, 0x38    /* mov.w @(0x0603C0C4), r2 */
    mov.w @(16, r14), r0
    mulu.w r3, r0
    sts macl, r0
    add r2, r0
...
FUN_0603C274:
    ...
    mov.w @(22, r15), r0
    mov r0, r8
    .byte 0x99, 0x36    /* mov.w @(0x0603C2F4), r9 */
    bra .L_0603C2A8
    mov r11, r12
.L_0603C28A:
    mov r5, r10
