...
FUN_06001810:
    ...
    .byte 0x06, 0x05  /* 06001924: mov.w r0,@(r0,r6) */
    .byte 0x49, 0x34  /* 06001926: .word 0x4934 */
    .byte 0x06, 0x00  /* 06001928: .word 0x0600 */
    .byte 0x58, 0xB4  /* 0600192A: mov.l @(0x10,r11),r8 */
    .byte 0x06, 0x05  /* 0600192C: mov.w r0,@(r0,r6) */
    .byte 0x49, 0x20  /* 0600192E: shal r9 */
    .byte 0x06, 0x04  /* 06001930: mov.b r0,@(r0,r6) */
    .byte 0xED, 0x20  /* 06001932: mov #32,r13 */
    .byte 0x06, 0x05  /* 06001934: mov.w r0,@(r0,r6) */
    .byte 0x49, 0x30  /* 06001936: .word 0x4930 */
    .byte 0x06, 0x05  /* 06001938: mov.w r0,@(r0,r6) */
    .byte 0x49, 0x32  /* 0600193A: .word 0x4932 */
    .byte 0x06, 0x05  /* 0600193C: mov.w r0,@(r0,r6) */
    .byte 0x49, 0x38  /* 0600193E: .word 0x4938 */
    .byte 0x06, 0x04  /* 06001940: mov.b r0,@(r0,r6) */
    .byte 0xED, 0x62  /* 06001942: mov #98,r13 */
    .byte 0x06, 0x04  /* 06001944: mov.b r0,@(r0,r6) */
    .byte 0xED, 0x6C  /* 06001946: mov #108,r13 */
    .byte 0x06, 0x04  /* 06001948: mov.b r0,@(r0,r6) */
    .byte 0xED, 0x34  /* 0600194A: mov #52,r13 */
    .byte 0x06, 0x0E  /* 0600194C: mov.l @(r0,r0),r6 */
    .byte 0xD1, 0x00  /* 0600194E: mov.l @(0x0,PC),r1  {[0x06001950] = 0x0604ED5C} */
    .byte 0x06, 0x04  /* 06001950: mov.b r0,@(r0,r6) */
    .byte 0xED, 0x5C  /* 06001952: mov #92,r13 */
    .byte 0x06, 0x0E  /* 06001954: mov.l @(r0,r0),r6 */
    .byte 0xD1, 0x03  /* 06001956: mov.l @(0xC,PC),r1  {[0x06001964] = 0x06055374} */
    ...
    .byte 0x06, 0x05  /* 06001964: mov.w r0,@(r0,r6) */
    .byte 0x53, 0x74  /* 06001966: mov.l @(0x10,r7),r3 */
