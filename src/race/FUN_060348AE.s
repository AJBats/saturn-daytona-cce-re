...
FUN_060348AE:
    mov #0x3C, r2
    .byte 0xD6, 0x10  /* 060348B0: mov.l @(0x40,PC),r6  {[0x060348F4] = 0x060520C8} */
    mov.w @r6, r3
    add #0x1, r3
    mov.w r3, @r6
    mov.w @r6, r4
    ...
    bf/s .L_060348D4
    mov #0x0, r5
    .byte 0xD1, 0x0F  /* 060348C0: mov.l @(0x3C,PC),r1  {[0x06034900] = 0x0602F2C4} */
    mov.w @(2, r1), r0
...
.L_060348D4:
    rts
    mov r5, r0
    .byte 0x01, 0xD8  /* 060348D8: .word 0x01D8 */
.L_wpool_060348DA:
    .byte 0x07, 0x00  /* 060348DA: .word 0x0700 */
.L_wpool_060348DC:
    .byte 0x01, 0x2C  /* 060348DC: mov.b @(r0,r2),r1 */
    .byte 0xFF, 0xFF  /* 060348DE: .word 0xFFFF */
