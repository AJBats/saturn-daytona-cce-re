/* TU: FUN_060384C4 + FUN_06038590 + FUN_060385CE + FUN_060386D8 + FUN_06038A82 + FUN_06038A84 */
...
FUN_060384C4:
    ...
    sts.l pr, @-r15
    add #-0x8, r15
    .byte 0xD8, 0x4F    /* mov.l @(0x06038618), r8 */
    mov.w @(14, r14), r0
    .byte 0xDB, 0x4F    /* mov.l @(0x0603861C), r11 */
    mov.w r0, @(4, r15)
    .byte 0x90, 0x91    /* mov.w @(0x06038606), r0 */
    mov.l @(r0, r14), r9
    .byte 0xDD, 0x4E    /* mov.l @(0x06038620), r13 */
    mov.l @(4, r9), r9
    mov.w @(4, r15), r0
    mov r0, r12
    .byte 0x94, 0x8C    /* mov.w @(0x06038608), r4 */
    add r12, r4
    mov.l r4, @r15
    jsr @r11
    nop
    ...
    add r3, r0
    mov.l r0, @r9
    .byte 0x90, 0x82    /* mov.w @(0x0603860A), r0 */
    .byte 0xDA, 0x47    /* mov.l @(0x06038624), r10 */
    mov.l @(r0, r14), r2
    mov.l r2, @(4, r9)
    mov.l @r15, r4
    jsr @r10
    ...
    mov r8, r4
    mov.l @(8, r14), r3
    .byte 0xD4, 0x43    /* mov.l @(0x06038628), r4 */
    add r3, r0
    mov.l r0, @(8, r9)
    add r12, r4
    .byte 0x90, 0x71    /* mov.w @(0x06038606), r0 */
    mov.l @(r0, r14), r9
    mov.l @r9, r9
    mov.l r4, @r15
    jsr @r11
    ...
    add r3, r0
    mov.l r0, @r9
    .byte 0x90, 0x67    /* mov.w @(0x0603860A), r0 */
    mov.l @(r0, r14), r2
    mov.l r2, @(4, r9)
    mov.l @r15, r4
    jsr @r10
    ...
    mov r8, r4
    mov.l @(8, r14), r3
    .byte 0x94, 0x5E    /* mov.w @(0x0603860C), r4 */
    add r3, r0
    mov.l r0, @(8, r9)
    add r12, r4
    .byte 0x90, 0x57    /* mov.w @(0x06038606), r0 */
    mov.l @(r0, r14), r8
    .byte 0xD9, 0x34    /* mov.l @(0x0603862C), r9 */
    mov.l @(12, r8), r8
    mov.l r4, @r15
    jsr @r11
    nop
    ...
    add r3, r0
    mov.l r0, @r8
    .byte 0x90, 0x4C    /* mov.w @(0x0603860A), r0 */
    mov.l @(r0, r14), r2
    mov.l r2, @(4, r8)
    mov.l @r15, r4
    jsr @r10
    ...
    add r3, r0
    mov.l r0, @(8, r8)
    .byte 0x90, 0x3E    /* mov.w @(0x06038606), r0 */
    .byte 0x94, 0x41    /* mov.w @(0x0603860E), r4 */
    mov.l @(r0, r14), r8
    mov.l @(8, r8), r8
    add r12, r4
    .global FUN_06038590
FUN_06038590:
    ...
    add r3, r0
    mov.l r0, @r8
    .byte 0x90, 0x32    /* mov.w @(0x0603860A), r0 */
    mov.l @(r0, r14), r2
    mov.l r2, @(4, r8)
    mov.l @r15, r4
    jsr @r10
...
.L_06038A20:
    ...
    mov r13, r4
    mov.l @r15+, r2
    .byte 0xD5, 0x46    /* mov.l @(0x06038B64), r5 */
    sub r0, r2
    .byte 0xD3, 0x46    /* mov.l @(0x06038B68), r3 */
    mov.l r2, @r15
    mov.l @(4, r15), r4
    jsr @r3
    nop
    .byte 0x92, 0x7E    /* mov.w @(0x06038B56), r2 */
    .byte 0xD5, 0x44    /* mov.l @(0x06038B6C), r5 */
    add r2, r0
    .byte 0xD3, 0x42    /* mov.l @(0x06038B68), r3 */
    mov.w r0, @(12, r14)
    mov.l @r15, r4
    jsr @r3
    nop
    neg r0, r0
    .byte 0x92, 0x76    /* mov.w @(0x06038B58), r2 */
    add r2, r0
    mov.w r0, @(16, r14)
    add #0xC, r15
    lds.l @r15+, pr
