/* FUN_0603E60C  0x0603E60C-0x0603E773  (generated naked asm shim) */
int FUN_0603E60C(void) asm {
        rts                         /* TRANSPLANT: kill direct init→race position call (reads 0x00220000) */
        nop                         /* was: sts.l pr, @-r15 + mov.l .L_pool_0603E65C, r0 */
        add r0, r15
        mov r15, r13
        mov.l r0, @-r15
